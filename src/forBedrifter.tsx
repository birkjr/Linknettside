    ...
    return (
        <div className="min-h-screen flex flex-col w-full p-6 lg:px-12 bg-stone-100">
            ...
            <div className="flex flex-col md:flex-row justify-center items-start gap-12 max-w-6xl mx-auto mt-12">
                <BusinessOffer 
                    image="/src/assets/bilder_forBedrifter/bedriftsbilde.avif"
                ...
                />
                <BusinessOffer 
                    image="/src/assets/bilder_forBedrifter/logo_sirkel.avif"
                    title="Jobbtorget"
                ...
                />
                <BusinessOffer 
                    image="/src/assets/bilder_forBedrifter/instagram_bedrifter.avif"
