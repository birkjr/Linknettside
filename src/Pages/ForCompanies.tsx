...
export default function ForBedrifter() {
  return (
    <div className="min-h-screen flex flex-col w-full p-6 lg:px-12">
      ...
      >
        <h1 className="text-white text-3xl my-4">For bedrifter</h1>
        <p>
          {' '}
          Ønsker din bedrift å promotere stillingsannonser, internships eller gi
          et generelt innblikk i hva din bedrift driver med?{' '}
        </p>
        <p>
          {' '}
          Emil-Link tilbyr flere ulike tjenester hvor bedrifter har mulighet til
          å komme i kontakt med våre studenter og gjøre nettopp dette.{' '}
        </p>
        <p>
          {' '}
          EMIL-Link er Energi- og miljøingeniørenes bedriftskontakt, en komite
          underlagt linjeforeningen.{' '}
        </p>
        <p>
          {' '}
          Våre medlemmer jobber hardt for å gi det beste tilbudet til
          studentene, og være deres link til arbeidslivet!
        </p>
      </div>
