...
export default function ImgPartners({ isOpen, onClose }: AddCompanyLogoProps) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const localFileNames = [
                    'asplanviak.JPG', 'cowi.JPG', 'dnv.JPG', 'equinor.JPG', 
                    'multiconsult.JPG', 'norconsult.JPG', 'statkraft.JPG'
                ];
    ...
    const handleUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (error) {
            ...
            alert("Bildet ble lastet opp til Supabase! Husk å flytte det til public/images/company_logos/ for raskere lasting.");
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg w-[400px] relative">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                    ...
                    <p className="text-blue-700 text-sm">
                        For raskeste bildehastning, flytt bilder til <code>public/images/company_logos/</code> etter opplasting.
                    </p>
                </div>
