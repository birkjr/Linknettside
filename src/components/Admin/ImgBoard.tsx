...
export default function ImgBoard({ isOpen, onClose }: EditBoardPics) {
    ...
    const fetchLocalFiles = async () => {
        try {
            ...
            const localFileNames = [
                'Annie.png', 'Aqeel.png', 'Aryan.png', 'Julia.png', 
                'Julie.png', 'Julius.png', 'Kaia.png', 'Stina.png'
            ];
    ...
    const handleUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (error) {
            ...
            alert("Bildet ble lastet opp til Supabase! Husk å flytte det til public/images/board_pics/ for raskere lasting.");
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm bg-opacity-50 z-[100]">
            <div className="bg-white p-6 rounded-xl shadow-lg w-[400px] relative">
                ...
                <h2 className="text-lg font-bold mb-4 text-center">Administrer Styret Bilder</h2>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                    ...
                    <p className="text-blue-700 text-sm">
                        For raskeste bildehastning, flytt bilder til <code>public/images/board_pics/</code> etter opplasting.
                    </p>
                </div>
