...
export default function UploadPhoto() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 rounded-lg shadow-lg">
      ...
      <AddCompanyLogo
        isOpen={isAddCompanyLogoOpen}
        onClose={() => setIsAddCompanyLogoOpen(false)}
      />
      <EditBoardPics
        isOpen={isEditBoardPicOpen}
        onClose={() => setIsEditBoardPicOpen(false)}
      />
      <EditSubGroup
        isOpen={isEditSubGroupOpen}
        onClose={() => setIsEditSubGroupOpen(false)}
      />
      <AddEventsJobads
        isOpen={isAddEventsJobads}
        onClose={() => setIsAddEventsJobads(false)}
      />
    </div>
  );
}
