(!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '72565a79-96d3-4254-b925-47223fc710fe'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-72565a79-96d3-4254-b925-47223fc710fe'));
  } catch (e) {}
})(),
    ...
    [7873],
    {
      ...
      5315: function (e, t, s) {
        ...
        t.Z = e => {
          ...
          let {
            ...
            T = L || { interval: y.length - 2, angle: 0, tick: !1 },
            H = B || {
      ...
      60480: function (e, t, s) {
                              ...
                              descriptionText: (0, a.jsxs)('p', {
                                children: [
                                  ...
                                  (0, a.jsx)(d(), {
                                    ...
                                    className:
                                      'transition text-brand hover:text-brand-600',
                                    children: 'here',
                                  }),
                                  ' ',
                                  'to bypass RLS.',
                                    ...
                                    children: [
                                      (0, a.jsxs)('div', {
                                        ...
                                        children: [
                                          (0, a.jsx)('div', {
                                            className:
                                              'rounded bg-surface-300 p-1.5 text-foreground-light shadow-sm',
          ...
          return (0, a.jsx)(t, {
            ...
            children: (0, a.jsxs)('div', {
              className:
                ...
                (e.href
                  ? 'cursor-pointer hover:text-gray-1200 hover:opacity-100'
                  : ''),
              children: [
                                  ...
                                  r.Fragment,
                                  {
                                    children: [
                                      (0, a.jsx)(d(), {
                                        ...
                                        children: (0, a.jsxs)('div', {
                                          className:
                                            'group flex items-center justify-between w-full px-3 py-3 transition hover:bg-surface-300',
                                          children: [
                                            (0, a.jsxs)('div', {
        ...
        async function ey(e, t) {
          ...
          let n = await (0, ex.v_)(
            ''
              .concat(ej.T5, '/pg-meta/')
              .concat(s, '/query?key=service_status'),
            { query: 'select 1' },
            { headers: Object.fromEntries(r), signal: t }
          );
        ...
        async function eb(e, t) {
          let { projectRef: s } = e;
          if (!s) throw Error('projectRef is required');
          let { data: a, error: r } = await (0, eN.U2)(
        ...
        var eE = () => {
                        ...
                        (0, a.jsxs)(
                          d(),
                          {
                            ...
                            children: [
                              ...
                              (0, a.jsxs)('div', {
                                className:
                                  'flex items-center gap-x-1 transition opacity-0 group-hover:opacity-100',
                                children: [
                                  (0, a.jsx)('span', {
          ...
          eM = () => {
            var e, t, s;
            let { ref: l } = (0, n.UO)(),
              { data: i } = (0, eB.h)({ projectRef: l }, { enabled: ej.Qy }),
              {
                status: o,
                initiated_at: c,
                error: u,
        ...
        let eY = () => {
          ...
          return (0, a.jsxs)('div', {
            ...
            children: [
              (0, a.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, a.jsxs)('div', {
                    ...
                    children: [
                      (null == t ? void 0 : t.status) === ej.S.ACTIVE_HEALTHY &&
                        (0, a.jsx)(eo, {}),
                      ej.Qy &&
              ...
              (null == t ? void 0 : t.status) === ej.S.INACTIVE &&
                (0, a.jsx)(eU.$, {}),
              (0, a.jsx)('div', {
                className: 'mx-6',
                children:
                            ...
                            children: [
                              ...
                              (0, a.jsx)(eO.nU, {
                                ...
                                children: (0, a.jsx)('div', {
                                  className:
                                    'grid gap-2 md:gap-8 md:grid-cols-2 lg:grid-cols-3',
                                  children: U.B.filter(e => 'mobile' === e.type)
                                    .sort((e, t) =>
                                      e.title.localeCompare(t.title)
                                    )
                                    .map(e => (0, a.jsx)(i.Z, { ...e }, e.url)),
        ...
        eY.getLayout = e => (0, a.jsx)(eR.$, { children: e });
        var eV = eY;
      },
      6719: function (e, t, s) {
        'use strict';
