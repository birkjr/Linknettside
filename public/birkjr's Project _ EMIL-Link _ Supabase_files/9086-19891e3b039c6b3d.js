!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '1e33f22d-68c9-4570-8eb5-4771e4cf0c5d'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-1e33f22d-68c9-4570-8eb5-4771e4cf0c5d'));
  } catch (e) {}
})();
('use strict');
  ...
  [9086],
  {
    66164: function (e, t, i) {
      ...
      let s =
        ...
        n = /chrome-extension:\/\/([a-zA-Z]*)/gm,
        o = /^([a-zA-Z][a-zA-Z0-9+.-]*):(?:\/{1,3})?([a-zA-Z0-9_.-]*)$/,
    ...
    94102: function (e, t, i) {
      ...
      var s = i(18648),
        r = i(66164);
      let E = e => atob(e.replace(/[-]/g, '+').replace(/[_]/g, '/')),
        ...
        o = {
          ...
          validationSchema: (0, s.object)().shape({
            MAILER_OTP_EXP: (0, s.number)()
              .min(0, 'Must be more than 0')
              .max(86400, 'Must be no more than 86400')
              .required('This is required'),
            MAILER_OTP_LENGTH: (0, s.number)()
        ...
        l = e =>
          (0, s.object)().shape({
            EXTERNAL_PHONE_ENABLED: (0, s.boolean)().required(),
            SMS_PROVIDER: (0, s.string)(),
            SMS_TWILIO_ACCOUNT_SID: (0, s.string)().when(
            ...
            SMS_TWILIO_AUTH_TOKEN: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'twilio'),
            ...
            SMS_TWILIO_MESSAGE_SERVICE_SID: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'twilio'),
                then: e => e.required('Twilio Message Service SID is required'),
                otherwise: e => e,
              }
            ),
            SMS_TWILIO_VERIFY_ACCOUNT_SID: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'twilio_verify'),
                then: e => e.required('Twilio Verify Account SID is required'),
                otherwise: e => e,
              }
            ),
            SMS_TWILIO_VERIFY_AUTH_TOKEN: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'twilio_verify'),
            ...
            SMS_TWILIO_VERIFY_MESSAGE_SERVICE_SID: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'twilio_verify'),
                then: e => e.required('Twilio Verify Service SID is required'),
                otherwise: e => e,
              }
            ),
            SMS_MESSAGEBIRD_ACCESS_KEY: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'messagebird'),
            ...
            SMS_MESSAGEBIRD_ORIGINATOR: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'messagebird'),
            ...
            SMS_TEXTLOCAL_API_KEY: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'textlocal'),
            ...
            SMS_TEXTLOCAL_SENDER: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'textlocal'),
            ...
            SMS_VONAGE_API_KEY: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'vonage'),
            ...
            SMS_VONAGE_API_SECRET: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'vonage'),
            ...
            SMS_VONAGE_FROM: (0, s.string)().when(
              ['EXTERNAL_PHONE_ENABLED', 'SMS_PROVIDER'],
              {
                ...a(e, 'vonage'),
            ...
            SMS_OTP_EXP: (0, s.number)()
              .min(0, 'Must be more than 0')
              .required('This is required'),
            SMS_OTP_LENGTH: (0, s.number)()
              .min(6, 'Must be 6 or more in length')
              .required('This is required'),
            SMS_TEMPLATE: (0, s.string)().required('SMS template is required.'),
            SMS_TEST_OTP: (0, s.string)()
              .matches(
            ...
            SMS_TEST_OTP_VALID_UNTIL: (0, s.string)().when(['SMS_TEST_OTP'], {
              is: e => !!e,
        ...
        _ = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_APPLE_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_APPLE_SECRET: (0, s.string)()
            ...
            EXTERNAL_APPLE_CLIENT_ID: (0, s.string)()
        ...
        h = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_AZURE_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_AZURE_CLIENT_ID: (0, s.string)().when(
            ...
            EXTERNAL_AZURE_SECRET: (0, s.string)().when(
              'EXTERNAL_AZURE_ENABLED',
              {
                is: !0,
            ...
            EXTERNAL_AZURE_URL: (0, s.string)()
              .matches((0, r.y)(), 'Must be a valid URL')
              .optional(),
          }),
        ...
        A = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_BITBUCKET_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_BITBUCKET_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_BITBUCKET_ENABLED',
              {
                is: !0,
            ...
            EXTERNAL_BITBUCKET_SECRET: (0, s.string)().when(
              'EXTERNAL_BITBUCKET_ENABLED',
              {
                is: !0,
        ...
        T = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_DISCORD_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_DISCORD_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_DISCORD_ENABLED',
              {
                is: !0,
            ...
            EXTERNAL_DISCORD_SECRET: (0, s.string)().when(
              'EXTERNAL_DISCORD_ENABLED',
              {
                is: !0,
        ...
        L = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_FACEBOOK_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_FACEBOOK_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_FACEBOOK_ENABLED',
              {
                is: !0,
            ...
            EXTERNAL_FACEBOOK_SECRET: (0, s.string)().when(
              'EXTERNAL_FACEBOOK_ENABLED',
              {
                is: !0,
        ...
        d = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_FIGMA_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_FIGMA_CLIENT_ID: (0, s.string)().when(
            ...
            EXTERNAL_FIGMA_SECRET: (0, s.string)().when(
              'EXTERNAL_FIGMA_ENABLED',
              {
                is: !0,
                then: e => e.required('Client Secret is required'),
        ...
        u = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_GITHUB_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_GITHUB_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_GITHUB_ENABLED',
              {
                is: !0,
                then: e => e.required('Client ID is required'),
            ...
            EXTERNAL_GITHUB_SECRET: (0, s.string)().when(
              'EXTERNAL_GITHUB_ENABLED',
              {
                is: !0,
                then: e => e.required('Client Secret is required'),
        ...
        p = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_GITLAB_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_GITLAB_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_GITLAB_ENABLED',
              {
                is: !0,
                then: e => e.required('Client ID is required'),
            ...
            EXTERNAL_GITLAB_SECRET: (0, s.string)().when(
              'EXTERNAL_GITLAB_ENABLED',
              {
                is: !0,
                then: e => e.required('Client Secret is required'),
            ...
            EXTERNAL_GITLAB_URL: (0, s.string)()
              .matches((0, r.y)(), 'Must be a valid URL')
              .optional(),
          }),
        ...
        S = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_GOOGLE_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_GOOGLE_CLIENT_ID: (0, s.string)()
              .matches(/^\S+$/, 'Client IDs should not contain spaces.')
              .matches(
                /^([a-z0-9-]+\.[a-z0-9-]+(\.[a-z0-9-]+)*(,[a-z0-9-]+\.[a-z0-9-]+(\.[a-z0-9-]+)*)*)$/i,
            ...
            EXTERNAL_GOOGLE_SECRET: (0, s.string)().when(
              'EXTERNAL_GOOGLE_ENABLED',
              {
                is: !0,
                then: e =>
            ...
            EXTERNAL_GOOGLE_SKIP_NONCE_CHECK: (0, s.boolean)().required(),
          }),
          misc: {
            iconKey: 'google-icon',
            requiresRedirect: !0,
        ...
        N = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_KAKAO_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_KAKAO_CLIENT_ID: (0, s.string)().when(
            ...
            EXTERNAL_KAKAO_SECRET: (0, s.string)().when(
              'EXTERNAL_KAKAO_ENABLED',
              {
                is: !0,
        ...
        R = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_KEYCLOAK_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_KEYCLOAK_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_KEYCLOAK_ENABLED',
              {
                is: !0,
                then: e => e.required('Client ID is required'),
            ...
            EXTERNAL_KEYCLOAK_SECRET: (0, s.string)().when(
              'EXTERNAL_KEYCLOAK_ENABLED',
              {
                is: !0,
                then: e => e.required('Client secret is required'),
            ...
            EXTERNAL_KEYCLOAK_URL: (0, s.string)().when(
              'EXTERNAL_KEYCLOAK_ENABLED',
              {
                is: !0,
                then: e =>
                ...
                otherwise: e => e.matches((0, r.y)(), 'Must be a valid URL'),
              }
            ),
          }),
        ...
        I = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_LINKEDIN_OIDC_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_LINKEDIN_OIDC_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_LINKEDIN_OIDC_ENABLED',
              {
                is: !0,
            ...
            EXTERNAL_LINKEDIN_OIDC_SECRET: (0, s.string)().when(
              'EXTERNAL_LINKEDIN_OIDC_ENABLED',
              {
                is: !0,
        ...
        g = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_NOTION_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_NOTION_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_NOTION_ENABLED',
              {
                is: !0,
            ...
            EXTERNAL_NOTION_SECRET: (0, s.string)().when(
              'EXTERNAL_NOTION_ENABLED',
              {
                is: !0,
        ...
        O = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_TWITCH_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_TWITCH_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_TWITCH_ENABLED',
              {
                is: !0,
                then: e => e.required('Client ID is required'),
            ...
            EXTERNAL_TWITCH_SECRET: (0, s.string)().when(
              'EXTERNAL_TWITCH_ENABLED',
              {
                is: !0,
                then: e => e.required('Client secret is required'),
        ...
        D = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_TWITTER_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_TWITTER_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_TWITTER_ENABLED',
              {
                is: !0,
                then: e => e.required('API Key is required'),
            ...
            EXTERNAL_TWITTER_SECRET: (0, s.string)().when(
              'EXTERNAL_TWITTER_ENABLED',
              {
                is: !0,
                then: e => e.required('API Secret Key is required'),
        ...
        m = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_SLACK_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_SLACK_CLIENT_ID: (0, s.string)().when(
            ...
            EXTERNAL_SLACK_SECRET: (0, s.string)().when(
              'EXTERNAL_SLACK_ENABLED',
              {
                is: !0,
                then: e => e.required('Client Secret is required'),
        ...
        b = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_SLACK_OIDC_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_SLACK_OIDC_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_SLACK_OIDC_ENABLED',
              {
                is: !0,
                then: e => e.required('Client ID is required'),
            ...
            EXTERNAL_SLACK_OIDC_SECRET: (0, s.string)().when(
              'EXTERNAL_SLACK_OIDC_ENABLED',
              {
                is: !0,
                then: e => e.required('Client Secret is required'),
        ...
        C = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_SPOTIFY_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_SPOTIFY_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_SPOTIFY_ENABLED',
              {
                is: !0,
                then: e => e.required('Client ID is required'),
            ...
            EXTERNAL_SPOTIFY_SECRET: (0, s.string)().when(
              'EXTERNAL_SPOTIFY_ENABLED',
              {
                is: !0,
                then: e => e.required('Client Secret is required'),
        ...
        y = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_WORKOS_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_WORKOS_URL: (0, s.string)()
              .matches((0, r.y)(), 'Must be a valid URL')
            ...
            EXTERNAL_WORKOS_CLIENT_ID: (0, s.string)().when(
              'EXTERNAL_WORKOS_ENABLED',
              {
                is: !0,
                then: e => e.required('Client ID is required'),
            ...
            EXTERNAL_WORKOS_SECRET: (0, s.string)().when(
              'EXTERNAL_WORKOS_ENABLED',
              {
                is: !0,
                then: e => e.required('Client Secret is required'),
        ...
        w = {
          ...
          validationSchema: (0, s.object)().shape({
            EXTERNAL_ZOOM_ENABLED: (0, s.boolean)().required(),
            EXTERNAL_ZOOM_CLIENT_ID: (0, s.string)().when(
            ...
            EXTERNAL_ZOOM_SECRET: (0, s.string)().when(
              'EXTERNAL_ZOOM_ENABLED',
              {
                is: !0,
                then: e => e.required('Client secret is required'),
        ...
        X = [
          ...
          c,
          {
            ...
            validationSchema: (0, s.object)().shape({
              SAML_ENABLED: (0, s.boolean)().required(),
              SAML_EXTERNAL_URL: (0, s.string)()
                .matches((0, r.y)(), 'Must be a valid URL')
                .optional(),
              SAML_ALLOW_ENCRYPTED_ASSERTIONS: (0, s.boolean)().optional(),
            }),
        ...
        return (0, s.jsxs)('div', {
          ...
          children: [
            ...
            (0, s.jsxs)('div', {
              ...
              children: [void 0 !== n && (0, s.jsx)(E.G, { href: n }), o],
            }),
          ],
        });
      };
