!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '0a2982c7-8f8e-4594-b2ac-5d2c110d51fc'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-0a2982c7-8f8e-4594-b2ac-5d2c110d51fc'));
  } catch (e) {}
})();
('use strict');
    ...
    38703: function (e, t, n) {
      ...
      var i,
        ...
        B = (e, t, n) =>
          t in e
            ...
            : (e[t] = n),
        $ = (e, t) => {
          for (var n in t || (t = {})) C.call(t, n) && B(e, n, t[n]);
          if (L) for (var n of L(t)) D.call(t, n) && B(e, n, t[n]);
          return e;
        },
        j = (e, t) => R(e, I(t)),
        P = (e, t) => {
          var n = {};
          for (var a in e) C.call(e, a) && 0 > t.indexOf(a) && (n[a] = e[a]);
          if (null != e && L)
            for (var a of L(e))
              0 > t.indexOf(a) && D.call(e, a) && (n[a] = e[a]);
          return n;
        },
        z =
          ((l =
                    ...
                    a = {
                      ...
                      highlight: function (e, t, n) {
                        ...
                        if ((a.hooks.run('before-tokenize', o), !o.grammar))
                          throw Error(
                            'The language "' + o.language + '" has no grammar.'
                          );
                        return (
                            ...
                            for (var u in s)
                              if (s.hasOwnProperty(u) && s[u]) {
                                ...
                                for (var d = 0; d < g.length; ++d) {
                                  ...
                                  for (
                                    var w = y.pattern || y, E = i.next, v = c;
                                    E !== n.tail && (!p || !(v >= p.reach));
                                    ...
                                    if (!(A instanceof r)) {
                                      ...
                                      if (m) {
                                        if (
                                          ...
                                          break;
                                        var F = x.index,
                                          _ = x.index + x[0].length,
                                          R = v;
                                        for (R += E.value.length; F >= R; )
                                          R += (E = E.next).value.length;
                                        if (
                                          ((R -= E.value.length),
                                          (v = R),
                                          E.value instanceof r)
                                        )
                                          continue;
                                        for (
                                          var T = E;
                                          T !== n.tail &&
                                          (R < _ || 'string' == typeof T.value);
                                          T = T.next
                                        )
                                          (S++, (R += T.value.length));
                                        (S--,
                                          (A = t.slice(v, R)),
                                          (x.index -= v));
                                      } else if (!(x = o(w, 0, A, f))) continue;
                                      var F = x.index,
                                        I = x[0],
                                        O = A.slice(0, F),
                                        L = A.slice(F + I.length),
                                        N = v + A.length;
                                      p && N > p.reach && (p.reach = N);
                                      var C = E.prev;
                                      if (
                                        (O &&
                                          ((C = l(n, C, O)), (v += O.length)),
                                        (function (e, t, n) {
                                          for (
                                            var a = t.next, r = 0;
                                            r < n && a !== e.tail;
            ...
            function () {
              return (
                r || (0, a[O(a)[0]])((r = { exports: {} }).exports, r),
                r.exports
              );
            })())
              ? F(N(o))
            ...
            if ((t && 'object' == typeof t) || 'function' == typeof t)
              for (let r of O(t))
                C.call(e, r) ||
                  ...
                  _(e, r, {
                    get: () => t[r],
                    enumerable: !(a = T(t, r)) || a.enumerable,
                  });
            return e;
          })(
            !s && o && o.__esModule
              ? l
              : _(l, 'default', { value: o, enumerable: !0 }),
            o
          ));
      ((z.languages.markup = {
        ...
        (z.languages.markup.tag.inside['attr-value'].inside.entity =
          z.languages.markup.entity),
        (z.languages.markup.doctype.inside['internal-subset'].inside =
          z.languages.markup),
        z.hooks.add('wrap', function (e) {
          'entity' === e.type &&
            (e.attributes.title = e.content.replace(/&amp;/, '&'));
        }),
        Object.defineProperty(z.languages.markup.tag, 'addInlined', {
          value: function (e, t) {
            var n = {},
              n =
                ((n['language-' + t] = {
            ...
            ((t[e] = {
              ...
              z.languages.insertBefore('markup', 'cdata', t));
          },
        }),
        Object.defineProperty(z.languages.markup.tag, 'addAttribute', {
          value: function (e, t) {
            z.languages.markup.tag.inside['special-attr'].push({
              pattern: RegExp(
                /(^|["'\s])/.source +
                  '(?:' +
                  e +
        ...
        (z.languages.html = z.languages.markup),
        (z.languages.mathml = z.languages.markup),
        (z.languages.svg = z.languages.markup),
        (z.languages.xml = z.languages.extend('markup', {})),
        (z.languages.ssml = z.languages.xml),
        (z.languages.atom = z.languages.xml),
        (z.languages.rss = z.languages.xml),
        ...
        (z.languages.javascript = z.languages.extend('clike', {
          'class-name': [
            z.languages.clike['class-name'],
            {
              pattern:
        ...
        (z.languages.javascript['class-name'][0].pattern =
          /(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/),
        z.languages.insertBefore('javascript', 'keyword', {
          regex: {
            pattern: RegExp(
        ...
        z.languages.insertBefore('javascript', 'string', {
        ...
        z.languages.insertBefore('javascript', 'operator', {
          'literal-property': {
            pattern:
        ...
        z.languages.markup &&
          (z.languages.markup.tag.addInlined('script', 'javascript'),
          z.languages.markup.tag.addAttribute(
            /on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/
              .source,
            'javascript'
          )),
        (z.languages.js = z.languages.javascript),
        (z.languages.actionscript = z.languages.extend('javascript', {
          keyword:
            /\b(?:as|break|case|catch|class|const|default|delete|do|dynamic|each|else|extends|final|finally|for|function|get|if|implements|import|in|include|instanceof|interface|internal|is|namespace|native|new|null|override|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|use|var|void|while|with)\b/,
          operator: /\+\+|--|(?:[+\-*\/%^]|&&?|\|\|?|<<?|>>?>?|[!=]=?)=?|[~?@]/,
        })),
        (z.languages.actionscript['class-name'].alias = 'function'),
        delete z.languages.actionscript.parameter,
        delete z.languages.actionscript['literal-property'],
        z.languages.markup &&
          z.languages.insertBefore('actionscript', 'string', {
            xml: {
              pattern:
                /(^|[^.])<\/?\w+(?:\s+[^\s>\/=]+=("|')(?:\\[\s\S]|(?!\2)[^\\])*\2)*\s*\/?>/,
              lookbehind: !0,
              inside: z.languages.markup,
            },
          }),
        (g = /#(?!\{).+/),
        (d = { pattern: /#\{[^}]+\}/, alias: 'variable' }),
        (z.languages.coffeescript = z.languages.extend('javascript', {
          comment: g,
          string: [
        ...
        z.languages.insertBefore('coffeescript', 'comment', {
          'multiline-comment': { pattern: /###[\s\S]+?###/, alias: 'comment' },
          'block-regex': {
            pattern: /\/{3}[\s\S]*?\/{3}/,
            alias: 'regex',
            inside: { comment: g, interpolation: d },
          },
        }),
        z.languages.insertBefore('coffeescript', 'string', {
          'inline-javascript': {
            pattern: /`(?:\\[\s\S]|[^\\`])*`/,
            inside: {
        ...
        z.languages.insertBefore('coffeescript', 'keyword', {
          property: /(?!\d)\w+(?=\s*:(?!:))/,
        }),
        delete z.languages.coffeescript['template-string'],
        (z.languages.coffee = z.languages.coffeescript),
        Object.defineProperty(
          (y = z.languages.javadoclike =
            {
              parameter: {
                pattern:
              ...
              (e = 'string' == typeof e ? [e] : e).forEach(function (e) {
                ...
                if ((r = z.languages[e])) {
                  ...
                  if (
                    ((o =
                      o ||
                      (r = z.languages.insertBefore(e, 'comment', {
                        'doc-comment': {
                          pattern: /(^|[^\\])\/\*\*[^/][\s\S]*?(?:\*\/|$)/,
                          lookbehind: !0,
                          alias: 'comment',
                        },
                      }))[a]) instanceof RegExp && (o = r[a] = { pattern: o }),
                    Array.isArray(o))
                  )
                    for (var s = 0, l = o.length; s < l; s++)
                      (o[s] instanceof RegExp && (o[s] = { pattern: o[s] }),
                        n(o[s]));
                  else n(o);
                }
              });
        ...
        y.addSupport(['java', 'javascript', 'php'], y),
        (b =
          /(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/),
        (z.languages.css = {
          comment: /\/\*[\s\S]*?\*\//,
          ...
          url: {
            ...
            inside: {
              function: /^url/i,
              punctuation: /^\(|\)$/,
              string: { pattern: RegExp('^' + b.source + '$'), alias: 'url' },
            },
          },
          selector: {
            pattern: RegExp(
        ...
        (z.languages.css.atrule.inside.rest = z.languages.css),
        (b = z.languages.markup) &&
          (b.tag.addInlined('style', 'css'),
          b.tag.addAttribute('style', 'css')),
        (function (e) {
          var t = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,
            t =
        ...
        z.hooks.add('after-tokenize', function (e) {
              ...
              if ('keyword' === a.type && 'mutation' === a.content) {
                ...
                if (
                  ...
                  for (; n < o; n++) {
                    var s = t[n + 0];
                    'variable' === s.type &&
                      (g(s, 'variable-input'), r.push(s.content));
                  }
                  n = o + 1;
                }
                if (
                  ...
                  '{' === t[n + 0].content &&
                  (g(t[++n + 0], 'property-mutation'), 0 < r.length)
                ) {
                  var l = u(/^\{$/, /^\}$/);
                  if (-1 !== l)
                    for (var i = n; i < l; i++) {
          ...
          function u(e, a) {
            for (var r = 1, o = n; o < t.length; o++) {
              var s = t[o],
                l = s.content;
              if ('punctuation' === s.type && 'string' == typeof l) {
                if (e.test(l)) r++;
                else if (a.test(l) && 0 == --r) return o;
              }
            }
            return -1;
          }
              ...
              (function t(n) {
                for (var s = 0, i = n.length; s < i; s++) {
                  var c,
                    ...
                    g = n[s];
                  'string' != typeof g &&
                    (Array.isArray((c = g.content))
                      ? 'template-string' === g.type
                        ? ((g = c[1]),
                          3 === c.length &&
                            'string' != typeof g &&
                            'embedded-code' === g.type &&
                            ((p = (function e(t) {
                            ...
                            (g = Array.isArray((g = g.alias)) ? g[0] : g),
                            (u = e.languages[g])) &&
                            (c[1] = (function (t, n, s) {
                              var i = e.tokenize(t, {
                                  interpolation: {
                                    ...
                                    'string' == typeof m.content
                                      ? ((s = u[c]),
                                        -1 !==
                                          ...
                                          (d = b.substring(f + s.length)),
                                          (y = []),
                                          i && y.push(i),
                                          y.push(g),
                                          d &&
                                            (t((b = [d])), y.push.apply(y, b)),
                                          'string' == typeof m
                                            ? (n.splice.apply(
                                                n,
                                                [o, 1].concat(y)
                                              ...
                                              (o += y.length - 1))
                                            : (m.content = y)))
                                      : Array.isArray((f = m.content))
                                        ? t(f)
                                        : t([f]);
                                  }
                                })(i),
                                new e.Token(s, i, 'language-' + s, t)
                              );
                            })(p, u, g)))
                        : t(c)
                      : 'string' != typeof c && t([c]));
        ...
        (z.languages.typescript = z.languages.extend('javascript', {
          'class-name': {
            pattern:
        ...
        z.languages.typescript.keyword.push(
          /\b(?:abstract|declare|is|keyof|readonly|require)\b/,
          /\b(?:asserts|infer|interface|module|namespace|type)\b(?=\s*(?:[{_$a-zA-Z\xA0-\uFFFF]|$))/,
          /\btype\b(?=\s*(?:[\{*]|$))/
        ),
        delete z.languages.typescript.parameter,
        delete z.languages.typescript['literal-property'],
        (f = z.languages.extend('typescript', {})),
        delete f['class-name'],
        (z.languages.typescript['class-name'].inside = f),
        z.languages.insertBefore('typescript', 'function', {
          decorator: {
            pattern: /@[$\w\xA0-\uFFFF]+/,
            inside: {
        ...
        (z.languages.ts = z.languages.typescript),
        (m = z.languages.javascript),
        (k =
          '(@(?:arg|argument|param|property)\\s+(?:' +
          (h = /\{(?:[^{}]|\{(?:[^{}]|\{[^{}]*\})*\})+\}/.source) +
          '\\s+)?)'),
        (z.languages.jsdoc = z.languages.extend('javadoclike', {
          parameter: {
        ...
        z.languages.insertBefore('jsdoc', 'keyword', {
          'optional-parameter': {
            pattern: RegExp(
              k + /\[(?:(?!\s)[$\w\xA0-\uFFFF.])+(?:=[^[\]]+)?\](?=\s|$)/.source
            ),
          ...
          'class-name': [
            ...
            {
              pattern: RegExp('(@[a-z]+\\s+)' + h),
              lookbehind: !0,
              inside: {
                string: m.string,
                number: m.number,
                boolean: m.boolean,
                keyword: z.languages.typescript.keyword,
                operator: /=>|\.\.\.|[&|?:*]/,
                punctuation: /[.,;=<>{}()[\]]/,
              },
            },
        ...
        z.languages.javadoclike.addSupport('javascript', z.languages.jsdoc),
        (z.languages.flow = z.languages.extend('javascript', {})),
        z.languages.insertBefore('flow', 'keyword', {
          type: [
            {
              pattern:
        ...
        (z.languages.flow['function-variable'].pattern =
          /(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=\s*(?:function\b|(?:\([^()]*\)(?:\s*:\s*\w+)?|(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/i),
        delete z.languages.flow.parameter,
        z.languages.insertBefore('flow', 'operator', {
          'flow-punctuation': { pattern: /\{\||\|\}/, alias: 'punctuation' },
        }),
        Array.isArray(z.languages.flow.keyword) ||
          (z.languages.flow.keyword = [z.languages.flow.keyword]),
        z.languages.flow.keyword.unshift(
          {
        ...
        (z.languages.n4js = z.languages.extend('javascript', {
          keyword:
        ...
        z.languages.insertBefore('n4js', 'constant', {
          annotation: { pattern: /@+\w+/, alias: 'operator' },
        }),
        (z.languages.n4jsd = z.languages.n4js),
        (function (e) {
          function t(e, t) {
            return RegExp(
              ...
              r =
                (o =
                  'RegExp' === e.util.type(o)
                    ? (e.languages.javascript[r] = { pattern: o })
                    : o).inside || {};
            (o.inside = r)['maybe-class-name'] = /^[A-Z][\s\S]*/;
          }
        })(z),
        (function (e) {
        ...
        (w = z.util.clone(z.languages.typescript)),
        (((z.languages.tsx = z.languages.extend('jsx', w)),
        delete z.languages.tsx.parameter,
        delete z.languages.tsx['literal-property'],
        (w = z.languages.tsx.tag)).pattern = RegExp(
          /(^|[^\w$]|(?=<\/))/.source + '(?:' + w.pattern.source + ')',
          w.pattern.flags
        )),
        (w.lookbehind = !0),
        (z.languages.swift = {
        ...
        z.languages.swift['string-literal'].forEach(function (e) {
          e.inside.interpolation.inside = z.languages.swift;
        }),
        (z.languages.kotlin = z.languages.extend('clike', {
          keyword: {
            pattern:
        ...
        delete z.languages.kotlin['class-name'],
        (E = {
          'interpolation-punctuation': {
            pattern: /^\$\{?|\}$/,
            alias: 'punctuation',
          },
          expression: { pattern: /[\s\S]+/, inside: z.languages.kotlin },
        }),
        z.languages.insertBefore('kotlin', 'string', {
          'string-literal': [
            {
              pattern: /"""(?:[^$]|\$(?:(?!\{)|\{[^{}]*\}))*?"""/,
              alias: 'multiline',
        ...
        delete z.languages.kotlin.string,
        z.languages.insertBefore('kotlin', 'keyword', {
          annotation: {
            pattern: /\B@(?:\w+:)?(?:[A-Z]\w*|\[[^\]]+\])/,
            alias: 'builtin',
          },
        }),
        z.languages.insertBefore('kotlin', 'function', {
          label: { pattern: /\b\w+@|@\w+\b/, alias: 'symbol' },
        }),
        (z.languages.kt = z.languages.kotlin),
        (z.languages.kts = z.languages.kotlin),
        (z.languages.c = z.languages.extend('clike', {
          comment: {
            pattern:
              /\/\/(?:[^\r\n\\]|\\(?:\r\n?|\n|(?![\r\n])))*|\/\*[\s\S]*?(?:\*\/|$)/,
            greedy: !0,
        ...
        z.languages.insertBefore('c', 'string', {
          char: {
            pattern: /'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n]){0,32}'/,
            greedy: !0,
          },
          ...
          macro: {
            ...
            inside: {
              string: [
                ...
                z.languages.c.string,
              ],
              char: z.languages.c.char,
              comment: z.languages.c.comment,
              'macro-name': [
              ...
              'directive-hash': /^#/,
              punctuation: /##|\\(?=[\r\n])/,
              expression: { pattern: /\S[\s\S]*/, inside: z.languages.c },
            },
          },
        }),
        z.languages.insertBefore('c', 'function', {
          constant:
            /\b(?:EOF|NULL|SEEK_CUR|SEEK_END|SEEK_SET|__DATE__|__FILE__|__LINE__|__TIMESTAMP__|__TIME__|__func__|stderr|stdin|stdout)\b/,
        }),
        delete z.languages.c.boolean,
        (z.languages.objectivec = z.languages.extend('c', {
          string: {
            pattern: /@?"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"/,
            greedy: !0,
          },
        ...
        delete z.languages.objectivec['class-name'],
        (z.languages.objc = z.languages.objectivec),
        (z.languages.reason = z.languages.extend('clike', {
          string: {
            pattern: /"(?:\\(?:\r\n|[\s\S])|[^\\\r\n"])*"/,
            greedy: !0,
          },
        ...
        z.languages.insertBefore('reason', 'class-name', {
          char: {
            pattern:
        ...
        delete z.languages.reason.function,
        (function (e) {
          for (
        ...
        (z.languages.go = z.languages.extend('clike', {
          string: {
            pattern: /(^|[^\\])"(?:\\.|[^"\\\r\n])*"|`[^`]*`/,
            lookbehind: !0,
            greedy: !0,
        ...
        z.languages.insertBefore('go', 'string', {
          char: { pattern: /'(?:\\.|[^'\\\r\n]){0,10}'/, greedy: !0 },
        }),
        delete z.languages.go['class-name'],
        (v =
        ...
        (x = /\b(?!<keyword>)\w+(?:\s*\.\s*\w+)*\b/.source.replace(
          /<keyword>/g,
          function () {
            return v.source;
          }
        )),
        (z.languages.cpp = z.languages.extend('c', {
          'class-name': [
            {
              pattern: RegExp(
        ...
        z.languages.insertBefore('cpp', 'string', {
          module: {
            pattern: RegExp(
        ...
        z.languages.insertBefore('cpp', 'keyword', {
          'generic-function': {
            pattern:
            ...
            inside: {
              ...
              generic: {
                pattern: /<[\s\S]+/,
                alias: 'class-name',
                inside: z.languages.cpp,
              },
            },
          },
        }),
        z.languages.insertBefore('cpp', 'operator', {
          'double-colon': { pattern: /::/, alias: 'punctuation' },
        }),
        z.languages.insertBefore('cpp', 'class-name', {
          'base-clause': {
            pattern:
              /(\b(?:class|struct)\s+\w+\s*:\s*)[^;{}"'\s]+(?:\s+[^;{}"'\s]+)*(?=\s*[;{])/,
            lookbehind: !0,
            greedy: !0,
            inside: z.languages.extend('cpp', {}),
          },
        }),
        z.languages.insertBefore(
          'inside',
          'double-colon',
          { 'class-name': /\b[a-z_]\w*\b(?!\s*::)/i },
          z.languages.cpp['base-clause']
        ),
        (z.languages.python = {
        ...
        (z.languages.python[
          'string-interpolation'
        ].inside.interpolation.inside.rest = z.languages.python),
        (z.languages.py = z.languages.python));
      var M = {};
      ((e, t) => {
      ...
      var U = {
        ...
        V = {
          ...
          styles: [
            { types: ['attr-name'], style: { color: H } },
            { types: ['attr-value'], style: { color: K } },
            {
              types: [
                'comment',
                'block-comment',
            ...
            { types: ['string'], style: { color: K } },
            { types: ['punctuation'], style: { color: K } },
            {
        ...
        ei = (e, t) => {
          let { plain: n } = e,
            a = e.styles.reduce((e, n) => {
              let { languages: a, style: r } = n;
              return (
                (a && !a.includes(t)) ||
                  n.types.forEach(t => {
                    let n = $($({}, e[t]), r);
          ...
          return (
            (a.root = n),
            (a.plain = j($({}, n), { backgroundColor: void 0 })),
            a
          );
        },
        ec = (e, t) => {
          let [n, a] = (0, A.useState)(ei(t, e)),
            r = (0, A.useRef)(),
            o = (0, A.useRef)();
          return (
            (0, A.useEffect)(() => {
              (t !== r.current || e !== o.current) &&
                ((r.current = t), (o.current = e), a(ei(t, e)));
            }, [e, t]),
            n
          );
        },
        ep = e =>
          (0, A.useCallback)(
            t => {
              var { className: n, style: a, line: r } = t;
              let o = j($({}, P(t, ['className', 'style', 'line'])), {
                className: (0, S.Z)('token-line', n),
              });
              return (
                'object' == typeof e && 'plain' in e && (o.style = e.plain),
                'object' == typeof a && (o.style = $($({}, o.style || {}), a)),
                o
              );
            },
            [e]
        ...
        eu = e => {
          ...
          return (0, A.useCallback)(
            e => {
              var { token: n, className: a, style: r } = e;
              let o = j($({}, P(e, ['token', 'className', 'style'])), {
                className: (0, S.Z)('token', ...n.types, a),
                children: n.content,
                style: t(n),
              });
              return (null != r && (o.style = $($({}, o.style || {}), r)), o);
            },
            [t]
          );
        },
            ...
            for (; (o = a[s]++) < r[s]; ) {
              ...
              if (
                ('string' == typeof p
                  ? ((c = s > 0 ? c : ['plain']), (e = p))
                  : ((c = ey(c, p.type)),
                    p.alias && (c = ey(c, p.alias)),
                    (e = p.content)),
                'string' != typeof e)
              ) {
                (s++, t.push(c), n.push(e), a.push(0), r.push(e.length));
                continue;
              }
              let u = e.split(eg),
                g = u.length;
              l.push({ types: c, content: u[0] });
              for (let e = 1; e < g; e++)
                (ed(l), i.push((l = [])), l.push({ types: c, content: u[e] }));
            }
            (s--, t.pop(), n.pop(), a.pop(), r.pop());
          }
          return (ed(l), i);
        },
        ef = ({ prism: e, code: t, grammar: n, language: a }) => {
          let r = (0, A.useRef)(e);
          return (0, A.useMemo)(() => {
            if (null == n) return eb([t]);
            let e = { code: t, grammar: n, language: a, tokens: [] };
            return (
              r.current.hooks.run('before-tokenize', e),
              (e.tokens = r.current.tokenize(t, n)),
              r.current.hooks.run('after-tokenize', e),
              eb(e.tokens)
            );
          }, [t, n, a]);
        },
        em = ({ children: e, language: t, code: n, theme: a, prism: r }) => {
          let o = t.toLowerCase(),
            s = ec(o, a),
            l = ep(s),
            i = eu(s),
            c = r.languages[o];
          return e({
            tokens: ef({ prism: r, language: o, code: n, grammar: c }),
