!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '244a8653-eefb-4259-9c56-cda9955afdf6'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-244a8653-eefb-4259-9c56-cda9955afdf6'));
  } catch (e) {}
})();
('use strict');
        ...
        let {
          ...
          j = e => {
            ...
            return (
              ...
              (0, n.jsx)('span', {
                className:
                  'text-xs text-foreground-muted group-hover:text-foreground-lighter group-data-[state=active]:text-foreground-lighter transition',
          ...
          Z = [
            ...
            return {
              ...
              renderHeaderCell: () =>
                (0, n.jsx)('div', {
                  className:
                    'flex items-center justify-between font-mono font-normal text-xs w-full',
                  children: (0, n.jsxs)('div', {
                    className: 'flex items-center gap-x-2',
                    children: [
                      (0, n.jsx)('p', {
                ...
                (0, n.jsxs)(m.AW, {
                  ...
                  children: [
                    ...
                    (0, n.jsxs)(m.Xi, {
                      onClick: () => {
                        if (navigator) {
                          0 == p.length && (0, c.Am)('Results are empty');
