(!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '2e5dd5af-11d7-4ee4-983a-e3e972c46d82'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-2e5dd5af-11d7-4ee4-983a-e3e972c46d82'));
  } catch (e) {}
})(),
  (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [7704],
    {
      ...
      29979: function (e, t, s) {
        ...
        function l(e) {
          let t = [];
          if (e) for (var s in e) t.push({ name: s, value: e[s] });
          return { value: t };
        }
      },
      ...
      32875: function (e, t, s) {
        ...
        let c = function (e) {
          ...
          return (0, a.a)(
            ...
            e => {
              let { signal: n } = e;
              return i({ projectRef: t, connectionString: s }, n);
            },
            { enabled: n && void 0 !== t, ...l }
          );
        };
      },
      61138: function (e, t, s) {
        'use strict';
        s.d(t, {
          Z: function () {
            return n;
        ...
        let p = e => [
          ...
          y = () => {
            let { ref: e = 'default' } = (0, a.UO)(),
              t = (0, l.ar)();
            (0, i.kM)({ projectRef: e });
            let s = (0, r.useRouter)().pathname.split('/')[4];
          ...
          return (0, n.jsxs)('div', {
            ...
            children: [
              ...
              (0, n.jsxs)('div', {
                ...
                children: [void 0 !== l && (0, n.jsx)(r.G, { href: l }), o],
              }),
            ],
          });
        };
      ...
      84552: function (e, t, s) {
        ...
        t.Z = e => {
          let {
              ...
              onChange: k,
              filterFunction: w = () => !0,
              noResultsLabel: S = (0, n.jsx)('span', {
                children: 'No functions found in this schema.',
              }),
            } = e,
            C = (0, y.useRouter)(),
            { ref: _ } = (0, b.UO)(),
            ...
            V = (null != O ? O : []).filter(e => v && e.schema === v).filter(w),
            z = r()(V, e => e.name);
          return (0, n.jsxs)('div', {
            className: t,
            'data-sentry-component': 'FunctionSelector',
            'data-sentry-source-file': 'FunctionSelector.tsx',
            children: [
              R &&
                (0, n.jsx)(h.z, {
                  type: 'default',
                ...
                (0, n.jsxs)(m.bZ, {
                  ...
                  children: [
                    (0, n.jsx)(m.Cd, {
                      ...
                      children: 'Failed to load functions',
                    }),
                    (0, n.jsxs)(m.X, {
      ...
      66902: function (e, t, s) {
        ...
        t.Z = e => {
          let {
              ...
              excludedSchemas: v = [],
              onSelectSchema: N,
              onSelectCreateSchema: k,
            } = e,
            [w, S] = (0, o.useState)(!1),
            C = (0, u.Xo)(i.KA.TENANT_SQL_ADMIN_WRITE, 'schemas'),
            { project: _ } = (0, c.d2)(),
            {
              data: T,
              isLoading: E,
                ...
                (0, n.jsxs)(m.bZ, {
                  ...
                  children: [
                    ...
                    (0, n.jsxs)(m.X, {
                      ...
                      children: ['Error: ', null == H ? void 0 : H.message],
                    }),
                    (0, n.jsx)(h.z, {
                      type: 'default',
                      size: 'tiny',
      ...
      21285: function (e, t, s) {
        ...
        let g = function () {
          ...
          return (0, x.D)(e => y(e), {
            async onSuccess(t, s, a) {
              let { projectRef: r } = s;
              (await n.invalidateQueries(p.o.authConfig(r)),
                await (null == e ? void 0 : e(t, s, a)));
            },
            async onError(e, s, n) {
              void 0 === t
                ? l.Am.error('Failed to update auth hooks: '.concat(e.message))
                : t(e, s, n);
            },
            ...s,
          });
        ...
        let A = [
            {
              title: 'Send SMS hook',
              subtitle:
                'Will be called by Supabase Auth each time an SMS message needs to be sent.',
            ...
            },
            {
              ...
              subtitle:
                'Will be called by Supabase Auth each time an email message needs to be sent.',
          ...
          O = (e, t) => {
            if (e.startsWith('https'))
              return { type: 'https', url: e, secret: t || '' };
            {
              let [t, s, n, a, r] = (e || '').split('/');
              return {
                type: 'postgres',
                schema: a || '',
                functionName: r || '',
          ...
          H = e =>
            ('postgres' === e.method.type &&
              e.method.schema.length > 0 &&
              e.method.functionName.length > 0) ||
            ('https' === e.method.type &&
              e.method.url.startsWith('https') &&
              e.method.secret.length > 0),
          R = (e, t) => [
            '-- Revoke access to function from supabase_auth_admin\nrevoke execute on function '
              .concat(e, '.')
              .concat(t, ' from supabase_auth_admin;'),
            '-- Revoke access to schema from supabase_auth_admin\nrevoke usage on schema '.concat(
              e,
              ' from supabase_auth_admin;'
            ),
            '-- Restore function permissions to authenticated, anon and public\ngrant execute on function '
              .concat(e, '.')
              .concat(t, ' to authenticated, anon, public;'),
          ],
          K = e => {
            var t;
            let { buttonText: s = 'Add hook', onSelectHook: r } = e,
              { ref: l } = (0, o.UO)(),
              i = (0, C.l)(),
              { data: c } = (0, w.Gl)(
                { orgSlug: null == i ? void 0 : i.slug },
                { enabled: _.Qy }
              ),
              { data: d } = (0, h.$E)({ projectRef: l }),
              u = (0, S.Xo)(a.KA.AUTH_EXECUTE, '*'),
              m = A.map(e => ({
                ...e,
                enabled: (null == d ? void 0 : d[e.enabledKey]) || !1,
                method: O(
                  (null == d ? void 0 : d[e.uriKey]) || '',
                  (null == d ? void 0 : d[e.secretsKey]) || ''
                ),
              })),
              x = m.filter(e => !H(e) && !e.enterprise),
              f = m.filter(e => !H(e) && e.enterprise),
              p =
                (null == c ? void 0 : c.plan.id) === 'team' ||
                (null == c ? void 0 : c.plan.id) === 'enterprise';
            return u
              ? (0, n.jsxs)(T.h_, {
                  modal: !1,
                  'data-sentry-element': 'DropdownMenu',
                  'data-sentry-component': 'AddHookDropdown',
                  'data-sentry-source-file': 'AddHookDropdown.tsx',
                  children: [
                    (0, n.jsx)(T.$F, {
                      asChild: !0,
                      ...
                      children: [
                        (0, n.jsx)('div', {
                          children: x.map(e =>
                            (0, n.jsx)(
                              T.Xi,
                              { onClick: () => r(e.title), children: e.title },
                              e.title
                            )
                          ),
                        }),
                        ...
                        !p &&
                          (0, n.jsxs)(T.Ju, {
                            className: 'grid gap-1 bg-surface-200',
                            children: [
                              (0, n.jsx)('p', {
                                className: 'text-foreground-light',
                                children: 'Team or Enterprise Plan required',
                              }),
                              (0, n.jsxs)('p', {
                                ...
                                children: [
                                  ...
                                  (0, n.jsx)('a', {
                                    target: '_href',
                                    href: 'https://supabase.com/dashboard/org/'.concat(
                                      null !==
                                        (t = null == i ? void 0 : i.slug) &&
                                        void 0 !== t
                                        ? t
                                        : '_',
                                      '/billing'
              ...
              : (0, n.jsx)(k.u, {
                  ...
                  tooltip: {
                    content: {
                      side: 'bottom',
                      text: 'You need additional permissions to add auth hooks',
                    },
                  },
                  children: s,
                });
        ...
        var M = s(78751),
          ...
          G = s(56740),
          J = s(78366);
        let Y = 'create-edit-auth-hook',
          $ = L.Ry({
            hookType: L.Z_(),
            enabled: L.O7(),
            selectedType: L.G0([L.i0('https'), L.i0('postgres')]),
            httpsValues: L.Ry({ url: L.Z_(), secret: L.Z_() }),
            postgresValues: L.Ry({ schema: L.Z_(), functionName: L.Z_() }),
          }).superRefine(
            (e, t) => (
              'https' !== e.selectedType ||
                (e.httpsValues.url.startsWith('https://') ||
                  t.addIssue({
                    path: ['httpsValues', 'url'],
                    code: L.NL.custom,
                    message: 'The URL must start with https://',
                  }),
                e.httpsValues.secret ||
                  t.addIssue({
                    path: ['httpsValues', 'secret'],
                    code: L.NL.custom,
                    message: 'Missing secret value',
                  })),
              'postgres' !== e.selectedType ||
                (e.postgresValues.schema ||
                  t.addIssue({
                    path: ['postgresValues', 'schema'],
                    code: L.NL.custom,
                    message: 'You must select a schema',
                  }),
                e.postgresValues.functionName ||
                  t.addIssue({
          ...
          ee = e => {
            let {
              ...
              { ref: h } = (0, o.UO)(),
              { project: m } = (0, i.d2)(),
              x = (0, r.useMemo)(() => A.find(e => e.title === s) || A[0], [s]),
              f =
                'HOOK_SEND_EMAIL_ENABLED' === x.enabledKey
                  ? ['json', 'jsonb', 'void']
                  : ['json', 'jsonb'],
              p = (0, r.useMemo)(
                () => ({
                  ...x,
                  enabled: (null == a ? void 0 : a[x.enabledKey]) || !1,
                  method: O(
                    (null == a ? void 0 : a[x.uriKey]) || '',
                    (null == a ? void 0 : a[x.secretsKey]) || ''
                  ),
                }),
                [x, a]
              ),
              ...
              k = (0, r.useMemo)(() => {
                let e = [];
                return (
                  'postgres' === p.method.type &&
                    '' !== p.method.schema &&
                    '' !== p.method.functionName &&
                    p.method.functionName !== N.postgresValues.functionName &&
                    (e = R(p.method.schema, p.method.functionName)),
                  '' !== N.postgresValues.functionName &&
                    (e = [
                      ...e,
                      '-- Grant access to function to supabase_auth_admin\ngrant execute on function '
                        .concat(N.postgresValues.schema, '.')
                        .concat(
                          N.postgresValues.functionName,
                          ' to supabase_auth_admin;'
                        ),
                      '-- Grant access to schema to supabase_auth_admin\ngrant usage on schema '.concat(
                        N.postgresValues.schema,
                        ' to supabase_auth_admin;'
                      ),
              ...
              }, [p, N.postgresValues.schema, N.postgresValues.functionName]),
              { mutate: w, isLoading: S } = g({
                onSuccess: () => {
                  (l.Am.success(
                    'Successfully created '.concat(N.hookType, '.')
                  ),
                    k.length > 0 &&
                      (0, j.R)({
                        projectRef: h,
                ...
                onError: e => {
                  l.Am.error('Failed to create hook: '.concat(e.message));
                },
              }),
              C = async e => {
                if (!m) return console.error('Project is required');
                let t = A.find(t => e.hookType === t.title);
                if (!t) return;
                let s = t.enabledKey,
                  n = t.uriKey,
                  a = t.secretsKey,
                ...
                ((r =
                  'postgres' === e.selectedType
                    ? 'pg-functions://postgres/'
                        .concat(e.postgresValues.schema, '/')
                        .concat(e.postgresValues.functionName)
                    : e.httpsValues.url),
                  w({
                    projectRef: h,
                    config: {
            ...
            return (
                ...
                if (t) {
                  if (x) {
                    ...
                    v.reset({
                      ...
                      selectedType: e.type,
                      httpsValues: {
                        url: ('https' === e.type && e.url) || '',
                        secret: ('https' === e.type && e.secret) || '',
                      },
                      postgresValues: {
                        schema: ('postgres' === e.type && e.schema) || 'public',
                        functionName:
                          ('postgres' === e.type && e.functionName) || '',
                      },
                    });
                  } else
                    v.reset({
              ...
              (0, n.jsx)(U.yo, {
                ...
                'data-sentry-component': 'CreateHookSheet',
                'data-sentry-source-file': 'CreateHookSheet.tsx',
                children: (0, n.jsxs)(U.ue, {
                  size: 'lg',
                  showClose: !1,
                      ...
                      children: (0, n.jsx)(X.l0, {
                        ...
                        children: (0, n.jsxs)('form', {
                          ...
                          children: [
                              ...
                              X.Wi,
                              {
                                ...
                                render: e => {
                                  ...
                                  return (0, n.jsx)(J.E, {
                                    layout: 'flex',
                                    className: 'px-5',
                                    label: 'Enable '.concat(N.hookType),
                                    description:
                                      'Send SMS hook' === N.hookType
                                        ? 'SMS Provider settings will be disabled in favor of SMS hooks'
                                        : void 0,
                                    children: (0, n.jsx)(X.NI, {
                            ...
                            'postgres' === N.selectedType
                              ? (0, n.jsxs)(n.Fragment, {
                                  children: [
                                    (0, n.jsxs)('div', {
                                      className: 'grid grid-cols-2 gap-8 px-5',
                                      children: [
                                        (0, n.jsx)(
                                          X.Wi,
                                          {
                                            ...
                                            render: e => {
                                              ...
                                              return (0, n.jsx)(J.E, {
                                                ...
                                                description:
                                                  'Postgres schema where the function is defined',
                                                children: (0, n.jsx)(X.NI, {
                                        ...
                                        (0, n.jsx)(
                                          ...
                                          'postgresValues.functionName'
                                        ),
                                      ],
                                    }),
                                    (0, n.jsxs)('div', {
                                      className:
                                        'h-72 w-full gap-3 flex flex-col',
                                      children: [
                                        (0, n.jsx)('p', {
                                          className:
                    ...
                    (0, n.jsxs)(U.FF, {
                      ...
                      children: [
                        ...
                        (0, n.jsx)(E.z, {
                          ...
                          'data-sentry-element': 'Button',
                          'data-sentry-source-file': 'CreateHookSheet.tsx',
                          children: y ? 'Create hook' : 'Update hook',
                        }),
                      ],
                    }),
                  ],
        ...
        var et = s(61138),
          ...
          er = s(45536);
        let el = e => {
            let { hook: t, onSelect: s } = e,
              r = (0, S.Xo)(a.KA.AUTH_EXECUTE, '*');
            return (0, n.jsxs)('div', {
              className:
                'bg-surface-100 border-default overflow-hidden border shadow px-5 py-4 flex flex-row first:rounded-t-md last:rounded-b-md space-x-4',
              'data-sentry-component': 'HookCard',
              'data-sentry-source-file': 'HookCard.tsx',
              children: [
                (0, n.jsx)('div', {
                  className: '',
                  children: (0, n.jsx)(et.Z, {
                    size: 21,
                    strokeWidth: '1',
                    'data-sentry-element': 'Webhook',
                    'data-sentry-source-file': 'HookCard.tsx',
                  }),
                }),
                (0, n.jsxs)('div', {
                  className: 'flex flex-col flex-0 overflow-y-auto w-full',
                  children: [
                    (0, n.jsx)('span', {
                    ...
                    (0, n.jsx)('div', {
                      className: 'text-sm flex flex-row space-x-5 py-4',
                      children:
                        'postgres' === t.method.type
                          ? (0, n.jsxs)('div', {
                              ...
                              children: [
                                (0, n.jsxs)('div', {
                                  ...
                                  children: [
                                    (0, n.jsx)('span', {
                                      className: 'text-foreground-light w-20',
                                      children: 'type',
                                    }),
                                    (0, n.jsx)('span', {
                                      className: 'text-foreground',
                                      children: 'Postgres function',
                                    }),
                                  ],
                                }),
                                (0, n.jsxs)('div', {
                                  ...
                                  children: [
                                    ...
                                    (0, n.jsx)(en.Z, {
                                      title: t.method.schema,
                                      copy: !0,
                                      readOnly: !0,
                                      disabled: !0,
                                      className:
                                        'input-mono [&>div>div>div>input]:text-xs [&>div>div>div>input]:opacity-100 flex-1',
                                      value: t.method.schema,
                                      onCopy: () =>
                                        'postgres' === t.method.type &&
                                        (0, er.vQ)(t.method.schema),
                                    }),
                                  ],
                                }),
                                (0, n.jsxs)('div', {
                                  ...
                                  children: [
                                    ...
                                    (0, n.jsx)(en.Z, {
                                      title: t.method.functionName,
                                      copy: !0,
                                      readOnly: !0,
                                      disabled: !0,
                                      className:
                                        'input-mono [&>div>div>div>input]:text-xs [&>div>div>div>input]:opacity-100 flex-1',
                                      value: t.method.functionName,
                                      onCopy: () =>
                                        'postgres' === t.method.type &&
                                        (0, er.vQ)(t.method.functionName),
                                    }),
                                  ],
                                }),
                              ],
                              ...
                              children: [
                                ...
                                (0, n.jsxs)('div', {
                                  ...
                                  children: [
                                    ...
                                    (0, n.jsx)(en.Z, {
                                      copy: !0,
                                      title: t.method.secret,
                                      reveal: !0,
                                      readOnly: !0,
                                      disabled: !0,
                                      className:
                                        'input-mono [&>div>div>div>input]:text-xs [&>div>div>div>input]:opacity-100 flex-1',
                                      value: t.method.secret,
                                    }),
                                  ],
                                }),
                              ],
                  ...
                  children: t.enabled
                    ? (0, n.jsxs)(ea.C, {
                        ...
                        children: [
                          ...
                          (0, n.jsx)('span', { children: 'Enabled' }),
                        ],
                      })
                    : (0, n.jsx)(ea.C, {
                        variant: 'warning',
                        children: (0, n.jsx)('span', { children: 'Disabled' }),
                      }),
                }),
              ],
            });
          ...
          eo = () => {
            let { ref: e } = (0, o.UO)(),
              { project: t } = (0, i.d2)(),
              { data: s, error: a, isError: m } = (0, h.$E)({ projectRef: e }),
              [x, f] = (0, r.useState)(null),
              [p, y] = (0, r.useState)(null),
              { mutate: N, isLoading: k } = g({
                onSuccess: async () => {
                  if (!p) return;
                  let { method: s } = p;
                  if ('postgres' === s.type) {
                    let n = R(s.schema, s.functionName);
                    await (0, j.R)({
                      projectRef: e,
                  ...
                  (l.Am.success(''.concat(p.title, ' has been deleted.')),
                    y(null),
                    f(null));
                },
                onError: e => {
                  l.Am.error('Failed to delete hook: '.concat(e.message));
                },
              }),
              w = A.map(e => ({
                ...e,
                enabled: (null == s ? void 0 : s[e.enabledKey]) || !1,
                method: O(
                  (null == s ? void 0 : s[e.uriKey]) || '',
                  (null == s ? void 0 : s[e.secretsKey]) || ''
                ),
              }));
            return m
              ? (0, n.jsx)(c.Z, {
              ...
              : (0, n.jsxs)('div', {
                  ...
                  'data-sentry-source-file': 'HooksListing.tsx',
                  children: [
                    (0, n.jsx)(u.p, {
                      title: 'Auth Hooks',
                      description:
                        'Use Postgres functions or HTTP endpoints to customize the behavior of Supabase Auth to meet your needs.',
                      actions: (0, n.jsx)(K, { onSelectHook: f }),
                      'data-sentry-element': 'FormHeader',
                      'data-sentry-source-file': 'HooksListing.tsx',
                    }),
                    0 === w.filter(e => H(e)).length &&
                      (0, n.jsxs)('div', {
                        className:
                        ...
                        children: [
                          (0, n.jsx)('p', {
                            className: 'text-sm text-foreground-light',
                            children: 'No hooks configured yet',
                          }),
                          (0, n.jsx)(K, {
                    ...
                    (0, n.jsx)(ee, {
                      ...
                      visible: !!x,
                      onDelete: () => {
                        let e = w.find(e => e.title === x);
                        e && y(e);
                      },
                      onClose: () => f(null),
                      authConfig: s,
                      'data-sentry-element': 'CreateHookSheet',
                      'data-sentry-source-file': 'HooksListing.tsx',
                    }),
                    (0, n.jsx)(v.Z, {
                      visible: !!p,
                      ...
                      children: (0, n.jsxs)('div', {
                        children: [
                          ...
                          (null == p ? void 0 : p.method.type) === 'postgres' &&
                            (0, n.jsxs)(n.Fragment, {
                              children: [
                                (0, n.jsxs)('p', {
                                  className: 'text-sm text-foreground-light',
                                  children: [
                                    ...
                                    ' ',
                                    null == p ? void 0 : p.method.schema,
                                    '.',
                                    null == p ? void 0 : p.method.functionName,
                                    ' function:',
                                  ],
                                }),
                                (0, n.jsx)('div', {
                                  className: (0, b.cn)('mt-4', 'h-72'),
        ...
        var ei = s(7539),
          ...
          ed = s(61767);
        let eu = () => {
          let e = (0, S.Xo)(a.KA.READ, 'custom_config_gotrue');
          return (0, S.N4)() && !e
            ? (0, n.jsx)(ed.Z, {
                isFullPage: !0,
                resourceText: "access your project's auth hooks",
              })
            : (0, n.jsx)(ec.l, { children: (0, n.jsx)(eo, {}) });
        };
        eu.getLayout = e => (0, n.jsx)(ei.Z, { children: e });
        var eh = eu;
      },
      94059: function (e, t, s) {
        ...
        let i = (0, a.createContext)({ type: 'text' }),
          c = e => {
            let { type: t } = e;
        ...
        ((u.Item = function (e) {
          let {
            ...
            { type: x } = d(),
            f = [m.item.base];
          (f.push(m.item.variants[x].base),
            a
              ? f.push(m.item.variants[x].active)
              : f.push(m.item.variants[x].normal));
          let p = [m.item.content.base];
          a ? p.push(m.item.content.active) : p.push(m.item.content.normal);
          let y = [m.item.icon.base];
          return (
            a ? y.push(m.item.icon.active) : y.push(m.item.icon.normal),
            (0, n.jsxs)('li', {
              role: 'menuitem',
              className: (0, l.cn)('outline-none', f),
              style: h,
              onClick: i,
          ...
          (u.Group = function (e) {
            let { children: t, icon: s, title: a } = e,
              ...
              { type: o } = d();
            return (0, n.jsxs)('div', {
              className: [l.group.base, l.group.variants[o]].join(' '),
      ...
      67783: function (e, t, s) {
        ...
        let c = r.forwardRef((e, t) => {
          let { className: s, ...r } = e;
          return (0, n.jsx)(a.fC, {
            className: (0, i.cn)('flex flex-col -space-y-px w-full', s),
            ...r,
            ref: t,
          });
        });
        c.displayName = 'RadioGroupStacked';
        let d = r.forwardRef((e, t) => {
          let { image: s, label: r, showIndicator: c = !0, ...d } = e;
          return (0, n.jsx)(a.ck, {
            ref: t,
            ...d,
            className: (0, i.cn)(
            ...
            children: (0, n.jsxs)('div', {
              className: 'flex gap-3 w-full px-[21px] py-3',
              children: [
                c &&
                  (0, n.jsx)('div', {
                    className: (0, i.cn)(
                ...
                (0, n.jsxs)('div', {
                  className: 'flex flex-col gap-0.25 items-start',
                  children: [
                    (0, n.jsx)(o._, {
                      htmlFor: d.value,
                      className: (0, i.cn)(
        ...
        d.displayName = 'RadioGroupStackedItem';
      },
      62210: function (e, t, s) {
        ...
        let i = (0, r.j)(
          ...
          d = l.forwardRef((e, t) => {
            let { className: s, size: r, ...l } = e;
            return (0, n.jsx)(a.fC, {
              className: (0, o.cn)(i({ size: r }), s),
              ...l,
              ref: t,
              children: (0, n.jsx)(a.bU, {
                className: (0, o.cn)(c({ size: r })),
              }),
            });
          });
        d.displayName = a.fC.displayName;
      },
      98773: function (e, t, s) {
        'use strict';
        var n = s(73656),
          a = s(21607).Buffer,
          r = s.g.crypto || s.g.msCrypto;
        r && r.getRandomValues
          ? (e.exports = function (e, t) {
              if (e > 4294967295)
                throw RangeError('requested too many random bytes');
              var s = a.allocUnsafe(e);
              if (e > 0) {
                if (e > 65536)
                  for (var l = 0; l < e; l += 65536)
                    r.getRandomValues(s.slice(l, l + 65536));
    ...
    function (e) {
      (e.O(
        ...
        [
          ...
          659, 7612, 4637, 9344, 7726, 6739, 3302, 3898, 2495, 793, 3594, 3861,
