!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = 'dd76aa2a-be0f-4516-b929-475e3edcbaf7'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-dd76aa2a-be0f-4516-b929-475e3edcbaf7'));
  } catch (e) {}
})();
('use strict');
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3594],
  {
    45437: function (e, t, r) {
      ...
      var a = r(37756);
      let n = e => {
          let t = e.find(e => 'compute_instance' === e.type);
          return {
            computeInstance: t,
            pitr: e.find(e => 'pitr' === e.type),
            customDomain: e.find(e => 'custom_domain' === e.type),
            ipv4: e.find(e => 'ipv4' === e.type),
          };
        },
        s = e => {
          var t;
          return (
            !!a.Qy &&
            (null !== (t = null == e ? void 0 : e.addons) && void 0 !== t
              ? t
              : []
            ).some(e => 'addon_security_hipaa' === e.supabase_prod_id)
          );
        },
        o = e => {
          if (!e) return e;
    ...
    14075: function (e, t, r) {
      ...
      async function o(e, t) {
        let { projectRef: r } = e;
        if (!r) throw Error('Project ref is required');
        let { data: a, error: s } = await (0, n.U2)(
          '/v1/projects/{ref}/branches',
          { params: { path: { ref: r } }, signal: t }
        );
        if (s) {
          if (
            'Preview branching is not enabled for this project.' === s.message
          )
            return [];
          (0, n.S3)(s);
        }
      ...
      let i = function (e) {
        ...
        return (0, a.a)(
          ...
          e => {
            let { signal: r } = e;
            return o({ projectRef: t }, r);
          },
          { enabled: r && void 0 !== t, ...n }
        );
      };
    },
    3746: function (e, t, r) {
      ...
      let a = {
        list: e => ['projects', e, 'branches'],
        detail: (e, t) => ['projects', e, 'branches', t],
      };
    },
    5731: function (e, t, r) {
      r.d(t, {
      ...
      let a = {
        usage: e => ['projects', e, 'usage'],
        orgUsage: (e, t, r, a) => ['organizations', e, 'usage', t, r, a],
        resourceWarnings: () => ['projects', 'resource-warnings'],
      };
    },
    42764: function (e, t, r) {
      r.d(t, {
        v: function () {
          return i;
        },
      ...
      var a = r(28894),
        ...
        s = r(5731);
      async function o(e, t) {
        let { orgSlug: r, projectRef: a, start: s, end: o } = e;
        if (!r) throw Error('orgSlug is required');
        let { data: i, error: l } = await (0, n.U2)(
          '/platform/organizations/{slug}/usage',
          {
            params: {
              ...
              query: {
                project_ref: a,
                start: null == s ? void 0 : s.toISOString(),
      ...
      let i = function (e) {
        let { orgSlug: t, projectRef: r, start: n, end: i } = e,
          { enabled: l = !0, ...d } =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (0, a.a)(
          s.Z.orgUsage(
          ...
          e => {
            let { signal: a } = e;
            return o({ orgSlug: t, projectRef: r, start: n, end: i }, a);
          },
          { enabled: l && void 0 !== t, staleTime: 18e5, ...d }
        );
      };
    },
    71147: function (e, t, r) {
      r.d(t, {
        N: function () {
          return s;
        },
          ...
          ? Object.fromEntries(
              e.map(e => [
                e
                  ...
                  .join(''),
                n(e, null == t ? void 0 : t.disabled_features),
              ])
            )
          : n(e, null == t ? void 0 : t.disabled_features);
      }
    ...
    5529: function (e, t, r) {
      ...
      t.Z = e => {
        ...
        let {
          ...
          f = null == n ? void 0 : n.replace(/ /g, '%20'),
          m = '/support/new?category=dashboard_bug';
        (r && (m += '&ref='.concat(r)),
          f && (m += '&subject='.concat(f)),
          d && (m += '&error='.concat(d.message)));
        let C = (
          null == d
            ? void 0
            : null === (t = d.message) || void 0 === t
              ? void 0
              : t.includes('503')
        )
          ...
          : null == d
            ? void 0
            : d.message;
        return (0, a.jsxs)(o.bZ, {
          className: c,
          variant: 'warning',
          title: n,
          'data-sentry-element': 'Alert_Shadcn_',
          'data-sentry-component': 'AlertError',
          'data-sentry-source-file': 'AlertError.tsx',
          children: [
            u && (0, a.jsx)(i.aN, { className: 'h-4 w-4', strokeWidth: 2 }),
            (0, a.jsx)(o.Cd, {
    ...
    63621: function (e, t, r) {
      ...
      var i = r(65092);
      let l = e => {
          let { className: t, delayIndex: r = 0, animationDelay: l = 150 } = e,
            d = (function (e) {
                  ...
                  let e = document
                      ...
                      .filter(
                        e =>
                          ...
                          'shimmer' === e.animationName
                      ),
                    r = e.find(
                      e =>
                        e.effect instanceof KeyframeEffect &&
                        e.effect.target === t.current
                    );
                  if (void 0 === r) return;
                  let a = e[0];
                  return (
                    r === a && o && (r.currentTime = o),
                    r !== a && (r.currentTime = a.currentTime),
                    () => {
                      r === a && r.currentTime && (o = Number(r.currentTime));
                    }
                  );
                }, []),
                t
          ...
          return (0, a.jsx)('div', {
            ref: d,
            className: (0, i.cn)('shimmering-loader rounded py-3', t),
            style: {
              animationFillMode: 'backwards',
              animationDelay: ''.concat(r * l, 'ms'),
            },
            'data-sentry-component': 'ShimmeringLoader',
            'data-sentry-source-file': 'ShimmeringLoader.tsx',
          });
        },
        d = () =>
          (0, a.jsxs)('div', {
      ...
      let l = o.forwardRef((e, t) => {
        ...
        return (0, a.jsx)(n.fC, {
          ...
          children: (0, a.jsx)(n.z$, {
            ...
            children: (0, a.jsx)(s.Z, { className: 'h-3 w-3', strokeWidth: 4 }),
          }),
        });
      });
      l.displayName = n.fC.displayName;
    },
    47482: function (e, t, r) {
      r.d(t, {
        di: function () {
          return p;
        },
      ...
      d.displayName = n.mY.displayName;
      let c = i.forwardRef((e, t) => {
        ...
        return (0, a.jsxs)('div', {
          className: (0, l.cn)('flex items-center border-b px-3', d),
          'cmdk-input-wrapper': '',
          children: [
            u && (0, a.jsx)(s.Z, { className: 'h-4 w-4 shrink-0 opacity-50' }),
            (0, a.jsx)(n.mY.Input, {
              ref: t,
              className: (0, l.cn)(
            ...
            c &&
              (0, a.jsx)('button', {
                ...
                className: (0, l.cn)(
                  ...
                  !!(null === (r = m.value) || void 0 === r
                    ? void 0
                    : r.length) && 'opacity-100'
                ),
                children: (0, a.jsx)(o.Z, { size: 14 }),
              }),
          ],
        });
      });
      ...
      u.displayName = n.mY.List.displayName;
      let f = i.forwardRef((e, t) => {
        let { className: r, ...s } = e;
        return (0, a.jsx)(n.mY.Empty, {
          ref: t,
          className: (0, l.cn)('py-6 text-center text-xs', r),
          ...s,
        });
      });
      f.displayName = n.mY.Empty.displayName;
      let m = i.forwardRef((e, t) => {
        let { className: r, ...s } = e;
        return (0, a.jsx)(n.mY.Group, {
          ref: t,
          className: (0, l.cn)(
      ...
      m.displayName = n.mY.Group.displayName;
      let C = i.forwardRef((e, t) => {
        let { className: r, ...s } = e;
        return (0, a.jsx)(n.mY.Separator, {
          ref: t,
          className: (0, l.cn)('-mx-1 h-px bg-border-overlay', r),
          ...s,
        });
      });
      C.displayName = n.mY.Separator.displayName;
      let p = i.forwardRef((e, t) => {
        let { className: r, ...s } = e;
        return (0, a.jsx)(n.mY.Item, {
          ref: t,
          className: (0, l.cn)(
      ...
      p.displayName = n.mY.Item.displayName;
    },
    72271: function (e, t, r) {
      r.d(t, {
        DN: function () {
          return g;
        },
      ...
      let f = e => {
        let { side: t, children: r, ...s } = e;
        return (0, a.jsx)(n.h_, {
          ...s,
          'data-sentry-element': 'unknown',
          'data-sentry-component': 'SheetPortal',
          'data-sentry-source-file': 'sheet.tsx',
          children: r,
        });
      };
      f.displayName = n.h_.displayName;
      ...
      let C = (0, l.cn)([
        ...
        p = (0, s.j)(C, {
          ...
          compoundVariants: [
            { side: ['top', 'bottom'], size: 'content', class: 'max-h-screen' },
            ...
            { side: ['right', 'left'], size: 'content', class: 'max-w-screen' },
            { side: ['right', 'left'], size: 'default', class: 'lg:w-1/3' },
            { side: ['right', 'left'], size: 'sm', class: 'lg:w-1/4' },
            { side: ['right', 'left'], size: 'lg', class: 'lg:w-1/2' },
            { side: ['right', 'left'], size: 'xl', class: 'lg:w-4/6' },
            { side: ['right', 'left'], size: 'xxl', class: 'w-5/6' },
        ...
        h = o.forwardRef((e, t) => {
          ...
          return (0, a.jsxs)(f, {
            ...
            children: [
              ...
              (0, a.jsxs)(n.VY, {
                ref: t,
                className: (0, l.cn)(p({ side: r, size: s }), o),
                ...u,
                children: [
                  d,
                  c
      ...
      let y = e => {
        ...
        return (0, a.jsx)('div', {
          className: (0, l.cn)(
            'px-5 py-4 text-center sm:text-left border-b bg-dash-sidebar',
            t
          ),
          ...r,
          'data-sentry-component': 'SheetHeader',
          'data-sentry-source-file': 'sheet.tsx',
        });
      };
      ...
      let g = e => {
        let { className: t, ...r } = e;
        return (0, a.jsx)('div', {
          className: (0, l.cn)('px-5 py-4', t),
          ...r,
          'data-sentry-component': 'SheetSection',
          'data-sentry-source-file': 'sheet.tsx',
        });
      };
      g.displayName = 'SheetSection';
      let x = e => {
        let { className: t, ...r } = e;
        return (0, a.jsx)('div', {
          className: (0, l.cn)(
          ...
          ...r,
          'data-sentry-component': 'SheetFooter',
          'data-sentry-source-file': 'sheet.tsx',
        });
      };
      ...
      let M = o.forwardRef((e, t) => {
        ...
        return (0, a.jsx)(n.Dx, {
          ref: t,
          className: (0, l.cn)('text-lg text-foreground', r),
          ...s,
        });
      });
      M.displayName = n.Dx.displayName;
      let L = o.forwardRef((e, t) => {
        let { className: r, ...s } = e;
        return (0, a.jsx)(n.dk, {
          ref: t,
          className: (0, l.cn)('text-sm text-foreground-light', r),
          ...s,
        });
      });
      L.displayName = n.dk.displayName;
    },
    1846: function (e, t, r) {
      r.d(t, {
        gx: function () {
          ...
          let r = (0, a.forwardRef)((r, o) => {
            ...
            return (0, a.createElement)(
              'svg',
              {
                ...
                className: ['lucide', 'lucide-'.concat(s(e)), u].join(' '),
                ...m,
              },
              [
                ...t.map(e => {
      ...
      var l = o('Auth', [
        ...
        d = o('Database', [
          [
            'path',
            {
              d: ' M5.56774 9.70642H18.4547V15.7064H5.56774V9.70642Z',
              key: 'g5hndz',
            },
          ],
          [
