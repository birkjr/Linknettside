(!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '7555b508-2f28-4954-bc59-359ad118cd08'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-7555b508-2f28-4954-bc59-359ad118cd08'));
  } catch (e) {}
})(),
    ...
    [347],
    {
      12832: function (e, t, n) {
        ...
        var r = n(97335),
          ...
          l = function (e, t, n) {
            var r = new o({ func: e, wait: t, options: i({}, a, n) });
            return function () {
              for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
        ...
        e.exports = function (e) {
          ...
          return function () {
            var l,
              ...
              d = !r || u - r > c;
            r = u;
            for (var h = arguments.length, m = Array(h), f = 0; f < h; f++)
              m[f] = arguments[f];
            if (d && n.leading)
              return n.accumulate
                ? Promise.resolve(e.call(this, [m])).then(function (e) {
                    return e[0];
                  })
            ...
            if (
              (s
                ? clearTimeout(i)
                : (((l = {}).promise = new Promise(function (e, t) {
                    ((l.resolve = e), (l.reject = t));
                  })),
                  (s = l)),
              a.push(m),
              (i = setTimeout(o.bind(this), c)),
              n.accumulate)
            ) {
              var p = a.length - 1;
          ...
          function o() {
            ...
            (clearTimeout(i),
              Promise.resolve(
                n.accumulate ? e.call(this, a) : e.apply(this, a[a.length - 1])
        ...
        let y = e => [
          ...
          x = () => {
            let { ref: e = 'default' } = (0, s.UO)(),
              t = (0, a.ar)();
            (0, l.kM)({ projectRef: e });
            let n = (0, i.useRouter)().pathname.split('/')[4];
      ...
      34620: function (e, t, n) {
        ...
        ((a.getLayout = e => (0, r.jsx)(i.Z, { title: 'Auth', children: e })),
          (t.default = a));
      },
            ...
            (0, r.jsxs)('div', {
              ...
              children: [
                (0, r.jsx)(o.I, {
                  ...
                  onCopy: f,
                  value: h && j ? '**** **** **** ****' : x.value,
                  className: (0, a.cn)(...w, x.className),
                }),
                d && (0, r.jsx)(u, { icon: d, className: p }),
                n || m
                  ? (0, r.jsxs)('div', {
        ...
        let f = e =>
          ...
          y = e => {
            let { utcTimestamp: t, format: n } = e,
              r = p(t) ? f(t) : t;
            return l().utc(r).local().format(n);
          },
          x = e => {
            let { utcTimestamp: t, format: n } = e,
              r = p(t) ? f(t) : t;
            return l().utc(r).format(n);
          },
          v = e => {
            let { utcTimestamp: t } = e,
              n = p(t) ? f(t) : t;
            return l().utc(n).fromNow();
          },
          g = e => {
            let {
                utcTimestamp: t,
                className: n,
                displayAs: o = 'local',
                format: l = 'DD MMM  HH:mm:ss',
                labelFormat: c = 'DD MMM HH:mm:ss',
              } = e,
              u = y({ utcTimestamp: t, format: l }),
              d = x({ utcTimestamp: t, format: l }),
              h = v({ utcTimestamp: t }),
              [f, p] = (0, s.useState)('start'),
              g = (0, s.useRef)(null),
      ...
      94059: function (e, t, n) {
        ...
        var r = n(97458),
          ...
          a = n(65092);
        function o(e) {
          let { children: t, className: n, tag: s = 'div', style: i } = e;
        ...
        ((o.Title = function (e) {
          let { className: t, level: n = 1, children: s, style: i } = e;
        ...
        ((d.Item = function (e) {
          let {
            ...
            { type: f } = u(),
            p = [m.item.base];
          (p.push(m.item.variants[f].base),
            s
              ? p.push(m.item.variants[f].active)
              : p.push(m.item.variants[f].normal));
          let y = [m.item.content.base];
          s ? y.push(m.item.content.active) : y.push(m.item.content.normal);
          let x = [m.item.icon.base];
          return (
            s ? x.push(m.item.icon.active) : x.push(m.item.icon.normal),
            (0, r.jsxs)('li', {
              role: 'menuitem',
              className: (0, a.cn)('outline-none', p),
              style: h,
              onClick: l,
          ...
          (d.Group = function (e) {
            let { children: t, icon: n, title: s } = e,
              ...
              { type: o } = u();
            return (0, r.jsxs)('div', {
              className: [a.group.base, a.group.variants[o]].join(' '),
              'data-sentry-component': 'Group',
              'data-sentry-source-file': 'Menu.tsx',
              children: [
                n &&
                  (0, r.jsx)('span', { className: a.group.icon, children: n }),
                (0, r.jsx)('span', { className: a.group.content, children: s }),
                t,
              ],
            });
          }),
    ...
    function (e) {
      (e.O(
        ...
        [
          ...
          3861, 6120, 7094, 4334, 876, 9086, 3443, 9774, 2888, 179,
        ],
        function () {
          return e((e.s = 19615));
        }
