!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '79f89fbb-218d-40b9-b6ed-1f54e23d4ce3'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-79f89fbb-218d-40b9-b6ed-1f54e23d4ce3'));
  } catch (e) {}
})();
('use strict');
  ...
  [8028],
  {
        ...
        return Array.isArray(e)
          ? e
              .map(e => {
                let [t, n, ...r] = e.split(':'),
                  a = r.join(':'),
                  s = l.o.find(e => e.abbrev === n);
                if (t && n && s)
                  return { column: t, operator: s.value, value: a || '' };
              })
              .filter(e => void 0 !== e)
          : [];
      }
      function m(e) {
        let t = e.columns,
          ...
          a = t.map(e => {
            ...
            return (
              s &&
                ((t.foreignKey.targetTableSchema = s.target_table_schema),
                (t.foreignKey.targetTableName = s.target_table_name),
                (t.foreignKey.targetColumnName = s.target_column_name),
                (t.foreignKey.deletionAction = s.deletion_action),
                (t.foreignKey.updateAction = s.update_action)),
              t
            );
          });
        return {
          ...
          return (f(j(u)), c)
            ? (0, r.jsxs)('div', {
                ...
                children: [
                  (0, r.jsx)('span', {
                    className:
                      'transition-color text-foreground-lighter hover:text-foreground-light',
        ...
        let { table: t, sorts: n, onApplySorts: a } = e,
          ...
          v = (0, d.useCallback)((e, t) => {
            h(n => {
              ...
              return s()(n, { [r]: { $merge: { ascending: t } } });
            });
          }, []),
                        ...
                        (0, r.jsxs)(r.Fragment, {
                          children: [
                            ...
                            (0, r.jsxs)(d.Xi, {
                              ...
                              onClick: b,
                              children: [
                                (0, r.jsx)(l.Z, { size: 14, stroke: 'red' }),
        ...
        toSql() {
          try {
            ...
            switch (this.action) {
              case 'count':
                return (function (e, t) {
                  let n = 'select count(*) from '.concat(l(e)),
                    { filters: r } = null != t ? t : {};
                  return (r && (n = s(n, r)), n + ';');
              ...
              case 'insert':
                return (function (e, t, n) {
                  ...
                  let { returning: r, enumArrayColumns: s } =
                      null != n ? n : {},
                    o = Object.keys(t[0])
                      .map(e => (0, a.yR)(e))
                      .join(','),
      ...
      let c = e => {
        ...
        m = (e, t) => {
          ...
          return {
            ...
            ...(!a && { defaultValue: t.isArray && s ? x(s) : s }),
            ...(!a &&
              s && {
                defaultValueFormat: o()(s) || c(s) ? 'expression' : 'literal',
              }),
          };
        },
        f = (e, t, n) => {
          ...
          let m = t.primary_keys.map(e => e.name).includes(e.name),
            ...
            h =
              null ===
                ...
                ? void 0
                : r.trim(),
            x = null === (l = n.check) || void 0 === l ? void 0 : l.trim(),
            g = {};
          if (
        ...
        h = (e, t, n) => {
          ...
          if (void 0 === a) return a;
          {
            ...
            return {
              ...a,
              deletion_action:
                null !== (s = null == e ? void 0 : e.deletion_action) &&
                void 0 !== s
                  ? s
                  : l.N.NO_ACTION,
              update_action:
    ...
    99359: function (e, t, n) {
      ...
      let r = (e, t, n, r, a) => {
          ...
          return { hasLint: null !== s, count: s ? 1 : 0, matchingLint: s };
        },
        a = (e, t) => {
    ...
    4818: function (e, t, n) {
      ...
      async function l(e, t) {
        let { projectRef: n, connectionString: r, schema: s } = e,
          l = o({ schema: s }),
          { result: i } = await (0, a.R)(
            {
              ...
              connectionString: r,
              sql: l,
              queryKey: ['foreign-key-constraints', s],
            },
            t
          );
      ...
      let i = function (e) {
        ...
        return (0, r.a)(
          s.A.foreignKeyConstraints(t, a),
          e => {
            let { signal: r } = e;
            return l({ projectRef: t, connectionString: n, schema: a }, r);
          },
    ...
    39113: function (e, t, n) {
      ...
      async function i(e, t) {
        var n, r;
        let { projectRef: s, connectionString: o, id: i } = e;
      ...
      function d(e, t) {
        ...
        return e.fetchQuery(s.Q.tableEditor(n, a), e => {
          let { signal: t } = e;
    ...
    76059: function (e, t, n) {
      ...
      let f = 5e4,
        ...
        h = e => {
          var t, n, r;
          let { table: a, filters: o = [], enforceExactCount: l = !1 } = e;
          if (!a) return '';
          if (l) {
            let e = new s.A()
              .from(
          ...
          }
          {
            ...
            o.filter(e => e.value && '' != e.value).forEach(e => {
              let t = (0, m.q)(a, e);
              l = l.filter(e.column, e.operator, t);
            });
            let i = l.toSql().slice(0, -1);
            return '\n'
              .concat(
                p,
      ...
      async function x(e, t) {
        ...
        let {
          ...
          x = await (0, l.nq)(r, { projectRef: a, connectionString: s, id: u });
      ...
      let g = function (e) {
        let { projectRef: t, connectionString: n, tableId: s, ...o } = e,
          { enabled: l = !0, ...i } =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          c = (0, r.NL)();
        return (0, a.a)(
          u.s.tableRowsCount(t, { table: { id: s }, ...o }),
          e => {
            let { signal: r } = e;
            return x(
              {
    ...
    38650: function (e, t, n) {
      ...
      async function j(e, t) {
        let {
          ...
          x = await (0, c.nq)(n, { projectRef: r, connectionString: a, id: s });
        if (!x) throw Error('Table not found');
        let g = (0, l.NK)(x),
          y = (0, u.Jh)(
            b({
      ...
      function w(e, t) {
        ...
        return e.fetchQuery(p.s.tableRows(n, { table: { id: a }, ...o }), t => {
          let { signal: s } = t;
          return j(
            {
              queryClient: e,
    ...
    17319: function (e, t, n) {
      ...
      var r = n(62213),
        ...
        s = n(12436),
        o = n(37756);
      let l = e => (0, r.v1)('schema', r.Oi.withDefault(e)),
        i = () => {
          let { ref: e } = (0, s.UO)(),
            t =
              (e &&
                e.length > 0 &&
                window.localStorage.getItem(o.dA.LAST_SELECTED_SCHEMA(e))) ||
              'public',
            [n, r] = l((0, a.useMemo)(() => t, [e]));
          return (
            (0, a.useEffect)(() => {
              e &&
                e.length > 0 &&
                window.localStorage.setItem(o.dA.LAST_SELECTED_SCHEMA(e), n);
            }, [n, e]),
            { selectedSchema: n, setSelectedSchema: r }
          );
        };
    },
    ...
    62095: function (e, t, n) {
      ...
      function y(e) {
        let { gridRef: t } = e,
          { rows: n, gridColumns: r, selectedCellPosition: s } = (0, h.Qq)(),
          [o, l] = a.useState('Command');
        return (
          a.useEffect(() => {
            var e, t;
            l(
          ...
          (0, g.a)(
            {
              [''.concat(o, '+ArrowUp')]: e => {
                if ((e.stopPropagation(), s)) {
                  ...
                  let e = {
                    idx:
                      null !== (n = null == s ? void 0 : s.idx) && void 0 !== n
                        ? n
                        : 0,
                    rowIdx: 0,
                  };
              ...
              [''.concat(o, '+ArrowDown')]: e => {
                if ((e.stopPropagation(), s)) {
                  ...
                  let e = {
                    idx:
                      null !== (r = null == s ? void 0 : s.idx) && void 0 !== r
                        ? r
                        : 0,
              ...
              [''.concat(o, '+ArrowLeft')]: e => {
                ...
                let a = {
                  ...
                  rowIdx:
                    null !== (n = null == s ? void 0 : s.rowIdx) && void 0 !== n
                      ? n
                      : 0,
                };
        ...
        return (0, r.jsx)(
          j.X2,
          {
            ...
            onContextMenu: function (e) {
              n(e, { id: A.ep, props: { rowIdx: t.rowIdx } });
            },
          ...
          (0, a.forwardRef)((e, t) => {
            ...
            let M = D.table,
              ...
              { data: U } = (0, E.XJ)({
                ...
                schema:
                  null !== (n = null == M ? void 0 : M.schema) && void 0 !== n
                    ? n
                    : void 0,
              }),
              K = () => {
            ...
            return (0, r.jsx)('div', {
              className: (0, k.cn)('flex flex-col', l),
              style: { width: s || '100%', height: o || '50vh' },
                        ...
                        o =
                          null == U
                            ...
                            : U.find(
                                t =>
                                  t.source_schema ===
                                    (null == M ? void 0 : M.schema) &&
                                  t.source_table ===
                                    (null == M ? void 0 : M.name) &&
                                  t.source_columns.includes(e) &&
                                  t.target_schema === r &&
                                  t.target_table === a &&
                                  t.target_columns.includes(s)
                              );
                      return void 0 !== o ? (0, N.S)([o])[0] : void 0;
                    })(t.name);
                    n && q({ foreignKey: n, row: e, column: t });
                  })(e.row, e.column),
              }),
            });
          })
      ...
      async function Z(e, t, n, r, a) {
        var s, o;
        let l = e.projectRef
          ? F(e.projectRef, e.table.name, e.table.schema)
          : void 0;
        if (
          !t.isInitialComplete &&
          void 0 === r &&
          void 0 === a &&
          ((null == l ? void 0 : l.sorts) || (null == l ? void 0 : l.filters))
        )
          return { savedState: { sorts: l.sorts, filters: l.filters } };
        let i = (0, z.cv)(e.table, {
          projectRef: e.projectRef,
          tableId: e.tableId,
          editable: e.editable,
          defaultWidth:
            null === (s = e.gridProps) || void 0 === s
              ? void 0
              : s.defaultColumnWidth,
      ...
      let M = e => {
        ...
        W = e => {
          ...
          let {
            ...
            O = (0, a.useRef)(null),
            [D, z] = (0, a.useState)(!1),
            [{ sort: F, filter: M }, W] = (0, u.x)({
              arrayKeys: ['sort', 'filter'],
            }),
            U = (0, p.rg)(e.table.name, F),
            K = (0, p.Yb)(M),
            B = (0, m.fN)(),
            { project: H } = (0, c.d2)(),
            {
          ...
          return (
            ...
            (0, a.useEffect)(() => {
              D && T({ type: 'UPDATE_FILTERS', payload: {} });
            }, [JSON.stringify(K)]),
            (0, a.useEffect)(() => {
              D && T({ type: 'UPDATE_SORTS', payload: {} });
            }, [JSON.stringify(U)]),
            (0, a.useEffect)(() => {
              L.isInitialComplete && x && L.table && (0, p.Tf)(L, x, F, M);
            }, [
              L.table,
              L.isInitialComplete,
              L.gridColumns,
            ...
            (0, a.useEffect)(() => {
              let t = async () => {
                ...
                n = JSON.stringify(e.table) !== JSON.stringify(L.table);
              (!L.table || n) && t();
            }, [L.table, e.table, e.schema]),
            (0, r.jsxs)('div', {
    ...
    53365: function (e, t, n) {
      ...
      var r = n(97458),
        a = n(14500);
      let s = e => {
        let { children: t, side: n, align: s, options: o, onSelect: l } = e;
      ...
      let s = e => {
        ...
        return (0, r.jsx)(a.default, {
          ...
          onMount: function (e) {
            ...
            let t = e.getModel().getPositionAt(null == s ? void 0 : s.length);
            (e.setPosition(t),
              setTimeout(() => {
                null == e || e.focus();
              }, 0),
    ...
    99968: function (e, t, n) {
      ...
      var k = () => {
          ...
          let {
            ...
            Y = (null == K ? void 0 : K.is_estimate)
              ? E(K.count)
              : null == K
                ? void 0
                : K.count.toLocaleString(),
            V = Math.ceil(
              (null !== (e = null == K ? void 0 : K.count) && void 0 !== e
                ? e
                : 0) / R.rowsPerPage
            ),
            G =
              (null !== (t = null == K ? void 0 : K.count) && void 0 !== t
                ? t
                : 0) > 0
                ? V
                : 1,
    ...
    6600: function (e, t, n) {
            ...
            children: [
              c
                ...
                : (0, r.jsx)(r.Fragment, {
                    children:
                      d.size > 0
                        ? (0, r.jsx)(P, { table: t, sorts: n, filters: a })
                        : (0, r.jsx)(q, {
                            table: t,
                            onAddColumn: s,
                            onAddRow: o,
      ...
      let q = e => {
          let { table: t, onAddColumn: n, onAddRow: s, onImportData: o } = e,
            d = (0, j.Xo)(a.KA.TENANT_SQL_ADMIN_WRITE, 'columns'),
            [{ filter: u, sort: m }, f] = (0, _.x)({
              arrayKeys: ['sort', 'filter'],
            });
          return (0, r.jsxs)('div', {
                          ...
                          children: [
                            (0, r.jsx)(C.$F, {
                              ...
                              children: (0, r.jsx)(E.z, {
                                ...
                                type: 'primary',
                                size: 'tiny',
                                icon: (0, r.jsx)(l.Z, { strokeWidth: 1.5 }),
                                children: 'Insert',
                              }),
                            }),
                            (0, r.jsx)(C.AW, {
        ...
        P = e => {
          var t, n;
          let { table: a, sorts: s, filters: i } = e,
            c = (0, h.Qq)(),
            u = (0, h.I0)(),
            { project: j } = (0, g.d2)(),
            _ = (0, N._2)(),
            ...
            { data: q } = (0, v.HS)(
              {
                ...
                tableId: a.id,
                filters: i,
                enforceExactCount: _.enforceExactCount,
                impersonatedRole: S.role,
              },
              { keepPreviousData: !0 }
            ),
          ...
          async function D() {
            ...
            if (!j) return (p.Am.error('Project is required'), A(!1));
            let e = (
                U
                  ? await (0, b.wF)({
                      projectRef: j.ref,
              ...
              t = new Blob(
                [m().unparse(e, { columns: c.table.columns.map(e => e.name) })],
                { type: 'text/csv;charset=utf-8;' }
              );
            (o()(t, ''.concat(c.table.name, '_rows.csv')), A(!1));
          }
          async function z() {
            if ((A(!0), U && Z > I))
              return (
            ...
            let e = U
                ...
                : F.filter(e => M.has(e.idx)),
              t = new Blob([(0, x.k)(a, e)], {
                type: 'text/sql;charset=utf-8;',
              });
            (o()(t, ''.concat(c.table.name, '_rows.sql')), A(!1));
          }
          let F =
              null !== (t = null == L ? void 0 : L.rows) && void 0 !== t
                ? t
                : [],
            Z =
              null !== (n = null == q ? void 0 : q.count) && void 0 !== n
                ? n
                : 0,
            { selectedRows: M, editable: W, allRowsSelected: U } = c;
          return (
            (0, w.gv)(() => {
              (U || M.size > 0) &&
                u({
                  ...
                  (0, r.jsxs)(r.Fragment, {
                    children: [
                      (0, r.jsx)('div', {
                        ...
                        children: (0, r.jsx)(k.Z, { orientation: 'vertical' }),
                      }),
                      (0, r.jsx)(E.z, {
                        type: 'text',
                        onClick: () => P(),
    ...
    4951: function (e, t, n) {
      ...
      t.Z = e => {
        let { table: t, isRefetching: n } = e,
          { ref: c } = (0, o.UO)(),
          d = (0, a.NL)(),
          u = l.s.tableRowsAndCount(c, t.id);
        async function m() {
      ...
      var r = n(97458),
        ...
        v = (0, d.memo)(e => {
          ...
          let {
            ...
            d = a.columns.find(e => e.name === s.column),
            u =
            ...
            children: [
              ...
              (0, r.jsx)(x.F, {
                ...
                children: (0, r.jsx)(f.z, {
                  ...
                  'data-sentry-element': 'Button',
                  'data-sentry-source-file': 'FilterRow.tsx',
                  children: (0, r.jsx)('span', { children: s.operator }),
                }),
              }),
              (0, r.jsx)(h.Z, {
                size: 'tiny',
                ...
                placeholder: m,
                value: s.value,
                onChange: e => l(o, { ...s, value: e.target.value }),
                onKeyDown: c,
        ...
        u = (function () {
          ...
          (e, t) => {
            switch (t.type) {
              ...
              case 'UPDATE_FILTERS': {
                let t = { ...e };
                return ((t.page = 1), (t.totalRows = s.ZR), t);
              }
              case 'UPDATE_SORTS':
                return { ...e };
              default:
            ...
            switch (t.type) {
                  ...
                  gridColumns: (function (e, t) {
                    ...
                    if (null == t ? void 0 : t.gridColumns) {
                      ...
                      for (let t = 0; t < r.length; t++) {
                        let a = r[t],
                          s = e.find(e => e.key === a.key);
                        s && n.push({ ...s, width: a.width, frozen: a.frozen });
                      }
                      let a = e.filter(
                        e => !r.find(t => t.key === e.key) && '' !== e.name
                      );
                      n = n.concat(a);
                      let o = e.find(e => e.key === s.W);
                      o && (n = [o, ...n]);
                      let l = e.find(e => e.key === s.uZ);
                      l && n.push(l);
                    }
                    return n;
              ...
              case 'FREEZE_COLUMN': {
                ...
                return (
                  ...
                  {
                    ...e,
                    gridColumns: l()(e.gridColumns, { [n]: { $set: r } }),
                  }
                );
              }
              ...
              case 'UPDATE_COLUMN_IDX': {
                ...
                return (
                  ...
                  {
                    ...e,
                    gridColumns: l()(e.gridColumns, { [n]: { $set: r } }).sort(
                      (e, t) => e.idx - t.idx
                    ),
                  }
                );
    ...
    12335: function (e, t, n) {
      ...
      let l = e => {
        let {
          ...
          c = (0, s.Qq)().gridColumns.find(e => e.name == n.key),
          d = t[n.key];
            ...
            c = (0, u.useCallback)(
              e => {
                switch (e.key) {
                  ...
                  case 'Enter':
                    (e.stopPropagation(),
                      !e.shiftKey && s && (e.preventDefault(), s(t)));
                }
              },
              [t]
            );
      ...
      let q = () =>
        ...
        F = e => {
          let {
            ...
            [b, j] = (0, u.useState)(!0),
            [_, F] = (0, u.useState)(g),
            { mutate: Z, isLoading: M, isSuccess: W } = (0, k.rp)(),
            U = (0, u.useCallback)(() => {
              (a && o(t, !0), j(!1));
            }, []),
            K = (0, u.useCallback)(
              e => {
                (null !== e ? (0, A.tT)(e) : e) !== _ ? H(e) : j(!1);
              },
              [W]
            ),
            B = () => {
              (U(), l(n.key, { ...t, [n.key]: (0, A.dW)(_) || t[n.key] }));
            },
            H = e => {
              if (a) {
                if (e) {
                          ...
                          (0, r.jsxs)(I.u, {
                            children: [
                              (0, r.jsx)(I.aJ, {
                                ...
                                children: (0, r.jsx)('div', {
                                  className:
                                    'border border-strong rounded p-1 flex items-center justify-center transition cursor-pointer bg-selection hover:bg-border-strong',
                                  onClick: () => B(),
      ...
      function M(e) {
        let { row: t, column: n, onRowChange: a, onClose: s } = e,
          o = t[n.key];
      ...
      function W(e) {
        let {
          ...
          d = (0, s.Qq)().gridColumns.find(e => e.name == n.key),
          u = t[n.key];
        return (0, r.jsxs)(o.ZP, {
          autoFocus: !0,
          id: 'select-editor',
      ...
      let K = () =>
        ...
        B = e => {
          let {
            ...
            [z, F] = (0, u.useState)(!1),
            { mutate: Z, isLoading: M, isSuccess: W } = (0, k.rp)(),
            B = 'string' == typeof b && b.endsWith('...') && b.length > R.no,
            H = (0, u.useCallback)(() => {
              (o && l(t, !0), _(!1));
            }, []),
            $ = (0, u.useCallback)(
              e => {
                (o && e !== A && l({ ...t, [n.key]: e }, !0), _(!1));
              },
              [W]
            ),
            J = () => {
              (H(), i(n.key, { ...t, [n.key]: A || t[n.key] }));
            };
      ...
      let Y = 'HH:mm:ss';
      function V(e) {
        let { row: t, column: n, format: a, onRowChange: s, onClose: o } = e,
          l = t[n.key],
          i = l ? c()(l, a).format(Y) : l;
        return (0, r.jsx)('input', {
      ...
      let ed = e => {
          var t, n;
          let { table: s, column: o, value: l } = e,
            { ref: i } = (0, C.UO)(),
            c = (0, T.Vm)(),
            {
              data: d,
            ...
            } = (0, R.KK)(
              {
                ...
                tableId: s.id,
                filters: [{ column: o, operator: '=', value: l }],
                page: 1,
                limit: 10,
              },
              { keepPreviousData: !0 }
            ),
            g = s.primary_keys.map(e => e.name),
            y = (
              null !== (t = null == s ? void 0 : s.columns) && void 0 !== t
                ? t
                : []
            ).map(e => {
              let t = eL({ dataType: e.data_type, format: e.format }),
                n = (e.name.length + e.format.length) * eT,
                s = g.includes(e.name);
              return {
                key: e.name,
                name: e.name,
                ...
                renderHeaderCell: () =>
                  (0, r.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, r.jsx)('span', {
                        className: 'text-xs text-foreground-light font-normal',
                        children: e.format,
                      }),
                    ],
                  }),
                renderCell: e => {
                  ...
                  return (0, r.jsx)('div', {
                    className: (0, f.cn)(
                      ...
                      null === a && 'text-foreground-lighter'
                    ),
                    children: null === a ? 'NULL' : a,
                  });
                },
              };
            });
          return (0, r.jsxs)(r.Fragment, {
            children: [
              ...
              (0, r.jsx)('div', {
                ...
                children: (0, r.jsx)(ei.Sf, {
                  href: '/project/'
                    .concat(i, '/editor/')
                    .concat(s.id, '?schema=')
                    .concat(s.schema, '&filter=')
                    .concat(o, '%3Aeq%3A')
                    .concat(l),
                  projectRef: i,
                  id: String(s.id),
                  filters: [{ column: o, operator: '=', value: String(l) }],
        ...
        eu = e => {
          var t;
          let { project: n } = (0, en.d2)(),
            { selectedSchema: a } = (0, es.B)(),
            { projectRef: s, tableId: o, row: l, column: i } = e,
            c = o ? Number(o) : void 0,
            { data: d } = (0, E.iB)({
              projectRef: null == n ? void 0 : n.ref,
              connectionString: null == n ? void 0 : n.connectionString,
            ...
            u = (0, S.N3)(d) ? d : void 0,
            f = (
              null !== (t = null == u ? void 0 : u.relationships) &&
              void 0 !== t
                ? t
                : []
            ).find(
              e =>
                e.source_schema === (null == u ? void 0 : u.schema) &&
                e.source_table_name === (null == u ? void 0 : u.name) &&
                e.source_column_name === i.name
            ),
            { data: p } = (0, ea.Bj)({
              projectRef: null == n ? void 0 : n.ref,
              includeColumns: !0,
              connectionString: null == n ? void 0 : n.connectionString,
              schema: null == f ? void 0 : f.target_table_schema,
            }),
            h =
              null == p
                ? void 0
                : p.find(
                    e =>
                      e.schema ===
                        (null == f ? void 0 : f.target_table_schema) &&
                      e.name === f.target_table_name
                  ),
            x = l[i.key];
          return (0, r.jsxs)('div', {
        ...
        em = e => {
          let t = e.row[e.column.key];
          if (null === t) return (0, r.jsx)(q, {});
          if ('' === t) return (0, r.jsx)(K, {});
      ...
      let ep = {
          ...
          renderHeaderCell: () =>
            (0, r.jsx)(eh, { 'aria-label': 'Add New Row' }),
          renderCell: ee,
          parent: void 0,
          level: 0,
          minWidth: 0,
      ...
      function ew(e) {
        let {
          ...
          m = t.idx,
          f = t.key,
          p = 'array' == n ? ''.concat(l.replace('_', ''), '[]') : l,
          h = (0, s.Qq)(),
          x = t.name;
        (0, u.useEffect)(() => {
        ...
        let [{ isDragging: g }, y] = (0, ey.c)({
            type: 'column-header',
            item: () => ({ key: f, index: m }),
            canDrag: () => !t.frozen,
            collect: e => ({ isDragging: e.isDragging() }),
          }),
          [{ handlerId: v }, b] = (0, ev.L)({
            ...
            hover(e, n) {
              ...
              (a < m && i < l) || (a > m && i > l) || (j(s, f), (e.index = m));
            },
          }),
          j = (e, t) => {
            e != t &&
      ...
      function ek(e) {
        let {
          ...
          { selectedRows: d, allRowsSelected: m } = (0, s.Qq)(),
          f = (0, u.useRef)(null),
          p = d.size > 0 && !m;
        return (
          (0, u.useEffect)(() => {
      ...
      function eA(e, t) {
        let n = [
          ...
          ...e.columns.map((e, n) => {
            var s;
            let o = (function (e) {
                if ((0, eR.Pm)(e)) return 'foreign_key';
                if ((0, eR.v3)(e.dataType)) return 'number';
                if ((0, eR.nr)(e.dataType)) return 'array';
                if ((0, eR.om)(e.dataType)) return 'json';
                if ((0, eR.II)(e.dataType)) return 'text';
                if ((0, eR.kO)(e.format)) return 'citext';
                if ((0, eR.VO)(e.format)) return 'date';
                else if ((0, eR.LT)(e.format)) return 'time';
                else if ((0, eR.Kp)(e.format)) return 'datetime';
                else if ((0, eR.nL)(e.dataType)) return 'boolean';
                else if ((0, eR.N8)(e.dataType)) return 'enum';
                else return 'unknown';
              })(e),
              i = eL(e),
              c = (e.name.length + e.format.length) * eT,
                ...
                ? (function (e, t, n, a, s) {
                    ...
                    if (!e.isPrimaryKey && e.isUpdatable)
                      switch (t) {
                        case 'boolean':
                          return t =>
                            (0, r.jsx)(l, { ...t, isNullable: e.isNullable });
                        case 'date':
                    ...
                    e,
                    o,
                    null !== (s = null == t ? void 0 : t.editable) &&
                      void 0 !== s &&
                      s,
        ...
        return ((null == t ? void 0 : t.onAddColumn) && n.push(ep), n);
      }
      function eL(e) {
        return (0, eR.v3)(e.dataType)
          ? 120
          : (0, eR.Kp)(e.format) || (0, eR.VO)(e.format) || (0, eR.LT)(e.format)
            ? 150
            : (0, eR.nL)(e.dataType)
              ? 120
              : (0, eR.N8)(e.dataType)
      ...
      let i = e =>
        ...
        c = (e, t, n) => {
          ...
          let c = 'update' === e ? 'Updating' : 'Deleting',
            d = null !== (i = (0, l.s8)(t)) && void 0 !== i ? i : 'No action';
          switch (t) {
            case a.N.NO_ACTION:
              return (0, r.jsxs)(r.Fragment, {
                children: [
                  ...
                  u && !h
                    ? (0, r.jsx)('div', {
                        ...
                        children: v
                          ...
                          : (0, r.jsx)(s.Z, { size: 14, strokeWidth: 1.5 }),
                      })
                    : null,
                ],
              }),
    ...
    83462: function (e, t, n) {
        ...
        return (0, d.nq)(t, { projectRef: n, connectionString: r, id: a }).then(
          e => {
            if (e) {
              ...
              let m = (0, i.NK)(e),
                { sorts: p = [], filters: h = [] } =
                  null !== (d = (0, l.v)(n, e.name, e.schema)) && void 0 !== d
                    ? d
                    : {};
              (0, u.Ue)(t, {
                projectRef: n,
                connectionString: r,
                tableId: a,
                sorts: null != s ? s : (0, i.rg)(m.name, p),
      ...
      function g(e) {
        ...
        return (0, r.jsx)(p.Z, {
          ...
          prefetcher: () => c({ id: n, sorts: a, filters: s }),
          ...i,
    ...
    5079: function (e, t, n) {
      ...
      function d(e) {
        ...
        let U = [M.base];
        return (
          p && U.push(M.variants.error),
          p || U.push(M.variants.standard),
          h && U.push(M.with_icon),
          A && U.push(M.size[A]),
          f && U.push(M.disabled),
          (0, r.jsx)(s.l, {
            label: y,
            ...
            children: (0, r.jsxs)('div', {
              ...
              children: [
                (0, r.jsx)('select', {
                  ...
                  className: U.join(' '),
                  onChange: function (e) {
                    (N && N(e), q && q(e), I && Z(x, I(e.target.value)));
                  },
                  onBlur: function (e) {
                    (z && z(e), C && C(e));
                  },
