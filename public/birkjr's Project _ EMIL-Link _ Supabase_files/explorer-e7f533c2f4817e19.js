(!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = 'b409800a-34bb-4011-95ba-cdd6adb10ae5'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-b409800a-34bb-4011-95ba-cdd6adb10ae5'));
  } catch (e) {}
})(),
    ...
    [6526],
    {
      ...
      34273: function (e, t, s) {
        ...
        async function l(e, t) {
          let { ref: s, sql: a } = e;
          if (!a) throw Error('SQL must be provided');
          let { data: r, error: l } = await (0, n.U2)(
            '/platform/projects/{ref}/analytics/warehouse/query',
            { params: { path: { ref: s }, query: { bq_sql: a } }, signal: t }
          );
          return (l && (0, n.S3)(l), r);
        }
        let i = function (e) {
      ...
      18226: function (e, t, s) {
        ...
        t.Z = function (e) {
          let t =
            ...
            d = (0, r.PJ)(r.up),
            [u, m] = (0, n.useState)({
              sql: (null == t ? void 0 : t.sql) || '',
              project: e,
              iso_timestamp_start: t.iso_timestamp_start
                ? t.iso_timestamp_start
                : d.calcFrom(),
              iso_timestamp_end: t.iso_timestamp_end
                ? t.iso_timestamp_end
                : d.calcTo(),
            }),
            p = s && void 0 !== e && !!u.sql,
            ...
            f = (0, o.Ir)(u.sql || ''),
            {
              ...
              t => {
                ...
                return (0, l.U2)(
                  ''
                    .concat(i.T5, '/projects/')
                    .concat(e, '/analytics/endpoints/logs.all?')
                    .concat(h),
                  { signal: s }
                );
              },
          ...
          return (
                ...
                })),
            {
              params: u,
              isLoading: (p && j) || v,
              logData: (0, l.d8)(y) && y.result ? y.result : [],
              error: _,
      ...
      38850: function (e, t, s) {
        ...
        let i = e => {
          var t;
          let s = (0, l.l)(),
            { data: i } = (0, n.Gl)({ orgSlug: null == s ? void 0 : s.slug }),
            [o, c] = (0, r.useState)(!1),
            d = (0, a.dP)(
              e,
              null == i
      ...
      62651: function (e, t, s) {
        ...
        let U = e => {
          ...
          return (0, a.jsxs)(b.Z.tr, {
            ...
            children: [
              (0, a.jsxs)(b.Z.td, {
                className:
                  'font-mono text-xs !p-2 cursor-pointer hover:text-foreground transition flex items-center space-x-2',
                onClick: () =>
                  (0, N.vQ)(t.path, () => {
                    (n(!0), setTimeout(() => n(!1), 3e3));
                  }),
                'data-sentry-element': 'unknown',
                'data-sentry-source-file': 'LogsQueryPanel.tsx',
                children: [
                  (0, a.jsx)('span', { children: t.path }),
                  s
                    ? (0, a.jsxs)(F.u, {
                        children: [
                          (0, a.jsx)(F.aJ, {
                          ...
                          (0, a.jsxs)(T.h_, {
                            children: [
                              ...
                              (0, a.jsx)(T.AW, {
                                ...
                                children:
                                  'logs' === c &&
                                  D.sort((e, t) => e.localeCompare(t)).map(e =>
                                    (0, a.jsx)(
                                      T.Xi,
                                      {
                                        onClick: () => p(e),
                    ...
                    'logs' === c &&
                      (0, a.jsxs)(A.ZP, {
                        ...
                        header: (0, a.jsxs)('div', {
                          ...
                          children: [
                            (0, a.jsx)('h3', { children: 'Field Reference' }),
                            (0, a.jsx)(x.z, {
                              type: 'text',
                              className: 'px-1',
                              onClick: () => j(!1),
        ...
        let er = d.Qy
          ...
          el = () => {
            ...
            let e = (0, i.useRouter)(),
              ...
              [T, L] = (0, o.useState)(!1),
              [R, z] = (0, o.useState)([]),
              [A, I] = (0, o.useState)(b || 'logs'),
              [F, O] = (0, o.useState)(null),
              [Q, U] = (0, f._)(
                'project-content-'.concat(s, '-recent-log-sql'),
                []
              ),
              { data: X } = (0, J.I)({ projectRef: s, type: 'log_sql' }),
              el = null == X ? void 0 : X.content.find(e => e.id === v),
              { data: ei } = (0, K.Gl)({
              ...
              ),
              {
                ...
                isFetching: ey,
                error: eg,
              } = (0, B._)({ ref: s, sql: Z }, { enabled: !1 }),
              ej = 'warehouse' === A ? (null == ef ? void 0 : ef.result) : ec,
              ev = eu || ey,
              { data: eb } = (0, V.O)({ projectRef: s }),
            ...
            return (
              ...
              (0, o.useEffect)(() => {
                r && (eq({ mode: 'custom', searchString: r }), E(r));
              }, [r]),
              (0, o.useEffect)(() => {
                let e = [],
              ...
              (0, a.jsxs)('div', {
                ...
                children: [
                  (0, a.jsxs)(u.pO, {
                    ...
                    direction: 'vertical',
                    autoSaveId: ea.dA.LOG_EXPLORER_SPLIT_SIZE,
        ...
        el.getLayout = e => (0, a.jsx)(X.Z, { children: e });
        var ei = el;
      },
    ...
    function (e) {
      (e.O(
        ...
        [
          ...
          659, 7612, 4637, 9344, 7726, 6739, 3302, 3898, 8985, 717, 6615, 3382,
          793, 3594, 3861, 6120, 7094, 4334, 876, 5185, 6179, 9774, 2888, 179,
        ],
        function () {
          return e((e.s = 20912));
        }
