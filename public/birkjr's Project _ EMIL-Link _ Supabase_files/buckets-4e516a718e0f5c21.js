(!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '7edf7a88-6c1d-419b-8912-5104b9f3316f'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-7edf7a88-6c1d-419b-8912-5104b9f3316f'));
  } catch (e) {}
})(),
    ...
    [3839],
    {
      ...
      85074: function (e, t, r) {
        ...
        let d = () => {
          let { ref: e } = (0, n.UO)(),
            { project: t } = (0, a.d2)(),
            { error: r, isError: c } = (0, l.K)({ projectRef: e });
          return t
            ? (c && o.Z,
              (0, s.jsx)('div', {
        ...
        ((d.getLayout = e =>
          (0, s.jsx)(c.Z, { title: 'Buckets', children: e })),
          (t.default = d));
      },
    },
    function (e) {
      (e.O(
        0,
        [
          6665, 3659, 7623, 588, 783, 1018, 1706, 1864, 8703, 2397, 3954, 9621,
          9911, 659, 7612, 4637, 9344, 7726, 6739, 3302, 3898, 8985, 717, 2478,
          1727, 793, 3594, 3861, 6120, 7094, 4334, 1968, 6384, 8077, 9774, 2888,
          179,
        ],
        function () {
          return e((e.s = 19168));
