!(function () {
  try {
    ...
    T &&
      ...
      (E._sentryDebugIds[T] = '5c5ee029-1918-4a04-947c-786b03b7da40'),
      (E._sentryDebugIdIdentifier =
        'sentry-dbid-5c5ee029-1918-4a04-947c-786b03b7da40'));
  } catch (E) {}
})();
('use strict');
    ...
    28053: function (E, T, R) {
      ...
      var A,
        ...
        D = (E, T) => {
          ...
          if (L) for (var R of L(T)) _.call(T, R) && e(E, R, T[R]);
          return E;
        },
        P = (E, T) => I(E, N(T)),
        U = (E, T) => {
          ...
          if (null != E && L)
            for (var A of L(E))
              0 > T.indexOf(A) && _.call(E, A) && (R[A] = E[A]);
          return R;
        },
        M = {};
      ((E, T) => {
      ...
      var s = E => E.flatMap(t),
        t = E => o(r(E)).map(G),
        G = E => E.replace(/ +/g, ' ').trim(),
        r = E => ({ type: 'mandatory_block', items: H(E, 0)[0] }),
        H = (E, T, R) => {
          let A = [];
          for (; E[T]; ) {
            let [S, O] = a(E, T);
            if ((A.push(S), '|' === E[(T = O)])) T++;
              ...
              if (R !== E[T]) throw Error(`Unbalanced parenthesis in: ${E}`);
              T++;
              break;
            } else if (T === E.length) {
              if (R) throw Error(`Unbalanced parenthesis in: ${E}`);
              break;
        ...
        B = (E, T) => {
          if ('{' === E[T]) return i(E, T + 1);
          if ('[' === E[T]) return n(E, T + 1);
          {
            let R = '';
        ...
        o = E => {
          ...
          if ('concatenation' === E.type) return E.items.map(o).reduce(Y, ['']);
          if ('mandatory_block' === E.type) return E.items.flatMap(o);
          if ('optional_block' === E.type) return ['', ...E.items.flatMap(o)];
          throw Error(`Unknown node type: ${E}`);
        },
        Y = (E, T) => {
          let R = [];
          for (let A of E) for (let E of T) R.push(A + E);
          return R;
        },
        F =
          (((A = F || {}).QUOTED_IDENTIFIER = 'QUOTED_IDENTIFIER'),
          (A.IDENTIFIER = 'IDENTIFIER'),
          (A.STRING = 'STRING'),
          (A.VARIABLE = 'VARIABLE'),
          (A.RESERVED_DATA_TYPE = 'RESERVED_DATA_TYPE'),
          (A.RESERVED_PARAMETERIZED_DATA_TYPE =
            'RESERVED_PARAMETERIZED_DATA_TYPE'),
          (A.RESERVED_KEYWORD = 'RESERVED_KEYWORD'),
          (A.RESERVED_FUNCTION_NAME = 'RESERVED_FUNCTION_NAME'),
          (A.RESERVED_PHRASE = 'RESERVED_PHRASE'),
          (A.RESERVED_SET_OPERATION = 'RESERVED_SET_OPERATION'),
          (A.RESERVED_CLAUSE = 'RESERVED_CLAUSE'),
          (A.RESERVED_SELECT = 'RESERVED_SELECT'),
          (A.RESERVED_JOIN = 'RESERVED_JOIN'),
          (A.ARRAY_IDENTIFIER = 'ARRAY_IDENTIFIER'),
          (A.ARRAY_KEYWORD = 'ARRAY_KEYWORD'),
          (A.CASE = 'CASE'),
          (A.END = 'END'),
          (A.WHEN = 'WHEN'),
          (A.ELSE = 'ELSE'),
          ...
          (A.COMMA = 'COMMA'),
          (A.ASTERISK = 'ASTERISK'),
          (A.PROPERTY_ACCESS_OPERATOR = 'PROPERTY_ACCESS_OPERATOR'),
          (A.OPEN_PAREN = 'OPEN_PAREN'),
          (A.CLOSE_PAREN = 'CLOSE_PAREN'),
          (A.LINE_COMMENT = 'LINE_COMMENT'),
          (A.BLOCK_COMMENT = 'BLOCK_COMMENT'),
          (A.DISABLE_COMMENT = 'DISABLE_COMMENT'),
          (A.NUMBER = 'NUMBER'),
          (A.NAMED_PARAMETER = 'NAMED_PARAMETER'),
          (A.QUOTED_PARAMETER = 'QUOTED_PARAMETER'),
          (A.NUMBERED_PARAMETER = 'NUMBERED_PARAMETER'),
          (A.POSITIONAL_PARAMETER = 'POSITIONAL_PARAMETER'),
          (A.CUSTOM_PARAMETER = 'CUSTOM_PARAMETER'),
        ...
        l = V(1 / 0),
        W = E => T => T.type === E.type && T.text === E.text,
        p = {
          ARRAY: W({ text: 'ARRAY', type: 'RESERVED_DATA_TYPE' }),
          BY: W({ text: 'BY', type: 'RESERVED_KEYWORD' }),
          SET: W({ text: 'SET', type: 'RESERVED_CLAUSE' }),
          STRUCT: W({ text: 'STRUCT', type: 'RESERVED_DATA_TYPE' }),
          WINDOW: W({ text: 'WINDOW', type: 'RESERVED_CLAUSE' }),
          VALUES: W({ text: 'VALUES', type: 'RESERVED_CLAUSE' }),
        },
        X = E =>
          ...
          'OR' === E ||
          'XOR' === E,
        m = E => 'AND' === E || 'OR' === E || 'XOR' === E,
        u = s(['SELECT [ALL | DISTINCT] [AS STRUCT | AS VALUE]']),
        K = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
          ...
          tokenizerOptions: {
            ...
            postProcess: function (E) {
              ...
              return (
                ...
                (R = l),
                T.map(E =>
                  'OFFSET' === E.text && '[' === R.text
                    ? ((R = E), P(D({}, E), { type: 'RESERVED_FUNCTION_NAME' }))
                    : ((R = E), E)
                )
              );
            },
        ...
        b = s(['CREATE [GLOBAL TEMPORARY | EXTERNAL] TABLE [IF NOT EXISTS]']),
        x = s([
        ...
        v = {
          ...
          formatOptions: {
            onelineClauses: [...w, ...Z],
            tabularOnelineClauses: Z,
          },
        },
        q = s(['SELECT [ALL | DISTINCT]']),
        k = s([
          'WITH',
          'FROM',
          'WHERE',
        ...
        z = s(['CREATE [TEMPORARY] [EXTERNAL] TABLE [IF NOT EXISTS]']),
        j = s([
        ...
        EE = {
          ...
          tokenizerOptions: {
            reservedSelect: q,
            reservedClauses: [...k, ...z, ...j],
            reservedSetOperations: s(['UNION [ALL | DISTINCT]']),
            reservedJoins: s([
              'JOIN',
              '{LEFT | RIGHT | FULL} [OUTER] JOIN',
              '{INNER | CROSS} JOIN',
            ...
            reservedPhrases: s(['{ROWS | RANGE} BETWEEN']),
            reservedKeywords: [
              'ADD',
              'ADMIN',
              'AFTER',
      ...
      function ET(E) {
        return E.map((T, R) => {
          let A = E[R + 1] || l;
          if (p.SET(T) && '(' === A.text)
            return P(D({}, T), { type: 'RESERVED_FUNCTION_NAME' });
          let S = E[R - 1] || l;
          return p.VALUES(T) && '=' === S.text
            ? P(D({}, T), { type: 'RESERVED_FUNCTION_NAME' })
            : T;
        });
      }
      var ER = s(['SELECT [ALL | DISTINCT | DISTINCTROW]']),
        EA = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
        ...
        ES = s(['CREATE [OR REPLACE] [TEMPORARY] TABLE [IF NOT EXISTS]']),
        EO = s([
        ...
        EI = {
          ...
          formatOptions: {
            onelineClauses: [...ES, ...EO],
            tabularOnelineClauses: EO,
          },
        },
        EN = s(['SELECT [ALL | DISTINCT | DISTINCTROW]']),
        EL = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
        ...
        EC = s(['CREATE [TEMPORARY] TABLE [IF NOT EXISTS]']),
        E_ = s([
          'CREATE [OR REPLACE] [SQL SECURITY DEFINER | SQL SECURITY INVOKER] VIEW [IF NOT EXISTS]',
          'UPDATE [LOW_PRIORITY] [IGNORE]',
          'DELETE [LOW_PRIORITY] [QUICK] [IGNORE] FROM',
        ...
        Ee = {
          ...
          formatOptions: {
            onelineClauses: [...EC, ...E_],
            tabularOnelineClauses: E_,
          },
        },
        ED = s(['SELECT [ALL | DISTINCT | DISTINCTROW]']),
        EP = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
        ...
        EU = s(['CREATE [TEMPORARY] TABLE [IF NOT EXISTS]']),
        EM = s([
          'CREATE [OR REPLACE] [SQL SECURITY DEFINER | SQL SECURITY INVOKER] VIEW [IF NOT EXISTS]',
          'UPDATE [LOW_PRIORITY] [IGNORE]',
          'DELETE [LOW_PRIORITY] [QUICK] [IGNORE] FROM',
        ...
        Es = {
          ...
          formatOptions: {
            onelineClauses: [...EU, ...EM],
            tabularOnelineClauses: EM,
          },
        },
        Et = s(['SELECT [ALL | DISTINCT]']),
        EG = s([
          'WITH',
          'FROM',
          'WHERE',
        ...
        EH = {
          ...
          tokenizerOptions: {
            ...
            reservedPhrases: s(['{ROWS | RANGE | GROUPS} BETWEEN']),
            supportsXor: !0,
            reservedKeywords: [
              'ADVISE',
              'ALL',
          ...
          formatOptions: { onelineClauses: Er },
        },
        Ea = s(['SELECT [ALL | DISTINCT | UNIQUE]']),
        EB = s([
          'WITH',
          'FROM',
          'WHERE',
        ...
        Eo = {
          ...
          tokenizerOptions: {
            reservedSelect: Ea,
            reservedClauses: [...EB, ...Ei, ...En],
            reservedSetOperations: s(['UNION [ALL]', 'EXCEPT', 'INTERSECT']),
            reservedJoins: s([
              'JOIN',
              '{LEFT | RIGHT | FULL} [OUTER] JOIN',
              '{INNER | CROSS} JOIN',
          ...
          formatOptions: {
            ...
            onelineClauses: [...Ei, ...En],
            tabularOnelineClauses: En,
          },
        },
        EY = s(['SELECT [ALL | DISTINCT]']),
        EF = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
        ...
        EW = {
          ...
          formatOptions: {
            alwaysDenseOperators: ['::', ':'],
            onelineClauses: [...EV, ...El],
            tabularOnelineClauses: El,
          },
        },
        Ep = s(['SELECT [ALL | DISTINCT]']),
        EX = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
        ...
        EK = {
          ...
          formatOptions: {
            alwaysDenseOperators: ['::'],
            onelineClauses: [...Em, ...Eu],
            tabularOnelineClauses: Eu,
          },
        },
        Ec = s(['SELECT [ALL | DISTINCT]']),
        Ed = s([
          'WITH',
          'FROM',
          'WHERE',
        ...
        Ey = s(['CREATE [EXTERNAL] TABLE [IF NOT EXISTS]']),
        Eh = s([
          ...
          tokenizerOptions: {
            ...
            postProcess: function (E) {
              return E.map((T, R) => {
                let A = E[R - 1] || l,
                  S = E[R + 1] || l;
                return p.WINDOW(T) && 'OPEN_PAREN' === S.type
                  ? P(D({}, T), { type: 'RESERVED_FUNCTION_NAME' })
                  : 'ITEMS' !== T.text ||
                      'RESERVED_KEYWORD' !== T.type ||
                      ('COLLECTION' === A.text && 'TERMINATED' === S.text)
                    ? T
                    : P(D({}, T), { type: 'IDENTIFIER', text: T.raw });
              });
            },
          },
          formatOptions: {
            onelineClauses: [...Ey, ...Eh],
            tabularOnelineClauses: Eh,
          },
        },
        EJ = s(['SELECT [ALL | DISTINCT]']),
        Eb = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
        ...
        Ex = s(['CREATE [TEMPORARY | TEMP] TABLE [IF NOT EXISTS]']),
        E$ = s([
        ...
        EZ = s(['CREATE [GLOBAL TEMPORARY | LOCAL TEMPORARY] TABLE']),
        Ev = s([
        ...
        Eq = {
          ...
          formatOptions: {
            onelineClauses: [...EZ, ...Ev],
            tabularOnelineClauses: Ev,
          },
        },
        Ek = s(['SELECT [ALL | DISTINCT]']),
        Ez = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
        ...
        Ej = s(['CREATE TABLE [IF NOT EXISTS]']),
        E1 = s([
          'CREATE [OR REPLACE] [MATERIALIZED] VIEW',
          'UPDATE',
          'DELETE FROM',
        ...
        E0 = {
          ...
          formatOptions: {
            onelineClauses: [...Ej, ...E1],
            tabularOnelineClauses: E1,
          },
        },
        E2 = s(['SELECT [ALL | DISTINCT]']),
        E4 = s([
          'WITH',
          'INTO',
          'FROM',
        ...
        E3 = {
          ...
          formatOptions: {
            alwaysDenseOperators: ['::'],
            onelineClauses: [...E6, ...E5],
            tabularOnelineClauses: E5,
          },
        },
        E8 = s(['SELECT [ALL | DISTINCT | DISTINCTROW]']),
        E9 = s([
          'WITH',
          'FROM',
          'WHERE',
        ...
        TT = {
          ...
          formatOptions: {
            alwaysDenseOperators: ['::', '::$', '::%'],
            onelineClauses: [...E7, ...TE],
            tabularOnelineClauses: TE,
          },
        },
        TR = s(['SELECT [ALL | DISTINCT]']),
        TA = s([
          'WITH [RECURSIVE]',
          'FROM',
          'WHERE',
        ...
        TI = {
          ...
          formatOptions: {
            alwaysDenseOperators: ['::'],
            onelineClauses: [...TS, ...TO],
            tabularOnelineClauses: TO,
          },
        },
        TN = E => E[E.length - 1],
        TL = E => E.sort((E, T) => T.length - E.length || E.localeCompare(T)),
        TC = E => E.replace(/\s+/gu, ' '),
        T_ = E => /\n/.test(E),
        Te = E => E.replace(/[.*+?^${}()|[\]\\]/gu, '\\$&'),
        TD = /\s+/uy,
...
|$)`,
        ...
        Tr = E => TP(`${TL(E).map(Te).join('|')}`),
        TH = ({ rest: E, dashes: T }) =>
          E || T ? `(?![${E || ''}${T ? '-' : ''}])` : '',
        Ta = (E, T = {}) => {
          if (0 === E.length) return /^\b$/u;
          let R = TH(T),
            A = TL(E).map(Te).join('|').replace(/ /gu, '\\s+');
          return RegExp(`(?:${A})${R}\\b`, 'iuy');
        },
        TB = (E, T) => {
          if (!E.length) return;
          let R = E.map(Te).join('|');
          ...
          "q''": (() => {
            let E = { '<': '>', '[': ']', '(': ')', '{': '}' },
              T = Object.entries(E).map(([E, T]) =>
                "{left}(?:(?!{right}').)*?{right}"
                  .replace(/{left}/g, Te(E))
                  .replace(/{right}/g, Te(T))
              ),
              R = Te(Object.keys(E).join('')),
              A = String.raw`(?<tag>[^\s${R}])(?:(?!\k<tag>').)*?\k<tag>`;
            return `[Qq]'(?:${A}|${T.join('|')})'`;
          })(),
        },
        Tn = E =>
          'string' == typeof E
            ...
            : 'regex' in E
              ? E.regex
              : Ts(E) + Ti[E.quote],
        To = E => TP(E.map(E => ('regex' in E ? E.regex : Tn(E))).join('|')),
        TY = E => E.map(Tn).join('|'),
        TF = E => TP(TY(E)),
        TV = (E = {}) => TP(Tl(E)),
        Tl = ({
      ...
      var Tp = class {
          ...
          tokenize(E) {
            ...
            for (; this.index < this.input.length; ) {
              ...
              if (this.index < this.input.length) {
                if (!(T = this.getNextToken())) throw this.createParseError();
                R.push(P(D({}, T), { precedingWhitespace: E }));
              }
            }
            return R;
          }
          createParseError() {
            let E = this.input.slice(this.index, this.index + 10),
              { line: T, col: R } = TW(this.input, this.index);
...
If possible, please select a more specific dialect (like sqlite, postgresql, etc).`
          ...
          getWhitespace() {
            TD.lastIndex = this.index;
            let E = TD.exec(this.input);
        ...
        TK = class {
          ...
          exec(E) {
            let T,
              R = '',
              A = 0;
            if (!(T = this.matchSection(TX, E))) return null;
            for (R += T, A++; A > 0; )
              if ((T = this.matchSection(TX, E))) ((R += T), A++);
              else if ((T = this.matchSection(Tu, E))) ((R += T), A--);
              else {
                if (!(T = this.matchSection(Tm, E))) return null;
                R += T;
              }
            return [R];
          }
        ...
        Tc = class {
          ...
          buildRulesBeforeParams(E) {
            ...
            return this.validRules([
              ...
              {
                type: 'BLOCK_COMMENT',
                regex: E.nestedBlockComments ? new TK() : /(\/\*[^]*?\*\/)/uy,
              },
              {
                type: 'LINE_COMMENT',
                regex: Tt(null != (T = E.lineCommentTypes) ? T : ['--']),
              },
              { type: 'QUOTED_IDENTIFIER', regex: TF(E.identTypes) },
              {
                type: 'NUMBER',
                regex:
              ...
              { type: 'CASE', regex: /CASE\b/iuy, text: Td },
              { type: 'END', regex: /END\b/iuy, text: Td },
              { type: 'BETWEEN', regex: /BETWEEN\b/iuy, text: Td },
              {
                type: 'LIMIT',
              ...
              },
              {
                ...
                regex: Ta(E.reservedClauses, E.identChars),
                text: Td,
              },
              {
                type: 'RESERVED_SELECT',
                regex: Ta(E.reservedSelect, E.identChars),
                text: Td,
              },
              {
                type: 'RESERVED_SET_OPERATION',
                regex: Ta(E.reservedSetOperations, E.identChars),
                text: Td,
              },
              { type: 'WHEN', regex: /WHEN\b/iuy, text: Td },
              { type: 'ELSE', regex: /ELSE\b/iuy, text: Td },
              { type: 'THEN', regex: /THEN\b/iuy, text: Td },
              {
                type: 'RESERVED_JOIN',
                regex: Ta(E.reservedJoins, E.identChars),
                text: Td,
              },
              { type: 'AND', regex: /AND\b/iuy, text: Td },
              { type: 'OR', regex: /OR\b/iuy, text: Td },
              {
                type: 'XOR',
              ...
              ...(E.operatorKeyword
                ? [{ type: 'OPERATOR', regex: /OPERATOR *\([^)]+\)/iuy }]
                : []),
              {
                type: 'RESERVED_FUNCTION_NAME',
                regex: Ta(E.reservedFunctionNames, E.identChars),
                text: Td,
              },
              {
                type: 'RESERVED_DATA_TYPE',
                regex: Ta(E.reservedDataTypes, E.identChars),
                text: Td,
              },
              {
                type: 'RESERVED_KEYWORD',
                regex: Ta(E.reservedKeywords, E.identChars),
                text: Td,
              },
            ]);
          }
          buildRulesAfterParams(E) {
            ...
            return this.validRules([
              ...
              { type: 'STRING', regex: TF(E.stringTypes) },
              { type: 'IDENTIFIER', regex: TV(E.identChars) },
              { type: 'DELIMITER', regex: /[;]/uy },
              { type: 'COMMA', regex: /[,]/y },
              { type: 'OPEN_PAREN', regex: TG('open', E.extraParens) },
              { type: 'CLOSE_PAREN', regex: TG('close', E.extraParens) },
              {
                type: 'OPERATOR',
                regex: Tr([
                  '+',
              ...
              { type: 'ASTERISK', regex: /[*]/uy },
              {
                ...
                regex: Tr([
                  '.',
                  ...(null != (R = E.propertyAccessOperators) ? R : []),
                ]),
              },
            ]);
          }
            ...
            return this.validRules([
              {
                ...
                regex: TB(N.named, Tl(E.paramChars || E.identChars)),
                key: E => E.slice(1),
              },
              {
                type: 'QUOTED_PARAMETER',
                regex: TB(N.quoted, TY(E.identTypes)),
                key: E =>
                  (({ tokenKey: E, quoteChar: T }) =>
                    E.replace(RegExp(Te('\\' + T), 'gu'), T))({
        ...
        Td = E => TC(E.toUpperCase()),
        Ty = new Map(),
        Th = E => {
          let T = Ty.get(E);
          return (T || ((T = Tf(E)), Ty.set(E, T)), T);
        },
        Tf = E => ({
          tokenizer: new Tc(E.tokenizerOptions, E.name),
          formatOptions: TJ(E.formatOptions),
        }),
        TJ = E => {
          var T;
          return {
            ...
            tabularOnelineClauses: Object.fromEntries(
              (null != (T = E.tabularOnelineClauses)
                ? T
                : E.onelineClauses
              ).map(E => [E, !0])
            ),
      ...
      var Tx = class {
        ...
        T$ = (E, T, R) => {
          if (X(E.type)) {
            let A = Tv(R, T);
            if (A && 'PROPERTY_ACCESS_OPERATOR' === A.type)
              return P(D({}, E), { type: 'IDENTIFIER', text: E.raw });
            let S = Tq(R, T);
            if (S && 'PROPERTY_ACCESS_OPERATOR' === S.type)
              return P(D({}, E), { type: 'IDENTIFIER', text: E.raw });
          }
          return E;
        },
        ...
        TQ = (E, T, R) => {
          if ('RESERVED_DATA_TYPE' === E.type) {
            let A = Tq(R, T);
            if (A && Tk(A))
              return P(D({}, E), { type: 'RESERVED_PARAMETERIZED_DATA_TYPE' });
          }
          return E;
        },
        Tw = (E, T, R) => {
          if ('IDENTIFIER' === E.type) {
            let A = Tq(R, T);
            if (A && Tz(A)) return P(D({}, E), { type: 'ARRAY_IDENTIFIER' });
          }
          return E;
        },
        TZ = (E, T, R) => {
          if ('RESERVED_DATA_TYPE' === E.type) {
            let A = Tq(R, T);
            if (A && Tz(A)) return P(D({}, E), { type: 'ARRAY_KEYWORD' });
          }
          return E;
        },
        Tv = (E, T) => Tq(E, T, -1),
        Tq = (E, T, R = 1) => {
          let A = 1;
          for (; E[T + A * R] && Tj(E[T + A * R]); ) A++;
          return E[T + A * R];
        },
        Tk = E => 'OPEN_PAREN' === E.type && '(' === E.text,
        Tz = E => 'OPEN_PAREN' === E.type && '[' === E.text,
        Tj = E => 'BLOCK_COMMENT' === E.type || 'LINE_COMMENT' === E.type,
        T1 = class {
          constructor(E) {
            ((this.tokenize = E),
              (this.index = 0),
          ...
          save() {}
          formatError(E) {
            let { line: T, col: R } = TW(this.input, E.start);
      ...
      var T2 = new T1(E => []),
        ...
        T5 = E => ({ type: 'data_type', text: E.text, raw: E.raw }),
        T3 = (E, { leading: T, trailing: R }) => (
          (null == T ? void 0 : T.length) &&
            (E = P(D({}, E), { leadingComments: T })),
          (null == R ? void 0 : R.length) &&
            (E = P(D({}, E), { trailingComments: R })),
          E
        ),
        T8 = (E, { leading: T, trailing: R }) => {
          ...
          return (
            (null == R ? void 0 : R.length) &&
              (E = [...E.slice(0, -1), T3(E[E.length - 1], { trailing: R })]),
            E
          );
        },
        T9 = {
          ...
          ParserRules: [
            ...
            },
            {
              ...
              symbols: [
                T2.has('DELIMITER') ? { type: 'DELIMITER' } : DELIMITER,
              ],
            },
            {
              name: 'statement$subexpression$1',
              symbols: [T2.has('EOF') ? { type: 'EOF' } : EOF],
            },
            {
              name: 'statement',
            ...
            },
            {
              ...
              symbols: [T2.has('ASTERISK') ? { type: 'ASTERISK' } : ASTERISK],
            ...
            },
            {
              ...
              postprocess: ([E, T]) => T3(E, { trailing: T }),
            },
            {
              name: '_expression_with_comments',
              symbols: ['_', 'expression'],
              postprocess: ([E, T]) => T3(T, { leading: E }),
            },
            {
            ...
            { name: 'property_access$subexpression$1', symbols: ['parameter'] },
            {
              ...
              symbols: [
                'atomic_expression',
                '_',
                T2.has('PROPERTY_ACCESS_OPERATOR')
                  ? { type: 'PROPERTY_ACCESS_OPERATOR' }
              ...
              postprocess: ([E, T, R, A, [S]]) => ({
                ...
                object: T3(E, { trailing: T }),
                operator: R.text,
                property: T3(S, { leading: A }),
              }),
            },
            {
              name: 'between_predicate',
              symbols: [
                T2.has('BETWEEN') ? { type: 'BETWEEN' } : BETWEEN,
                '_',
                'andless_expression_chain',
                '_',
                T2.has('AND') ? { type: 'AND' } : AND,
                '_',
                'andless_expression',
              ],
              postprocess: ([E, T, R, A, S, O, I]) => ({
                ...
                betweenKw: T6(E),
                expr1: T8(R, { leading: T, trailing: A }),
                andKw: T6(S),
                expr2: [T3(I, { leading: O })],
              }),
            },
            {
            ...
            },
            {
              ...
              symbols: [
                T2.has('CASE') ? { type: 'CASE' } : CASE,
                '_',
                'case_expression$ebnf$1',
                'case_expression$ebnf$2',
                T2.has('END') ? { type: 'END' } : END,
              ],
              postprocess: ([E, T, R, A, S]) => ({
                type: 'case_expression',
                caseKw: T3(T6(E), { trailing: T }),
                endKw: T6(S),
                expr: R || [],
                clauses: A,
              }),
            },
            {
              name: 'case_clause',
              symbols: [
                T2.has('WHEN') ? { type: 'WHEN' } : WHEN,
                '_',
                'expression_chain_',
                T2.has('THEN') ? { type: 'THEN' } : THEN,
                '_',
                'expression_chain_',
              ],
              postprocess: ([E, T, R, A, S, O]) => ({
                type: 'case_when',
                whenKw: T3(T6(E), { trailing: T }),
                thenKw: T3(T6(A), { trailing: S }),
                condition: R,
                result: O,
              }),
            },
            {
              name: 'case_clause',
              symbols: [
                T2.has('ELSE') ? { type: 'ELSE' } : ELSE,
                '_',
                'expression_chain_',
              ],
              postprocess: ([E, T, R]) => ({
                type: 'case_else',
                elseKw: T3(T6(E), { trailing: T }),
                result: R,
              }),
            },
            {
              name: 'comma$subexpression$1',
              symbols: [T2.has('COMMA') ? { type: 'COMMA' } : COMMA],
            },
            {
              name: 'comma',
            ...
            },
            {
              ...
              symbols: [T2.has('OPERATOR') ? { type: 'OPERATOR' } : OPERATOR],
            },
            {
              name: 'operator',
            ...
            },
            {
              ...
              symbols: [
                T2.has('IDENTIFIER') ? { type: 'IDENTIFIER' } : IDENTIFIER,
              ],
            },
            {
              name: 'identifier$subexpression$1',
              symbols: [
                T2.has('QUOTED_IDENTIFIER')
            ...
            {
              name: 'identifier$subexpression$1',
              symbols: [T2.has('VARIABLE') ? { type: 'VARIABLE' } : VARIABLE],
            },
            {
              name: 'identifier',
            ...
            },
            {
              ...
              symbols: [T2.has('NUMBER') ? { type: 'NUMBER' } : NUMBER],
            },
            {
              name: 'literal$subexpression$1',
              symbols: [T2.has('STRING') ? { type: 'STRING' } : STRING],
            },
            {
              name: 'literal',
            ...
            },
            {
              name: 'data_type',
              symbols: [
                T2.has('RESERVED_PARAMETERIZED_DATA_TYPE')
              ...
              postprocess: ([E, T, R]) => ({
                ...
                dataType: T3(T5(E), { trailing: T }),
                parenthesis: R,
              }),
            },
            {
              name: 'logic_operator$subexpression$1',
              symbols: [T2.has('AND') ? { type: 'AND' } : AND],
            },
            {
              name: 'logic_operator$subexpression$1',
              symbols: [T2.has('OR') ? { type: 'OR' } : OR],
            },
            {
              name: 'logic_operator$subexpression$1',
              symbols: [T2.has('XOR') ? { type: 'XOR' } : XOR],
            },
            {
              name: 'logic_operator',
            ...
            },
            {
              ...
              symbols: [T2.has('WHEN') ? { type: 'WHEN' } : WHEN],
            },
            {
              name: 'other_keyword$subexpression$1',
              symbols: [T2.has('THEN') ? { type: 'THEN' } : THEN],
            },
            {
              name: 'other_keyword$subexpression$1',
              symbols: [T2.has('ELSE') ? { type: 'ELSE' } : ELSE],
            },
            {
              name: 'other_keyword$subexpression$1',
              symbols: [T2.has('END') ? { type: 'END' } : END],
            },
            {
              name: 'other_keyword',
        ...
        RT = class {
          ...
          trimHorizontalWhitespace() {
            for (; RR(TN(this.items)); ) this.items.pop();
          }
          trimWhitespace() {
            for (; RA(TN(this.items)); ) this.items.pop();
          }
          addNewline(E) {
            if (this.items.length > 0)
              switch (TN(this.items)) {
                case 3:
      ...
      var RI = 'top-level',
        RN = class {
          ...
          decreaseTopLevel() {
            this.indentTypes.length > 0 &&
              TN(this.indentTypes) === RI &&
              this.indentTypes.pop();
          }
          decreaseBlockLevel() {
            for (
              ;
              this.indentTypes.length > 0 && this.indentTypes.pop() === RI;
        ...
        R_ = class E {
          ...
          isOnelineClause(E) {
            return Tb(this.cfg)
              ? this.dialectCfg.tabularOnelineClauses[E.nameKw.text]
              : this.dialectCfg.onelineClauses[E.nameKw.text];
          }
          ...
          formatLimitClause(E) {
            (this.withComments(E.limitKw, () => {
              ...
              this.layout.indentation.increaseTopLevel(),
              Tb(this.cfg) ? this.layout.add(0) : this.layout.add(3, 5),
              E.offset &&
          ...
          formatBlockComment(E) {
            'block_comment' === E.type && this.isMultilineBlockComment(E)
          ...
          isMultilineBlockComment(E) {
            return T_(E.text) || T_(E.precedingWhitespace || '');
          }
          isDocComment(E) {
            let T = E.split(/\n/);
            return (
          ...
          formatInlineExpression(T) {
            ...
            try {
              return new E({
                ...
                dialectCfg: this.dialectCfg,
                params: this.params,
                layout: new RL(this.cfg.expressionWidth),
                inline: !0,
              }).format(T);
            } catch (E) {
              if (E instanceof RC) {
          ...
          showKw(E) {
            return RO(E.tokenType)
              ? RS(this.showNonTabularKw(E), this.cfg.indentStyle)
          ...
          showFunctionKw(E) {
            return RO(E.tokenType)
              ? RS(this.showNonTabularFunctionKw(E), this.cfg.indentStyle)
        ...
        Re = class {
          constructor(E, T) {
            ((this.dialect = E),
              (this.cfg = T),
              (this.params = new Tx(this.cfg.params)));
          }
          format(E) {
            let T = this.parse(E);
          ...
          parse(E) {
            return (function (E) {
              let T = {},
                R = new T1(R => [
                  ...E.tokenize(R, T).map(T$).map(Tg).map(TQ).map(Tw).map(TZ),
                  V(R.length),
                ]),
                A = new T7(RE.fromCompiled(T9), { lexer: R });
              return {
                parse: (E, R) => {
                  T = R;
                  let { results: S } = A.feed(E);
                  if (1 === S.length) return S[0];
                  if (0 === S.length) throw Error('Parse error: Invalid SQL');
                  throw Error(`Parse error: Ambiguous grammar
${JSON.stringify(S, void 0, 2)}`);
          ...
          formatStatement(E) {
            ...
            let R = new R_({
              ...
              layout: new RT(
                new RN(
                  'tabularLeft' === (T = this.cfg).indentStyle ||
                  'tabularRight' === T.indentStyle
                    ? ' '.repeat(10)
                    : T.useTabs
                      ? '	'
                      : ' '.repeat(T.tabWidth)
        ...
        Rs = (E, T = {}) => {
          if ('string' == typeof T.language && !RU.includes(T.language))
            throw new RD(`Unsupported SQL dialect: ${T.language}`);
          let R = RP[T.language || 'sql'];
          return Rt(E, P(D({}, T), { dialect: M[R] }));
        },
        Rt = (E, T) => {
          var { dialect: R } = T,
            A = U(T, ['dialect']);
          ...
          let S = (function (E) {
            ...
            for (let T of [
              ...
              if (T in E) throw new RD(`${T} config is no more supported.`);
            ...
            if (
              (E.params &&
                !((T = E.params) instanceof Array ? T : Object.values(T)).every(
                  E => 'string' == typeof E
                ) &&
                console.warn(
              ...
              E.paramTypes &&
                !(
                  !((R = E.paramTypes).custom && Array.isArray(R.custom)) ||
                  R.custom.every(E => '' !== E.regex)
                ))
            )
              throw new RD(
