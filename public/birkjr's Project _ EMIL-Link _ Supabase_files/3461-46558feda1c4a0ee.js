!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = 'd3b58795-4e9e-4acb-b78c-1d5468b75726'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-d3b58795-4e9e-4acb-b78c-1d5468b75726'));
  } catch (e) {}
})();
('use strict');
  ...
  [3461],
  {
    ...
    78484: function (e, t, n) {
      ...
      t.Z = e => {
        ...
        let {
          ...
          [z, I] = (0, f.useState)(!1),
          O = k.DL.concat(R.map(e => e.format.replaceAll('"', ''))),
          K = !T || O.includes(T),
          B = k.VP[T],
          U = e => {
            switch (e) {
    ...
    62859: function (e, t, n) {
      ...
      let _ = function () {
        ...
        return (0, f.D)(e => Z(e), {
          async onSuccess(t, n, l) {
            ...
            (await a.invalidateQueries(k.s.tableRowsAndCount(s, i.id)),
              await (null == e ? void 0 : e(t, n, l)));
          },
          async onError(e, n, a) {
      ...
      let J = function (e) {
        ...
        return (0, q.a)(
          ...
          e => {
            let { signal: l } = e;
            return Q({ projectRef: t, connectionString: n, id: a }, l);
          },
                ...
                (0, s.jsx)(eF, {
                  ...
                  onSaveRelation: e => {
                    ...
                    void 0 !== e.id && l.includes(e.id)
                      ...
                      : r(a.concat([e]));
                    let s =
                      null === (t = e.columns.find(e => e.source === n.name)) ||
                      void 0 === t
                        ? void 0
                        : t.targetType;
                    s && i(s);
        ...
        eH = e => {
          ...
          let z = e => {
              ...
              (t &&
                ...
                (t || n) &&
                  k((0, ey.Sb)(e.format || N.format, e.name || N.name)),
                w({ ...N, ...e }),
                y());
              let a = { ...j };
          ...
          return (0, s.jsxs)(
            ee.ZP,
            {
              ...
              visible: u,
              onConfirm: e => I(e),
              header: (0, s.jsx)(eq, { table: c, column: d }),
              onCancel: h,
              customFooter: (0, s.jsx)(es.Z, {
                backButtonLabel: 'Cancel',
                applyButtonLabel: 'Save',
                      ...
                      (0, s.jsx)(et.Z, {
                        ...
                        value:
                          ...
                          void 0 !== n
                            ? n
                            : '',
                        onChange: e => z({ comment: e.target.value }),
                        'data-sentry-element': 'Input',
                        'data-sentry-source-file': 'ColumnEditor.tsx',
                      }),
                    ],
                    ...
                    description: (0, s.jsxs)('div', {
                      ...
                      children: [
                        (0, s.jsx)(en.z, {
                          ...
                          type: 'default',
                          size: 'tiny',
                          icon: (0, s.jsx)(B.Z, { strokeWidth: 2 }),
                          children: (0, s.jsx)(M(), {
                        ...
                        (0, s.jsx)(en.z, {
                          ...
                          type: 'default',
                          size: 'tiny',
                          icon: (0, s.jsx)(U.Z, { size: 14, strokeWidth: 2 }),
                          children: (0, s.jsx)(M(), {
                  ...
                  children: (0, s.jsxs)(Y.B4, {
                    ...
                    children: [
                      ...
                      (0, s.jsx)(el.Z, {
                        ...
                        onChange: () => z({ isNullable: !N.isNullable }),
                        'data-sentry-element': 'Toggle',
                        'data-sentry-source-file': 'ColumnEditor.tsx',
                      }),
                      (0, s.jsx)(el.Z, {
                        ...
                        checked: N.isUnique,
                        onChange: () => z({ isUnique: !N.isUnique }),
                        'data-sentry-element': 'Toggle',
                        'data-sentry-source-file': 'ColumnEditor.tsx',
                      }),
                      (0, s.jsx)(et.Z, {
                        ...
                        value:
                          ...
                          void 0 !== r
                            ? r
                            : '',
                        onChange: e => z({ check: e.target.value }),
      ...
      let tt = function (e) {
        ...
        tn = (e, t) => {
          let n = 'object' == typeof t[e] ? JSON.stringify(t[e]) : t[e];
          return (0, s.jsx)('div', {
      ...
      var ta = e => {
          let { table: t, rows: n, onRowSelect: a } = e,
            l = t.columns.map(e => {
              let t = (0, e9.ve)(e),
                n = (e.name.length + e.format.length) * e9.i1;
              return {
                key: e.name,
                name: e.name,
                renderCell: t => tn(e.name, t.row),
                renderHeaderCell: () => tt(e.name, e.isPrimaryKey),
                resizable: !0,
                width: t < n ? n : t,
                minWidth: e6.mr,
              };
            });
          return (0, s.jsx)(e7.ZP, {
            columns: l,
            rows: n,
            style: { height: '100%' },
        ...
        tl = e => {
          ...
          let { visible: o, foreignKey: d, onSelect: c, closePanel: u } = e,
            ...
            C = S && (0, eG.NK)(S),
            [E, k] = (0, x.useState)({ filter: [], sort: [] }),
            T = (0, eG.rg)(
              (null == S ? void 0 : S.name) || '',
              null !== (n = E.sort) && void 0 !== n ? n : []
            ),
            P = (0, eG.Yb)(null !== (a = E.filter) && void 0 !== a ? a : []),
            [R, Z] = (0, x.useState)(1),
            _ = (0, A.fN)(),
            {
              data: L,
      ...
      let tg = e => {
          ...
          return void 0 === n
            ...
            : 'bool' === t.format && null === n[t.name]
              ? 'null'
              : er.nA.includes(t.format)
                ? tS(t.format, n[t.name])
                : tN(n[t.name], t.format);
        },
        tj = (e, t, n) => {
          var a;
          let { primary_keys: l } = t,
            s = l.map(e => e.name);
          return (null !== (a = t.columns) && void 0 !== a ? a : []).map(t => {
            var a, l;
            let i = tg({ column: t, row: e }),
              r = n.find(e => e.columns.map(e => e.source).includes(t.name));
            return {
              value: i,
              foreignKey:
                void 0 !== r
                  ? {
                      ...
                      target_table_schema: r.schema,
                      target_table_name: r.table,
                      target_column_name:
                        null !==
                          (l =
                            null ===
                              (a = r.columns.find(e => e.source === t.name)) ||
                            void 0 === a
                              ? void 0
                              : a.target) && void 0 !== l
                          ? l
          ...
          return (
            e.forEach(e => {
              ...
              if (
                ...
                if (tT(e.value)) return;
                try {
                  (0, e_.jn)(null !== (l = e.value) && void 0 !== l ? l : '');
                } catch (n) {
        ...
        tS = (e, t) => {
          ...
          if (er.Ks.includes(e)) return tc()(t).format('YYYY-MM-DDTHH:mm:ss');
          if (!er.XO.includes(e)) return t;
          {
            let e = t && t.includes('+') ? 'HH:mm:ssZZ' : 'HH:mm:ss';
            return tc()(t, e).format('HH:mm:ss');
          }
        },
        tC = (e, t) => {
          ...
          switch (e) {
            case 'timestamptz':
              return tc()(t, 'YYYY-MM-DDTHH:mm:ss').format(
            ...
            case 'timetz':
              return tc()(t, 'HH:mm:ss').format('HH:mm:ssZZ');
            case 'time':
              return tc()(t, 'HH:mm:ss').format('HH:mm:ss');
            default:
              return t;
          }
        },
        tE = function (e) {
          ...
          return (
            e.forEach(e => {
              var t;
              let a = e.format.startsWith('_'),
                l = er.BB.includes(e.format)
                  ? e.value
                  : 0 ===
                    ...
                    ? null
                    : e.value;
              if (a && null !== l) n[e.name] = (0, e_.dW)(l);
              else if (e.format.includes('json'))
                'object' == typeof e.value
                  ? (n[e.name] = l)
                  : tf()(l) && (n[e.name] = (0, e_.dW)(l));
              else if ('bool' === e.format && l)
                'null' === l ? (n[e.name] = null) : (n[e.name] = 'true' === l);
              else if (er.nA.includes(e.format)) {
                let t =
                  2 === (l || '').split(':').length ? ''.concat(l, ':00') : l;
                n[e.name] = tC(e.format, t);
              } else n[e.name] = l;
            }),
            t ? n : tv()(n, th())
          );
        ...
        tk = (e, t) => {
          ...
          return (
            Object.keys(n).forEach(l => {
              let s = t.find(e => e.name === l),
                i = null == s ? void 0 : s.format;
              if (void 0 !== i && er.nA.includes(i)) {
                let t = tS(i, e[l]);
                tC(i, t) !== n[l] && (a[l] = n[l]);
              } else
                void 0 !== i && er.YF.includes(i)
                  ? tT(null == s ? void 0 : s.value) || (a[l] = n[l])
                  : eV()(e[l], n[l]) || (a[l] = n[l]);
            }),
            a
          );
      ...
      var tP = n(77875),
                ...
                t.map(e =>
                  (0, s.jsxs)(
                    'div',
                    {
                      className: 'flex items-center space-x-2',
                      children: [
                        (0, s.jsx)(tZ.Z, { size: 16, strokeWidth: 2 }),
                        e === tR()(t)
                          ? (0, s.jsx)('p', {
        ...
        tL = e => {
          ...
          let i = Object.keys(n).filter(
              e => 'object' == typeof n[e] && !th()(n[e])
            ),
            r = Object.keys(n).filter(
              e => th()(n[e]) || 'object' != typeof n[e]
            );
          return (0, s.jsxs)('div', {
            className: 'max-w-[50%] flex-1 '.concat(
              2 === t ? 'border-l border-default' : ''
        ...
        tI = e => {
          let {
            ...
            N = tT(b),
            { mutate: w, isLoading: S, isSuccess: C, reset: k } = (0, tr.rp)(),
            T = async e => {
              try {
                let t = (0, e_.tT)(v),
                  n = (0, e_.jn)(t);
        ...
        tQ = e => {
            ...
            return '_' === c.format[0]
              ? (0, s.jsx)('div', {
                  ...
                  children: (0, s.jsx)(et.Z.TextArea, {
                    'data-testid': ''.concat(c.name, '-input'),
                    layout: 'horizontal',
                    label: c.name,
                    className: 'text-sm',
                    descriptionText: c.comment,
                    labelOptional: c.format,
                    disabled: !x,
                    error: u[c.name],
                    rows: 5,
                    value: null !== (t = c.value) && void 0 !== t ? t : '',
                    placeholder:
                      null === c.defaultValue
                        ? ''
                        : 'string' == typeof c.defaultValue &&
                            0 === c.defaultValue.length
                          ? 'EMPTY'
                          : 'Default: '.concat(c.defaultValue),
                    onChange: e => h({ [c.name]: e.target.value }),
                  }),
                })
              : (0, s.jsxs)(eo.ZP, {
                  size: 'medium',
                  layout: 'horizontal',
                  value: null !== (n = c.value) && void 0 !== n ? n : '',
                  label: c.name,
                  labelOptional: c.format,
                  descriptionText: c.comment,
                  disabled: !x,
          ...
          if (void 0 !== c.foreignKey)
            return (0, s.jsx)(et.Z, {
              'data-testid': ''.concat(c.name, '-input'),
              layout: 'horizontal',
              placeholder: 'NULL',
              label: c.name,
              value: null !== (a = c.value) && void 0 !== a ? a : '',
              descriptionText: (0, s.jsxs)(s.Fragment, {
                children: [
                  ...
                  (0, s.jsxs)('span', {
                    ...
                    children: [
                      c.foreignKey.target_table_schema,
                      '.',
                      c.foreignKey.target_table_name,
                      '.',
                      c.foreignKey.target_column_name,
                    ],
                  }),
                  c.comment &&
                    (0, s.jsx)('span', {
          ...
          if (tV()(er.BB, c.format)) {
            ...
            return (0, s.jsx)('div', {
              ...
              children: (0, s.jsx)(et.Z.TextArea, {
                ...
                descriptionText: (0, s.jsxs)(s.Fragment, {
                  children: [
                    c.comment && (0, s.jsx)('p', { children: c.comment }),
                    e &&
                      (0, s.jsx)('p', {
                        children:
                ...
                error: u[c.name],
                rows: 5,
                value: null !== (l = c.value) && void 0 !== l ? l : '',
                placeholder:
                  null === c.value && null === c.defaultValue
                    ? 'NULL'
                    : '' === c.value
                      ? 'EMPTY'
                      : 'string' == typeof c.defaultValue &&
                          0 === c.defaultValue.length
                        ? 'EMPTY'
                        : 'NULL (Default: '.concat(c.defaultValue, ')'),
                actions: (0, s.jsxs)(eh.h_, {
                  children: [
                    (0, s.jsx)(eh.$F, {
                      asChild: !0,
          ...
          if (tV()(er.YF, c.format)) {
            let e = tT(c.value);
            return (0, s.jsx)(et.Z, {
              'data-testid': ''.concat(c.name, '-input'),
              layout: 'horizontal',
              value: null !== (i = c.value) && void 0 !== i ? i : '',
              label: c.name,
              descriptionText: (0, s.jsxs)(s.Fragment, {
                children: [
                  c.comment && (0, s.jsx)('p', { children: c.comment }),
              ...
              disabled: !x || e,
              placeholder:
                null !== (r = null == c ? void 0 : c.defaultValue) &&
                void 0 !== r
                  ? r
                  : 'NULL',
              error: u[c.name],
              ...
              actions: (0, s.jsx)(en.z, {
                type: 'default',
                htmlType: 'button',
                onClick: () => p({ column: c.name, value: c.value }),
                icon: (0, s.jsx)(tW.Z, {}),
                children: 'Edit JSON',
              }),
            });
          }
          if (tV()(er.nA, c.format))
            return (0, s.jsx)(tH, {
              name: c.name,
              format: c.format,
              value: null !== (o = c.value) && void 0 !== o ? o : '',
              isNullable: c.isNullable,
              description: (0, s.jsxs)(s.Fragment, {
                children: [
                  c.defaultValue &&
                    (0, s.jsxs)('p', {
                      children: ['Default: ', c.defaultValue],
                    }),
                  c.comment && (0, s.jsx)('p', { children: c.comment }),
                ],
              }),
              onChange: e => h({ [c.name]: e }),
            });
          if ('bool' === c.format) {
            let e = [
                { value: 'true', label: 'TRUE' },
                { value: 'false', label: 'FALSE' },
                ...(c.isNullable ? [{ value: 'null', label: 'NULL' }] : []),
              ],
              t = null === c.value ? void 0 : c.value;
            return (0, s.jsx)(tq.E, {
              isReactForm: !1,
              layout: 'horizontal',
              label: c.name,
              ...
              children: (0, s.jsxs)(tY.Ph, {
                value: null === t ? 'null' : t,
                onValueChange: e => h({ [c.name]: e }),
                children: [
                  (0, s.jsx)(tY.i4, {
                    children: (0, s.jsx)(tY.ki, {
                      placeholder: 'Select a value',
                    }),
                  }),
                  (0, s.jsx)(tY.Bw, {
                    children: (0, s.jsx)(tY.DI, {
                      children: e.map(e =>
                        (0, s.jsx)(
                          tY.Ql,
          ...
          return (0, s.jsx)(et.Z, {
            ...
            labelOptional: c.format,
            error: u[c.name],
            value: null !== (d = c.value) && void 0 !== d ? d : '',
            placeholder: c.isIdentity
      ...
      let tG = e => {
        let {
          ...
          v = null == a ? void 0 : a[l],
          g = tT(v),
          { mutate: j, isLoading: b, isSuccess: N, reset: w } = (0, tr.rp)();
        (0, x.useEffect)(() => {
          t && (y('edit'), p(v));
        }, [t]);
      ...
      var t$ = e => {
          ...
          return (0, s.jsxs)(
            ee.ZP,
            {
              ...
              size: 'large',
              visible: d,
              header: (0, s.jsx)(tB, { isNewRecord: T, tableName: r.name }),
              ...
              children: [
                ...
                (0, s.jsx)(
                  tl,
                  {
                    ...
                    foreignKey: I,
                    onSelect: e => {
                      (void 0 !== E && void 0 !== e && O(e), C(!1), k(void 0));
                    },
                    closePanel: () => {
                      (C(!1), k(void 0));
                    },
      ...
      async function t1(e) {
        let { name: t, projectRef: n, connectionString: a } = e,
          l = t0.Z.schemas.create({ name: t, owner: 'postgres' }).sql,
      ...
      let nd = async (e, t, n, a, l) => {
        ...
        np = async e => {
          let {
            ...
            s = '\n  '
              .concat(nx({ table: a, foreignKeys: l }), '\n  ')
              .concat(nu({ table: a, foreignKeys: l }), '\n  ')
              .replace(/\s+/g, ' ')
              .trim();
          return await (0, P.R)({
            projectRef: t,
        ...
        nf = async e => {
          ...
          try {
            let { isPrimaryKey: e, ...o } = a,
              c = await nt({ projectRef: t, connectionString: n, payload: o });
            if (e) {
              h.Am.loading('Assigning primary key to column...', { id: d });
              let e = l.primary_keys.map(e => e.name);
              e.length > 0 &&
                void 0 !== s &&
                (await nc(t, n, c.schema, c.table, s.name));
              let a = e.concat([c.name]);
              await nd(t, n, c.schema, c.table, a);
            }
            (i.length > 0 &&
              (await nm({
                projectRef: t,
        ...
        ny = async e => {
          ...
          try {
            ...
            if (!d && void 0 !== e) {
              ...
              a.length > 0 &&
                void 0 !== i &&
                (await nc(t, n, m.schema, m.table, i.name));
              let l = e ? a.concat([m.name]) : a.filter(e => e !== m.name);
              l.length && (await nd(t, n, m.schema, m.table, l));
            }
            (r.length > 0 &&
              (await nw({
                projectRef: t,
        ...
        ng = async e => {
          let {
            ...
            c = (0, ns.g)(),
            u = await ni({ projectRef: t, connectionString: n, payload: l });
          try {
            for (let e of (o &&
              (await (0, no.T)({
                projectRef: t,
            ...
            i)) {
              ...
              await nt({ projectRef: t, connectionString: n, payload: a });
            }
            let e = i.filter(e => e.isPrimaryKey).map(e => e.name);
            if (
              (e.length > 0 && (await nd(t, n, u.schema, u.name, e)),
              r.length > 0 &&
                (await nm({
                  projectRef: t,
                  connectionString: n,
        ...
        nj = async e => {
          ...
          let {
            ...
            p = !eV()(m, x);
          p && void 0 !== u && (await nc(n, a, s.schema, s.name, u.name));
          let f = await (0, no.T)({
              projectRef: n,
              connectionString: a,
              id: s.id,
          ...
          (p && m.length > 0 && (await nd(n, a, f.schema, f.name, m)),
            await nw({
              projectRef: n,
              connectionString: a,
              table: f,
          ...
          return (
            ...
            await j.invalidateQueries(k.s.tableRowsAndCount(n, s.id)),
            {
        ...
        nN = async (e, t, n, a, l, s) => {
          ...
          for (let e of t3()(d, 10)) {
            let t = await Promise.allSettled(e.map(e => e()));
            if (t9()(t, { status: 'rejected' })) break;
            s(100 * r);
          }
          return { error: i };
        },
                ...
                ? (0, s.jsxs)('div', {
                    ...
                    children: [
                      (0, s.jsxs)('div', {
                        className: 'flex items-center space-x-2',
                        children: [
                          (0, s.jsx)(nk.Z, { size: 14, strokeWidth: 1.5 }),
                          (0, s.jsx)('p', {
      ...
      let n_ = [
        ...
        nL = ['csv', 'tsv'],
        nD = { headers: [], rows: [], rowCount: 0, columnTypeMap: {} };
      var nF = n(45346),
        nz = n.n(nF);
      let nI = e => {
          let t = {};
        ...
        nK = (e, t) => {
          ...
          return tV()(['true', 'false'], n.toString().toLowerCase()) &&
            a.every(
              e =>
                null == e || tV()(['true', 'false'], e.toString().toLowerCase())
            )
            ? 'bool'
            : (0, e_.dW)(n) && a.every(e => (0, e_.dW)(n))
              ? 'jsonb'
              : Date.parse(n) &&
                  a.every(e => tc()(e, 'YYYY-MM-DD hh:mm:ss').isValid())
                ? 'timestamptz'
                : 'text';
        },
        nB = e => {
      ...
      var nU = n(44735),
                    ...
                    (0, s.jsx)('div', {
                      ...
                      children:
                        h.length > 0 && p.length > 0
                          ? (0, s.jsx)(nV, { height: 350, headers: h, rows: p })
                          : (0, s.jsxs)('div', {
                              className:
        ...
        nW = e => {
          ...
          let [u, p] = (0, x.useState)('fileUpload'),
            [f, y] = (0, x.useState)(''),
            [v, g] = (0, x.useState)(),
            [j, b] = (0, x.useState)(0),
            [N, w] = (0, x.useState)({
            ...
            P = E.filter(e => !T.includes(e)),
            R = void 0 === r || 0 === P.length,
            A = e => {
              b(e);
            },
            Z = async e => {
              ...
              if (t && tV()(n_, null == t ? void 0 : t.type) && nB(t)) {
                if (t.size > 104857600)
                  return (
                    (e.target.value = ''),
                    (0, h.Am)(
                  ...
                  );
                {
                  ...
                  (l.length > 0 &&
                    ...
                    C(l),
                    k(e),
                    w({ headers: e, rows: s, rowCount: n, columnTypeMap: a }));
                }
              } else
                h.Am.error(
            ...
            D = (0, x.useCallback)(nC()(L, a), []);
          return (0, s.jsxs)(ee.ZP, {
            size: 'large',
            visible: n,
            align: 'right',
            header:
                ...
                'fileUpload' === u && void 0 === v
                  ...
                  : 0 === E.length
                    ? (h.Am.error(
                      ...
                      e())
                    : R
                      ? o({ file: v, ...N, selectedHeaders: E, resolve: e })
                      : (h.Am.error(
                ...
                (0, s.jsxs)(s.Fragment, {
                  children: [
                    ...
                    (0, s.jsx)(nA, {
                      ...
                      onToggleHeader: e => {
                        k(
                          E.includes(e) ? E.filter(t => t !== e) : E.concat([e])
                        );
                      },
                    }),
                    (0, s.jsx)(ee.ZP.Separator, {}),
                    ...
                    children: [
                      (0, s.jsxs)(n0.xo, {
                        ...
                        children: [
                          ...
                          (0, s.jsx)('div', {
                            className:
                              'text-foreground-light transition-colors group-hover:text-foreground',
        ...
        n3 = e => {
          ...
          let {
            ...
            [j, b] = (0, x.useState)(),
            N = !o()(r),
            [w, S] = tK()(a, e => e.isPrimaryKey),
            C = e =>
              void 0 !== l.find(t => t.columns.find(t => t.source === e.name)),
            E = (e, t) => {
              c(
                a.map(n => {
            ...
            P = (e, t) => {
              if (e.destination) {
                if ('pks' === t) {
                  ...
                  return (t.splice(e.destination.index, 0, n), c(t.concat(S)));
                }
                if ('others' === t) {
                  let t = S.slice(),
                    [n] = t.splice(e.source.index, 1);
                  return (t.splice(e.destination.index, 0, n), c(w.concat(t)));
                }
              }
            };
          return (0, s.jsxs)(s.Fragment, {
                      ...
                      (0, s.jsxs)('div', {
                        ...
                        children: [
                          (0, s.jsx)(en.z, {
                            asChild: !0,
                            type: 'default',
                            icon: (0, s.jsx)(U.Z, { size: 12, strokeWidth: 2 }),
                            'data-sentry-element': 'Button',
                              ...
                              children: [
                                ...
                                N
                                  ...
                                  : (0, s.jsx)(en.z, {
                                      type: 'default',
                                      onClick: u,
                                      children: 'Import data via spreadsheet',
                                    }),
                              ],
                            }),
                        ],
                    ...
                    children: [
                      (0, s.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, s.jsx)('div', {
                            className: ''.concat(N ? 'w-[10%]' : 'w-0'),
                          }),
                          (0, s.jsx)('div', { className: 'w-[5%]' }),
                          !N && (0, s.jsx)('div', { className: 'w-[5%]' }),
                        ],
                      }),
                      w.length > 0 &&
                        (0, s.jsx)(nQ.Z5, {
                          onDragEnd: e => P(e, 'pks'),
                          children: (0, s.jsx)(nQ.bK, {
      ...
      let ao = e => {
          ...
          return (
            ...
            ar()(e.columns, e => 0 === e.format.length) &&
              (t.columns = 'Ensure that all your columns are assigned a type'),
            ar()(e.columns, e => 0 === e.name.length) &&
      ...
      var am = e => {
          ...
          let { data: C } = (0, G.k)({
            ...
            E = (null != C ? C : []).filter(e => !$.T.includes(e.schema)),
            { data: k } = (0, b.z)({
              projectRef: null == v ? void 0 : v.ref,
              connectionString: null == v ? void 0 : v.connectionString,
            }),
            T = (null != k ? k : []).find(e => 'supabase_realtime' === e.name),
            P =
                ...
                if ((n.columns && h.Am.error(n.columns), Z(n), o()(n))) {
                  ...
                  let n = {
                    ...
                    l = {
                      ...
                      isDuplicateRows: O,
                      existingForeignKeyRelations: el,
                      primaryKey: Q,
                    };
                  u(
                    n,
          ...
          return ((0, x.useEffect)(() => {
            r &&
              ...
              j
                ? (L(ad()), F([]))
                : (L(ac(a, en || [], i, R)), F((0, ei.S)(el))));
          }, [r]),
          (0, x.useEffect)(() => {
            U && !o()(U) && er({ columns: au(U) });
          }, [U]),
          _)
            ? (0, s.jsxs)(
                ee.ZP,
                    ...
                    (0, s.jsxs)(ee.ZP.Content, {
                      ...
                      children: [
                        (0, s.jsx)(et.Z, {
                          ...
                          onChange: e => er({ name: e.target.value }),
                          'data-sentry-element': 'Input',
                          'data-sentry-source-file': 'TableEditor.tsx',
                        }),
                        (0, s.jsx)(et.Z, {
                          ...
                          value:
                            ...
                            void 0 !== n
                              ? n
                              : '',
                          onChange: e => er({ comment: e.target.value }),
                          'data-sentry-element': 'Input',
                          'data-sentry-source-file': 'TableEditor.tsx',
                        }),
                      ],
                      ...
                      children: [
                        (0, s.jsx)(ea.Z, {
                          ...
                          onChange: () => {
                            _.isRLSEnabled
                              ? q(!0)
                              : er({ isRLSEnabled: !_.isRLSEnabled });
                          },
                          size: 'medium',
                          'data-sentry-element': 'Checkbox',
                          'data-sentry-source-file': 'TableEditor.tsx',
                        ...
                        N &&
                          (0, s.jsx)(ea.Z, {
                            ...
                            onChange: () =>
                              er({ isRealtimeEnabled: !_.isRealtimeEnabled }),
                            size: 'medium',
                          }),
                      ],
                    }),
                      ...
                      children: [
                        !i &&
                          (0, s.jsx)(n3, {
                            ...
                            isNewRecord: j,
                            importContent: U,
                            onColumnsUpdated: e => er({ columns: e }),
                            onSelectImportData: () => W(!0),
                            onClearImportContent: () => {
                              (er({ columns: as }), V(void 0));
                            },
                            onUpdateFkRelations: eo,
                          }),
                        i &&
                          (0, s.jsx)(s.Fragment, {
                            children: (0, s.jsx)(ea.Z, {
                        ...
                        (0, s.jsx)(nW, {
                          visible: M,
                          headers: null == U ? void 0 : U.headers,
                          rows: null == U ? void 0 : U.rows,
                          saveContent: e => {
                            (V(e), W(!1));
                          },
                          closePanel: () => W(!1),
                        ...
                        (0, s.jsx)(K.Z, {
                          ...
                          onCancel: () => q(!1),
                          onConfirm: () => {
                            (er({ isRLSEnabled: !_.isRLSEnabled }), q(!1));
                          },
        ...
        ax = e => {
          var t, n, a, l, r, d, u, f, y, v, g, T, P, R, Z, B, U, V, M, W;
          let {
              editable: Y = !0,
              selectedTable: q,
              includeColumns: H = !1,
            ...
            J = (0, I._2)(),
            [X, G] = (0, z.x)({ arrayKeys: ['filter', 'sort'] }),
            $ = (0, i.NL)(),
            { project: ee } = (0, p.d2)(),
            [et, en] = (0, x.useState)(!1),
            [ea, el] = (0, x.useState)(!1),
            es = (
              null !== (W = null == q ? void 0 : q.columns) && void 0 !== W
                ? W
                : []
            )
              .filter(e => {
            ...
            ex = async (e, t) => {
              ...
              let o = {};
              if (
                (null === (n = J.sidePanel) || void 0 === n
                  ? void 0
                  : n.type) === 'json'
              ) {
                let { row: t, column: n } = J.sidePanel.jsonValue;
                ((i = { [n]: null === e ? null : JSON.parse(e) }),
                  q.primary_keys.forEach(e => (o[e.name] = t[e.name])),
                  (r = { identifiers: o, rowIdx: t.idx }));
              } else if (
                (null === (a = J.sidePanel) || void 0 === a
                  ? void 0
                  : a.type) === 'cell'
              ) {
                let t =
                    null === (l = J.sidePanel.value) || void 0 === l
                      ? void 0
                      : l.column,
                  n =
                    null === (s = J.sidePanel.value) || void 0 === s
                      ? void 0
                      : s.row;
                if (!t || !n) return;
                ((i = { [t]: null === e ? null : e }),
                  q.primary_keys.forEach(e => (o[e.name] = n[e.name])),
            ...
            eh = async e => {
              ...
              if (
                void 0 === q ||
                (null === (t = J.sidePanel) || void 0 === t
                  ? void 0
                  : t.type) !== 'foreign-row-selector'
              )
                return;
              let n = J.sidePanel.foreignKey;
              try {
                let { row: t } = n,
                  a = {};
                q.primary_keys.forEach(e => (a[e.name] = t[e.name]));
            ...
            ep = async (e, t, n, a) => {
              var l;
              let s =
                  (null === (l = J.sidePanel) || void 0 === l
                    ? void 0
                    : l.type) === 'column' && J.sidePanel.column,
                {
                  columnId: i,
                  primaryKey: r,
                  foreignKeyRelations: o,
            ...
            ey = async (e, t) => {
              ...
              let n = (null != eo ? eo : []).find(
                ...
                a = await $.fetchQuery({
                  queryKey: D.W.list(ee.ref, 'public', H),
                  queryFn: e => {
                    let { signal: t } = e;
                    return (0, F.Lk)(
                      {
            ...
            ev = async (e, t, n, a, l, s) => {
              ...
              try {
                var p;
                if (
                  (null === (p = J.sidePanel) || void 0 === p
                    ? void 0
                    : p.type) === 'table' &&
                  'duplicate' === J.sidePanel.mode &&
                  q
                ) {
                  i = h.Am.loading('Duplicating table: '.concat(q.name, '...'));
                  let t = await nv(
                    null == ee ? void 0 : ee.ref,
                  ...
                  (c && (await ey(t, c)),
                    await Promise.all([
                      $.invalidateQueries(
                        D.W.list(null == ee ? void 0 : ee.ref, t.schema, H)
                      ),
                      $.invalidateQueries(
                  ...
                  (c && (await ey(a, !0)),
                    await Promise.all([
                      $.invalidateQueries(
                        D.W.list(null == ee ? void 0 : ee.ref, a.schema, H)
                      ),
                      $.invalidateQueries(
                        S.C.list(null == ee ? void 0 : ee.ref)
                      ),
                  ...
                  let { table: a, hasError: l } = await nj({
                    projectRef: null == ee ? void 0 : ee.ref,
                    connectionString: null == ee ? void 0 : ee.connectionString,
                    toastId: i,
                    table: q,
            ...
            eg = async e => {
              ...
              if (t && n > 0) {
                let e = await nb(ee.ref, ee.connectionString, t, q, a, e => {
                  h.Am.loading(
                    (0, s.jsx)(O.S, {
                      progress: e,
                      message: 'Adding '
          ...
          return (0, s.jsxs)(s.Fragment, {
            children: [
              ...
              (0, s.jsx)(am, {
                table:
                  (null === (r = J.sidePanel) || void 0 === r
                    ? void 0
                    : r.type) === 'table' &&
                  ('edit' === J.sidePanel.mode ||
                    'duplicate' === J.sidePanel.mode)
                    ? q
                    : void 0,
                isDuplicating:
                  (null === (d = J.sidePanel) || void 0 === d
                    ? void 0
                    : d.type) === 'table' && 'duplicate' === J.sidePanel.mode,
                visible:
                  (null === (u = J.sidePanel) || void 0 === u
                    ? void 0
                    : u.type) === 'table',
                closePanel: ej,
                saveChanges: ev,
              ...
              (0, s.jsx)(tI, {
                visible:
                  (null === (y = J.sidePanel) || void 0 === y
                    ? void 0
                    : y.type) === 'json',
                row:
                  ((null === (v = J.sidePanel) || void 0 === v
                    ? void 0
                    : v.type) === 'json' &&
                    J.sidePanel.jsonValue.row) ||
                  {},
                column:
                  ((null === (g = J.sidePanel) || void 0 === g
                    ? void 0
                    : g.type) === 'json' &&
                    J.sidePanel.jsonValue.column) ||
                  '',
                backButtonLabel: 'Cancel',
              ...
              (0, s.jsx)(tG, {
                ...
                column:
                  ((null === (P = J.sidePanel) || void 0 === P
                    ? void 0
                    : P.type) === 'cell' &&
                    (null === (R = J.sidePanel.value) || void 0 === R
                      ? void 0
                      : R.column)) ||
                  '',
                row:
                  ((null === (Z = J.sidePanel) || void 0 === Z
                    ? void 0
                    : Z.type) === 'cell' &&
                    (null === (B = J.sidePanel.value) || void 0 === B
                      ? void 0
                      : B.row)) ||
                  {},
                closePanel: ej,
              ...
              (0, s.jsx)(tl, {
                visible:
                  (null === (U = J.sidePanel) || void 0 === U
                    ? void 0
                    : U.type) === 'foreign-row-selector',
                foreignKey:
                  (null === (V = J.sidePanel) || void 0 === V
                    ? void 0
                    : V.type) === 'foreign-row-selector'
                    ? J.sidePanel.foreignKey.foreignKey
                    : void 0,
                closePanel: ej,
                onSelect: eh,
                'data-sentry-element': 'ForeignRowSelector',
    ...
    95526: function (e, t, n) {
      ...
      let r = e => {
        ...
        let T = [E[c].list];
        return (
          p && T.push(E.scrollable),
          f && T.push(E.wrappable),
          g && T.push(g),
          (0, a.jsxs)(l.fC, {
            value: S,
            className: [E.base, j].join(' '),
                ...
                children: [
                  ...
                  w.map(e => {
                    let t = S === e.props.id,
                      n = [E[c].base, E.size[u]];
                    return (
                      t ? n.push(E[c].active) : n.push(E[c].inactive),
                      m && n.push(E.block),
                      (0, a.jsxs)(
                        l.xz,
                        {
                          onKeyDown: t => {
                            'Enter' === t.key &&
                              (t.preventDefault(), k(e.props.id));
                          },
                          onClick: () => k(e.props.id),
                          value: e.props.id,
                          className: n.join(' '),
                          children: [
                            e.props.icon,
