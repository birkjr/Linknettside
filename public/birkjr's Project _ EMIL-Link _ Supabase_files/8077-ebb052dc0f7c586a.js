!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '067c5003-e476-40fe-88d8-edb8d3a90070'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-067c5003-e476-40fe-88d8-edb8d3a90070'));
  } catch (e) {}
})();
('use strict');
    ...
    78077: function (e, t, a) {
      ...
      async function z(e) {
        ...
        let n = await (0, N.v_)(
          ...
          { id: a, public: l, file_size_limit: i, allowed_mime_types: s }
        );
      ...
      async function A(e) {
        ...
        if (!a) throw Error('Bucket name is requried');
        let n = await (0, N.r$)(
          ''.concat(d.T5, '/storage/').concat(t, '/buckets/').concat(a),
          { public: l, file_size_limit: i, allowed_mime_types: s }
        );
        if (n.error) throw n.error;
        return n;
      }
      ...
      async function U(e) {
        ...
        if (!t) throw Error('projectRef is required');
        if (!a) throw Error('Bucket name is requried');
        let { data: l, error: i } = await (0, K.v_)(
      ...
      var Y = a(359),
        ...
        ec = e => {
          let {
              ...
              projectRef: a = '',
              isSelected: i = !1,
              onSelectEmptyBucket: s = el(),
              onSelectDeleteBucket: n = el(),
              onSelectEditBucket: r = el(),
            } = e,
            o = (0, H.Xo)(p.KA.STORAGE_WRITE, '*');
          return (0, l.jsxs)(
            'div',
            {
              className: (0, R.cn)(
                ...
                (0, l.jsx)(b(), {
                  ...
                  children: (0, l.jsxs)('div', {
                    ...
                    children: [
                      (0, l.jsx)('p', {
                        className:
                          'text-sm group-hover:text-foreground transition truncate '.concat(
