(!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '8a14dbd6-c4da-4248-af9e-91e678abff26'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-8a14dbd6-c4da-4248-af9e-91e678abff26'));
  } catch (e) {}
})(),
  (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2281],
    {
      ...
      35336: function (e, t, s) {
        ...
        t.Z = e => {
          ...
          let {
            ...
            b = (0, d.Vm)(),
            N = (0, c.l)(),
            { data: w } = (0, o.Gl)({ orgSlug: null == N ? void 0 : N.slug }),
            C =
              null == w
                ? void 0
                : null === (t = w.plan) || void 0 === t
                  ? void 0
                  : t.id,
            k = (0, l.Xo)(n.KA.BILLING_WRITE, 'stripe.subscriptions'),
            S = (0, u.P)('disableProjectCreationAndUpdate');
          return (0, r.jsx)('div', {
            className: (0, m.cn)(
      ...
      84114: function (e, t, s) {
        ...
        async function b(e) {
          let { ref: t, name: s } = e,
            r = await (0, y.r$)(''.concat(v.T5, '/projects/').concat(t), {
              name: s,
            });
        ...
        let N = function () {
          ...
          return (0, j.D)(e => b(e), {
            async onSuccess(t, s, n) {
              let { ref: a } = s;
              (await Promise.all([
                r.invalidateQueries(g.i.list()),
                r.invalidateQueries(g.i.detail(a)),
              ]),
            ...
            let t = (0, L.useRouter)(),
              ...
              m =
                null !== (e = null == n ? void 0 : n.ref) && void 0 !== e
                  ? e
                  : '',
              f = (null == n ? void 0 : n.status) === v.S.INACTIVE,
              x = (0, w.Xo)(a.KA.INFRA_EXECUTE, 'queue_jobs.projects.pause'),
              { data: p } = (0, I.Gl)({ orgSlug: null == i ? void 0 : i.slug }),
              j = (null == p ? void 0 : p.plan.id) === 'free',
              { mutate: y, isLoading: g } = M({
                onSuccess: (e, r) => {
                  ((0, B.k7)(s, r.ref, v.S.PAUSING),
        ...
        var W = s(21786),
            ...
            let s = (0, L.useRouter)(),
              ...
              f =
                null !== (t = null == i ? void 0 : i.region) && void 0 !== t
                  ? t
                  : '',
              x = (0, W.P)('disableProjectRestarts'),
              p = (0, w.Xo)(a.KA.INFRA_EXECUTE, 'reboot'),
              { mutate: j, isLoading: y } = (0, U.D)({
                onSuccess: () => {
                  k();
                },
                onError: e => {
          ...
          $ = () => {
            ...
            let { project: s } = (0, d.d2)(),
              n = (0, C.l)(),
              o = (0, k.N$)(null == s ? void 0 : s.parent_project_ref),
              h = void 0 !== o,
              ...
              v = (0, w.Xo)(a.KA.UPDATE, 'projects', {
                resource: { project_id: null == s ? void 0 : s.id },
              }),
              { mutate: g, isLoading: b } = N(),
              T = async (e, t) => {
                let { resetForm: r } = t;
        ...
        let eu = function () {
          ...
          return (0, j.D)(e => ed(e), {
            async onSuccess(t, s, n) {
              let { projectRef: a } = s;
              (await r.invalidateQueries(ec.A.list(a)),
                await (null == e ? void 0 : e(t, s, n)));
            },
            async onError(e, s, r) {
              void 0 === t
        ...
        var ex = e => {
            ...
            let { projectRef: s, customDomain: n } = e,
              [a, i] = (0, R.useState)(!1),
              { data: o } = (0, en.zR)({ projectRef: s }),
              { mutate: l, isLoading: d } = el(),
              { mutate: u, isLoading: m } = eu({
                onSuccess: () => {
                  (c.Am.success('Successfully activated custom domain'), i(!1));
                },
              }),
              { mutate: f, isLoading: p } = ef(),
              h =
                null == o
                  ? void 0
        ...
        var eC = e => {
            ...
            let { customDomain: u } = e,
              { ref: m } = (0, et.UO)(),
              [f, p] = (0, R.useState)(!1),
              { data: h } = (0, en.zR)({ projectRef: m }),
              { mutate: j, isLoading: y } = eg({
                onSuccess: e => {
                  '2_initiated' === e.status && p(!0);
                },
              }),
              { mutate: v, isLoading: g } = ef(),
              b =
        ...
        var eA = () => {
            ...
            let { ref: t } = (0, et.UO)(),
              { project: s } = (0, d.d2)(),
              { mutate: n, isLoading: i } = el(),
              { mutate: o, isLoading: l } = eP(),
              { data: c } = (0, en.zR)({ projectRef: t }),
          ...
          eT = () => {
            ...
            let { ref: t } = (0, et.UO)(),
              s = (0, C.l)(),
              n = (0, W.P)('customDomainsDisabledDueToQuota'),
              { data: a } = (0, I.Gl)({ orgSlug: null == s ? void 0 : s.slug }),
              i =
                null == a
                  ? void 0
                  : null === (e = a.plan) || void 0 === e
                    ? void 0
                    : e.id,
              { isLoading: o } = (0, en.zR)({ projectRef: t }),
              {
                isLoading: c,
                isError: d,
                isSuccess: u,
                        ...
                        children: (0, r.jsx)(x.Z.Content, {
                          ...
                          children: (0, r.jsxs)('div', {
                            className:
                              'flex items-center justify-center space-x-2 py-8',
                            children: [
                              (0, r.jsx)(ee.Z, { size: 16, strokeWidth: 1.5 }),
                              (0, r.jsxs)('p', {
                                className: 'text-sm text-foreground-light',
                                children: [
        ...
        async function eO(e) {
          ...
          let r = await (0, y.v_)(
            ''.concat(v.T5, '/projects/').concat(t, '/transfer'),
        ...
        let eV = function () {
          ...
          return (0, j.D)(e => eO(e), {
            async onSuccess(t, s, n) {
              ...
              (await Promise.all([
                r.invalidateQueries(g.i.projectTransferPreview(a, i)),
                r.invalidateQueries(g.i.detail(a)),
                r.invalidateQueries(g.i.list()),
              ]),
                await (null == e ? void 0 : e(t, s, n)));
        ...
        async function eU(e, t) {
          ...
          let n = await (0, y.v_)(
            ''.concat(v.T5, '/projects/').concat(s, '/transfer/preview'),
          ...
          let { projectRef: t, targetOrganizationSlug: s } = e,
            { enabled: r = !0, ...n } =
              arguments.length > 1 && void 0 !== arguments[1]
                ...
                : {};
          return (0, eq.a)(
            g.i.projectTransferPreview(t, s),
            e => {
              let { signal: r } = e;
        ...
        var eY = s(42155),
          ...
          eQ = () => {
            let e = (0, k.Vm)(),
              ...
              { data: n } = (0, eI.tl)(),
              i = (0, W.P)('disableProjectTransfer'),
              o = (n || []).filter(e => e.id !== s),
              [l, d] = (0, R.useState)(!1),
              [u, m] = (0, R.useState)(),
              {
            ...
            let g = (0, w.Xo)(a.KA.UPDATE, 'organizations'),
              b = () => {
                d(!l);
              };
            async function N() {
        ...
        async function e2(e) {
          ...
          if (!t) throw Error('projectRef is required');
          let { data: r, error: n } = await (0, F.r$)(
        ...
        let e7 = () => {
          let { project: e } = (0, d.d2)(),
            ...
            { projectsTransfer: a } = (0, e9.N)(['projects:transfer']),
            { data: i } = (0, I.Gl)({ orgSlug: null == t ? void 0 : t.slug }),
            o = (0, n.$w)(i);
          return (0, r.jsxs)(r.Fragment, {
            children: [
              (0, r.jsx)(e8._S, {
        ...
        e7.getLayout = e => (0, r.jsx)(e6.Z, { title: 'General', children: e });
        var te = e7;
      },
        ...
        function h(e) {
          ...
          (I && !w && ((w = I[y || v]), (A = I[y || v])),
            ...
            (0, o.useEffect)(() => {
              ...
              F(null === (e = s[0]) || void 0 === e ? void 0 : e.props);
            }, [L]));
                      ...
                      children: [
                        (0, r.jsxs)('span', {
                          ...
                          children: [
                            ...
                            (null == z ? void 0 : z.addOnBefore) &&
                              (0, r.jsx)(z.addOnBefore, {}),
                            (0, r.jsx)('span', {
                              className: E.label,
                              children: null == z ? void 0 : z.label,
                            }),
                          ],
                        }),
                        (0, r.jsx)('span', {
