!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = 'e6259dd0-2cfa-4b62-bfc0-ff18ad44efb2'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-e6259dd0-2cfa-4b62-bfc0-ff18ad44efb2'));
  } catch (e) {}
})();
('use strict');
  ...
  [5227],
  {
    ...
    80023: function (e, t, r) {
      ...
      let n = {
        ...
        orgDailyComputeStats: (e, t) => {
          let { startDate: r, endDate: n, projectRef: a } = t;
          return [
            'organizations',
            e,
            'daily-stats-compute',
            { startDate: s(r), endDate: s(n), projectRef: a },
          ];
        },
        orgDailyStats: (e, t) => {
          let {
    ...
    63186: function (e, t, r) {
      ...
      async function i(e, t) {
        ...
        let { data: n, error: a } = await (0, s.U2)(
      ...
      let o = function (e) {
        ...
        return (0, n.a)(
          a.d.usageApiRequestsCount(t),
          e => {
            let { signal: r } = e;
            return i({ projectRef: t }, r);
          },
      ...
      function c(e, t) {
        let { projectRef: r } = t;
        return e.fetchQuery(a.d.usageApiRequestsCount(r), e => {
          let { signal: t } = e;
          return i({ projectRef: r }, t);
        });
      }
    },
    77631: function (e, t, r) {
      ...
      async function i(e, t) {
        ...
        let { data: a, error: i } = await (0, s.U2)(
      ...
      let o = function (e) {
        let { projectRef: t, interval: r } = e,
          { enabled: s = !0, ...o } =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (0, n.a)(
          a.d.usageApiCounts(t, r),
          e => {
            let { signal: n } = e;
            return i({ projectRef: t, interval: r }, n);
          },
      ...
      function c(e, t) {
        ...
        return e.fetchQuery(a.d.usageApiCounts(r, n), e => {
          let { signal: t } = e;
          return i({ projectRef: r, interval: n }, t);
        });
      }
    },
    987: function (e, t, r) {
      ...
      async function i(e, t) {
        ...
        return (a && (0, s.S3)(a), n.connections);
      }
      let o = function (e) {
        let { organizationId: t } = e,
          { enabled: r = !0, ...s } =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (0, n.a)(
          a.F.githubConnectionsList(t),
          e => {
            let { signal: r } = e;
            return i({ organizationId: t }, r);
          },
          { enabled: r && void 0 !== t, ...s }
        );
      };
    ...
    15501: function (e, t, r) {
      ...
      async function o(e, t) {
        ...
        let n = await (0, s.U2)(
          ''.concat(a.T5, '/integrations/').concat(r, '?expand=true'),
          { signal: t }
        );
    ...
    47589: function (e, t, r) {
      ...
      let b = e => {
        let { resourceWarnings: t, projectStatus: r } = e,
          ...
          a = (null == s ? void 0 : s.is_readonly_mode_enabled)
            ? ['is_readonly_mode_enabled']
          ...
          i = a.some(e => (null == s ? void 0 : s[e]) === 'critical'),
          o = a.includes('is_readonly_mode_enabled') || i,
          c = void 0 !== s ? (0, x.L)(s, a[0], 'cardContent') : void 0,
          l =
            'isPaused' === r
              ? 'Project is paused'
              : 'isPausing' === r
          ...
          d = (() => {
            ...
            if (s) return (a.length, null == c ? void 0 : c.description);
          })(),
          u = o ? 'destructive' : 'isPaused' === r ? 'default' : 'warning';
        return (0 === a.length || void 0 === c) && 'isHealthy' === r
          ? null
          : (0, n.jsxs)(j.bZ, {
              variant: u,
              className: (0, v.cn)(
    ...
    6719: function (e, t, r) {
      ...
      var n = r(97458),
        ...
        a = r(65092);
      function i(e) {
        let { infraComputeSize: t, className: r, ...i } = e,
          o =
