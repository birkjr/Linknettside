(!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '194e5daa-aa88-4735-9988-44057b1429c6'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-194e5daa-aa88-4735-9988-44057b1429c6'));
  } catch (e) {}
})(),
    ...
    [2241],
    {
      ...
      44146: function (e, t, n) {
                                      ...
                                      children: (0, s.jsxs)('div', {
                                        ...
                                        children: [
                                          (0, s.jsx)(k.z, {
                                            ...
                                            className:
                                              'whitespace-nowrap hover:border-muted',
                                            style: {
                                              paddingTop: 3,
                                              paddingBottom: 3,
                                            },
        ...
        var eU = n(37393),
          ...
          eG = () => {
            let { project: e } = (0, j.d2)(),
              ...
              { data: g, isLoading: y } = (0, ep.x4)({
                projectRef: null == e ? void 0 : e.ref,
                connectionString: null == e ? void 0 : e.connectionString,
              }),
              v = ex()(null != g ? g : [], e => e.name.toLocaleLowerCase()),
              N = (
          ...
          e3 = e => {
            ...
            return (0, s.jsxs)('div', {
              className:
                'flex border-overlay flex-col overflow-hidden rounded border shadow-sm',
                ...
                0 === n.length
                  ...
                  : (null != l ? l : []).filter(e => {
                      let t = e.name.toLowerCase().includes(n.toLowerCase()),
                        s = (e8.Xq[e.name] || []).some(e =>
                          e.includes(n.toLowerCase())
                        );
                      return t || s;
                    }),
              d = c.filter(e => !e8.Ht.includes(e.name)),
          ...
          tt = e => {
            let { onSelectPublication: t = l() } = e,
              ...
              b = async () => {
                if (!g || !n) return;
                let { publication: e, event: t, currentStatus: s } = g,
                  a = {
                    projectRef: n.ref,
              ...
              children: [
                ...
                (0, s.jsx)(e7.Z, {
                  ...
                  title: 'Confirm to toggle sending '.concat(
                    null == g ? void 0 : g.event.event.toLowerCase(),
                    ' events'
                  ),
                  ...
                  children: (0, s.jsxs)('p', {
                    ...
                    children: [
                      ...
                      (null == g ? void 0 : g.currentStatus) ? 'stop' : 'start',
                      ' ',
                      'sending ',
                      null == g ? void 0 : g.event.event.toLowerCase(),
                      ' events for',
                      ' ',
                      null == g ? void 0 : g.publication.name,
                      '?',
                    ],
                  }),
                }),
        ...
        async function tV(e) {
          ...
          s && r.set('x-connection-encrypted', s);
          let l = await (0, tq.r$)(
            ''.concat(th.T5, '/pg-meta/').concat(n, '/triggers?id=').concat(t),
            a,
        ...
        let tY = function () {
          let {
              ...
              : {},
            s = (0, eC.NL)();
          return (0, eZ.D)(e => tV(e), {
            async onSuccess(t, n, a) {
              let { projectRef: r } = n;
              (await s.invalidateQueries(tM.D.list(r)),
        ...
        let nn = (0, tz.Pi)(e => {
              ...
              children: [
                (0, s.jsxs)(tI.Z.Option, {
                  addOnBefore: e => {
                    ...
                    return (0, s.jsx)('div', {
                      className:
                        'h-3 w-3 rounded-full border border-green-700 bg-green-900 shadow-sm',
                    });
                  },
                  value: 'ORIGIN',
                  label: 'Origin',
                ...
                (0, s.jsxs)(tI.Z.Option, {
                  addOnBefore: e => {
                    ...
                    return (0, s.jsx)('div', {
                      className:
                        'h-3 w-3 rounded-full border border-red-700 bg-red-900 shadow-sm',
                    });
                  },
                  value: 'DISABLED',
                  label: 'Disabled',
          ...
          nd = (0, tz.Pi)(e => {
            ...
            return (0, s.jsx)('button', {
              ...
              className:
                'relative w-full rounded border border-default bg-surface-200 px-5 py-1 shadow-sm transition-all hover:border-strong hover:bg-overlay-hover',
              children: (0, s.jsx)(tD, {
                icon: (0, s.jsx)(tX.Z, { size: 14, strokeWidth: 2 }),
          ...
          nu = (0, tz.Pi)(e => {
            ...
            return (0, s.jsx)(s.Fragment, {
              children: (0, s.jsxs)('div', {
                className:
                  'relative w-full flex items-center justify-between space-x-3 px-5 py-4 border border-default rounded shadow-sm transition-shadow',
                children: [
                  (0, s.jsxs)('div', {
                    ...
                    children: [
                      (0, s.jsx)(T.aJ, {
                        ...
                        children: (0, s.jsx)(k.z, {
                          ...
                          onClick: () => r(!a),
                          icon: a ? (0, s.jsx)(nF.Z, {}) : (0, s.jsx)(nR.Z, {}),
                          'data-sentry-element': 'Button',
                          'data-sentry-source-file': 'FunctionEditor.tsx',
                        }),
                      }),
        ...
        var nA = e => {
          let { func: t, visible: n, setVisible: a } = e,
            ...
            p = (0, ev.cI)({ resolver: (0, ey.F)(nI) }),
            g = p.watch('language'),
            { mutate: y, isLoading: v } = nv(),
            { mutate: b, isLoading: N } = nN();
          function w() {
          ...
          let S = async e => {
            ...
            let s = {
              ...
              config_params: tk()(np()(e.config_params, 'name'), 'value'),
            };
            h
              ? b(
                  {
                                  ...
                                  (0, s.jsx)(eF.Wi, {
                                    ...
                                    render: e => {
                                      ...
                                      return (0, s.jsx)(nE.E, {
                                        label: 'Return type',
                                        layout: 'horizontal',
                                        children: (0, s.jsxs)(nC.Ph, {
                                          onValueChange: t.onChange,
                                          defaultValue: t.value,
                                          children: [
                                            (0, s.jsx)(nC.i4, {
                                              className: 'col-span-8',
                                              children: (0, s.jsx)(nC.ki, {}),
                                            }),
                                            (0, s.jsx)(nC.Bw, {
                                              children: (0, s.jsx)(nZ.x, {
                                                className: 'h-52',
                                                children: [
                                                  'void',
                                                  'record',
        ...
        let nL = e => {
          ...
          nB = ['plpgsql', 'sql', 'plcoffee', 'plv8', 'plls'],
          nW = () => {
            let { project: e } = (0, j.d2)(),
              { data: t } = (0, e4.H)(
                {
                ...
                return (0, s.jsx)(nE.E, {
                  ...
                  children: (0, s.jsxs)(nC.Ph, {
                    ...
                    children: [
                      ...
                      (0, s.jsx)(nC.Bw, {
                        children: n.map(e =>
                          (0, s.jsx)(nC.Ql, { value: e, children: e }, e)
                        ),
                      }),
                    ],
                  }),
        ...
        let nG = function () {
          ...
          return (0, eZ.D)(e => nJ(e), {
            async onSuccess(t, n, a) {
              let { projectRef: r } = n;
              (await s.invalidateQueries(nQ.P.list(r)),
                await (null == e ? void 0 : e(t, n, a)));
            },
            async onError(e, n, s) {
              void 0 === t
                ...
                (0, s.jsxs)('div', {
                  ...
                  children: [
                    (0, s.jsx)('div', {
                      ...e.dragHandleProps,
                      className:
                        'opacity-50 hover:opacity-100 transition '.concat(
                          r
                            ? 'text-foreground-lighter !cursor-default'
                            : 'text-foreground'
                        ),
                      children: (0, s.jsx)(nK.Z, {
                        size: 16,
                        strokeWidth: 1.5,
                      }),
                    }),
        ...
        var n7 = e => {
          ...
          n9 = () => {
            let { project: e } = (0, j.d2)(),
              ...
              I = null == g ? void 0 : g.find(e => e.name === a),
      ...
      59762: function (e, t, n) {
        ...
        async function c(e) {
          ...
          let r = await (0, l.v_)(
            ''.concat(i.T5, '/pg-meta/').concat(t, '/triggers'),
            s,
        ...
        let d = function () {
          ...
          return (0, a.D)(e => c(e), {
            async onSuccess(t, n, s) {
              let { projectRef: a } = n;
              (await l.invalidateQueries(o.D.list(a)),
                await (null == e ? void 0 : e(t, n, s)));
            },
            async onError(e, n, s) {
              void 0 === t
      ...
      46310: function (e, t, n) {
        ...
        async function c(e) {
          ...
          let r = await (0, l.$v)(
            ''.concat(i.T5, '/pg-meta/').concat(n, '/triggers?id=').concat(t),
            void 0,
            { headers: Object.fromEntries(a) }
          );
      ...
      84849: function (e, t, n) {
        ...
        let y = function () {
          ...
          return (0, f.D)(e => g(e), {
            async onSuccess(t, n, a) {
              let { projectRef: r } = n;
              (await s.invalidateQueries(j.o.list(r)),
                await (null == e ? void 0 : e(t, n, a)));
            },
            async onError(e, n, s) {
              void 0 === t
          ...
          F = e => {
            ...
            return (0, s.jsxs)(s.Fragment, {
              children: [
                (0, s.jsxs)('div', {
                  className:
                    'bg-surface-100 border border-overlay flex flex-col overflow-hidden rounded shadow-sm',
                  children: [
                    (0, s.jsxs)('div', {
                      className: (0, w.cn)(
        ...
        let h = (e, t) => {
          ...
          f = () => {
            let e = (0, c.Vm)(),
              ...
              u =
                void 0 !== (null != n ? n : []).find(e => 'pg_net' === e.name),
              m =
                (null == d
                  ? void 0
      ...
      78066: function (e, t, n) {
        ...
        ((c.displayName = 'ScaffoldHeader'),
          ...
          (g.displayName = 'ScaffoldFilterAndContent'),
                ...
                (0, s.jsxs)(x.bZ, {
                  ...
                  children: [
                    ...
                    (0, s.jsxs)(x.X, {
                      ...
                      children: ['Error: ', null == R ? void 0 : R.message],
                    }),
                    (0, s.jsx)(m.z, {
                      type: 'default',
                      size: 'tiny',
